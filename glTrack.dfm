object MenuForm: TMenuForm
  ...
  object FDQuery1: TFDQuery
    ...
    SQL.Strings = (
        ...
        'unt, pp.p_price, pp.is_updated, pp.price_updated_at '
    ...
    object FDQuery1is_updated: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'is_updated'
      Origin = 'is_updated'
      FixedChar = True
    ...
    object FDQuery1price_updated_at: TSQLTimeStampField
      AutoGenerateValue = arDefault
      FieldName = 'price_updated_at'
      Origin = 'price_updated_at'
    end
  end
