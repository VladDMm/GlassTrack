...
// (DO NOT EDIT: machine generated header) 'FireDAC.Stan.Error.pas' rev: 36.00 (Windows)
...
public:
	/* Exception.CreateFmt */ inline __fastcall EFDException(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : Data::Db::EDatabaseError(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EFDException(System::NativeUInt Ident)/* overload */ : Data::Db::EDatabaseError(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EFDException(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : Data::Db::EDatabaseError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EFDException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : Data::Db::EDatabaseError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EFDException(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : Data::Db::EDatabaseError(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EFDException(System::NativeUInt Ident, int AHelpContext)/* overload */ : Data::Db::EDatabaseError(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EFDException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : Data::Db::EDatabaseError(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EFDException(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : Data::Db::EDatabaseError(Ident, Args, Args_High, AHelpContext) { }
...
private:
	Firedac::Stan::Intf::TFDObjList* FItems;
...
public:
	/* Exception.CreateFmt */ inline __fastcall EFDDBEngineException(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : EFDException(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EFDDBEngineException(System::NativeUInt Ident)/* overload */ : EFDException(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EFDDBEngineException(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : EFDException(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EFDDBEngineException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : EFDException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EFDDBEngineException(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : EFDException(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EFDDBEngineException(System::NativeUInt Ident, int AHelpContext)/* overload */ : EFDException(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EFDDBEngineException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : EFDException(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EFDDBEngineException(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : EFDException(Ident, Args, Args_High, AHelpContext) { }
...
public:
	/* Exception.CreateFmt */ inline __fastcall EFDDBArrayExecuteError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : EFDException(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EFDDBArrayExecuteError(System::NativeUInt Ident)/* overload */ : EFDException(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EFDDBArrayExecuteError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : EFDException(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EFDDBArrayExecuteError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : EFDException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EFDDBArrayExecuteError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : EFDException(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EFDDBArrayExecuteError(System::NativeUInt Ident, int AHelpContext)/* overload */ : EFDException(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EFDDBArrayExecuteError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : EFDException(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EFDDBArrayExecuteError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : EFDException(Ident, Args, Args_High, AHelpContext) { }
...
extern DELPHI_PACKAGE System::UnicodeString __fastcall FDExceptionLayers(const System::UnicodeString *ALayers, const System::NativeInt ALayers_High);
extern DELPHI_PACKAGE System::UnicodeString __fastcall FDGetErrorMessage(int ACode, const System::TVarRec *AArgs, const System::NativeInt AArgs_High);
extern DELPHI_PACKAGE void __fastcall FDException(System::TObject* AObj, const System::UnicodeString *ALayers, const System::NativeInt ALayers_High, int ACode, const System::TVarRec *AArgs, const System::NativeInt AArgs_High)/* overload */;
extern DELPHI_PACKAGE void __fastcall FDCapabilityNotSupported(System::TObject* AObj, const System::UnicodeString *ALayers, const System::NativeInt ALayers_High);
extern DELPHI_PACKAGE EFDDBEngineException* __fastcall FDDBEngineExceptionCreate(EFDDBEngineExceptionClass AClass, int ACode, const System::TVarRec *AArgs, const System::NativeInt AArgs_High);
