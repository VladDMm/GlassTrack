...
// (DO NOT EDIT: machine generated header) 'Winapi.ActiveX.pas' rev: 36.00 (Windows)
...
__interface  INTERFACE_UUID("{A35E20C2-837D-11D0-9E9F-00A02457621F}") IWeakRef  : public System::IInterface 
{
	...
	virtual System::LongInt __stdcall ReleaseKeepAlive(const System::_di_IInterface unkReleased, System::LongInt reserved) = 0 ;
};
...
//-- var, const, procedure ---------------------------------------------------
static _DELPHI_CONST int CLSCTX_FROM_DEFAULT_CONTEXT = int(0x20000);
...
extern DELPHI_PACKAGE HRESULT __fastcall PropVariantToCLSID(const tagPROPVARIANT &propvarIn, /* out */ TCLSID &pclsid);
