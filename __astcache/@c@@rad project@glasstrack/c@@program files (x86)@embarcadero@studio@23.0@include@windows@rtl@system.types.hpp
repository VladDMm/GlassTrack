...
// (DO NOT EDIT: machine generated header) 'System.Types.pas' rev: 36.00 (Windows)
...
private:
	...
	static TWaitResult __fastcall DoWait(TMultiWaitEvent* const *Events, const System::NativeInt Events_High, bool WaitAll, System::PInteger Index, PMultiWaitEvent Event, unsigned Timeout);
...
//-- var, const, procedure ---------------------------------------------------
static _DELPHI_CONST TEndian PlatformEndian = (TEndian)(1);
static _DELPHI_CONST System::WideChar NullChar = (System::WideChar)(0x0);
static _DELPHI_CONST System::WideChar Tabulator = (System::WideChar)(0x9);
static _DELPHI_CONST System::WideChar Space = (System::WideChar)(0x20);
static _DELPHI_CONST System::WideChar CarriageReturn = (System::WideChar)(0xd);
static _DELPHI_CONST System::WideChar LineFeed = (System::WideChar)(0xa);
static _DELPHI_CONST System::WideChar VerticalTab = (System::WideChar)(0xb);
static _DELPHI_CONST System::WideChar FormFeed = (System::WideChar)(0xc);
static _DELPHI_CONST System::WideChar LineSeparator = (System::WideChar)(0x2028);
static _DELPHI_CONST System::WideChar ParagraphSeparator = (System::WideChar)(0x2029);
static _DELPHI_CONST System::WideChar BOM_LSB_FIRST = (System::WideChar)(0xfeff);
static _DELPHI_CONST System::WideChar BOM_MSB_FIRST = (System::WideChar)(0xfffe);
static _DELPHI_CONST System::Int8 LessThanValue = System::Int8(-1);
static _DELPHI_CONST System::Int8 EqualsValue = System::Int8(0x0);
static _DELPHI_CONST System::Int8 GreaterThanValue = System::Int8(1);
...
extern DELPHI_PACKAGE TRectF __fastcall NormalizeRectF(const TPointF *Pts, const System::NativeInt Pts_High)/* overload */;
...
extern DELPHI_PACKAGE TSmallPoint __fastcall SmallPoint(System::LongWord XY)/* overload */;
