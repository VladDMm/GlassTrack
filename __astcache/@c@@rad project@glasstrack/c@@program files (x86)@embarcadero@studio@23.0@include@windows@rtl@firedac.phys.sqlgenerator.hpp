...
// (DO NOT EDIT: machine generated header) 'FireDAC.Phys.SQLGenerator.pas' rev: 36.00 (Windows)
...
protected:
	...
	virtual System::UnicodeString __fastcall GetCreatePrimaryKey(const System::UnicodeString AName, const System::UnicodeString ACols, bool AInline);
