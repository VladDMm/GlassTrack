...
// (DO NOT EDIT: machine generated header) 'FireDAC.Stan.Util.pas' rev: 36.00 (Windows)
...
class DELPHICLASS TFDStringEraser;
//-- type declarations -------------------------------------------------------
...
public:
	void __fastcall SetData(void * APtr, System::LongInt ASize);
public:
...
private:
	bool FActive;
	System::LongWord FStartupTimeout;
	System::LongWord FIdleTimeout;
	Firedac::Stan::Intf::TFDThreadObjList* FMessages;
...
protected:
	...
	__property Firedac::Stan::Intf::TFDThreadObjList* Messages = {read=FMessages};
...
public:
	...
	__property System::LongWord StartupTimeout = {read=FStartupTimeout, write=FStartupTimeout, nodefault};
	__property System::LongWord IdleTimeout = {read=FIdleTimeout, write=FIdleTimeout, nodefault};
...
public:
	...
	void * __fastcall Extend(System::LongWord ASrcDataLen, System::LongWord &ADestDataLen, Firedac::Stan::Intf::TFDDataType ASrcType, Firedac::Stan::Intf::TFDDataType ADestType);
	void * __fastcall Check(System::LongWord ALen = (unsigned)(0x0));
	void __fastcall Release();
	__property void * Ptr = {read=FBuffer};
	__property System::LongWord Size = {read=FBufferSize, nodefault};
};
...
private:
	...
	unsigned FCodePage;
	Firedac::Stan::Intf::TFDByteString __fastcall GetPreamble();
	void * __fastcall Alloc(System::LongWord ALen);
	void __fastcall Release(void * APtr);
	__classmethod void __fastcall SetBytes(Firedac::Stan::Intf::TFDByteString &AStr, void * AValue, int ALen, int ATrailerLen);
	__classmethod void __fastcall SetTrailerBytes(Firedac::Stan::Intf::TFDByteString &AStr, bool AAppend, int ATrailerLen);
	
public:
	__fastcall TFDEncoder(TFDBuffer* ABuffer);
	__fastcall virtual ~TFDEncoder();
	Firedac::Stan::Intf::TFDByteString __fastcall Encode(const System::UnicodeString AStr, Firedac::Stan::Intf::TFDEncoding ADestEncoding = (Firedac::Stan::Intf::TFDEncoding)(0x0))/* overload */;
	...
	Firedac::Stan::Intf::TFDByteString __fastcall Encode(const void * ASrc, int ASrcLen, Firedac::Stan::Intf::TFDEncoding ASrcEncoding = (Firedac::Stan::Intf::TFDEncoding)(0x0), Firedac::Stan::Intf::TFDEncoding ADestEncoding = (Firedac::Stan::Intf::TFDEncoding)(0x0))/* overload */;
	...
	System::UnicodeString __fastcall Decode(const Firedac::Stan::Intf::TFDByteString AStr, Firedac::Stan::Intf::TFDEncoding ASrcEncoding = (Firedac::Stan::Intf::TFDEncoding)(0x0))/* overload */;
	...
	int __fastcall EncodedLength(const Firedac::Stan::Intf::TFDByteString AStr, Firedac::Stan::Intf::TFDEncoding ADestEncoding = (Firedac::Stan::Intf::TFDEncoding)(0x0));
	...
	__classmethod System::UnicodeString __fastcall Deco(const Firedac::Stan::Intf::TFDByteString ASrc, Firedac::Stan::Intf::TFDEncoding ASrcEncoding)/* overload */;
	__classmethod Firedac::Stan::Intf::TFDByteString __fastcall Enco(const System::UnicodeString AStr, Firedac::Stan::Intf::TFDEncoding ADestEncoding)/* overload */;
	__classmethod int __fastcall EncoLength(const Firedac::Stan::Intf::TFDByteString AStr, Firedac::Stan::Intf::TFDEncoding ADestEncoding);
	__property Firedac::Stan::Intf::TFDEncoding Encoding = {read=FEncoding, write=FEncoding, nodefault};
	__property Firedac::Stan::Intf::TFDByteString Preamble = {read=GetPreamble};
...
protected:
	Firedac::Stan::Intf::TFDVersion FVersion;
	System::UnicodeString FVersionStr;
	Winapi::Windows::THandle FhDLL;
	System::UnicodeString FDLLName;
	virtual void __fastcall GetLibraryInfo();
	virtual void __fastcall LoadLibrary(const System::UnicodeString *ADLLNames, const System::NativeInt ADLLNames_High, bool ARequired);
...
public:
	...
	void __fastcall Load(const System::UnicodeString *ADLLNames, const System::NativeInt ADLLNames_High, bool ARequired);
...
#ifndef _WIN64
	__property Winapi::Windows::THandle hDLL = {read=FhDLL, nodefault};
#else /* _WIN64 */
	__property Winapi::Windows::THandle hDLL = {read=FhDLL};
#endif /* _WIN64 */
	__property System::UnicodeString DLLName = {read=FDLLName};
	__property Firedac::Stan::Intf::TFDVersion Version = {read=FVersion};
...
#pragma pack(push,4)
#endif /* not _WIN64 */
class PASCALIMPLEMENTATION TFDStringEraser : public System::TInterfacedObject
{
	typedef System::TInterfacedObject inherited;
	
private:
	System::UnicodeString *FpString;
	
public:
	__fastcall virtual ~TFDStringEraser();
	static System::_di_IInterface __fastcall Create(System::UnicodeString &AStr)/* overload */;
public:
	/* TObject.Create */ inline __fastcall TFDStringEraser() : System::TInterfacedObject() { }
...
//-- var, const, procedure ---------------------------------------------------
#ifndef _WIN64
static _DELPHI_CONST TFDMachineType mtNative = (TFDMachineType)(1);
#else /* _WIN64 */
static _DELPHI_CONST TFDMachineType mtNative = (TFDMachineType)(2);
#endif /* _WIN64 */
...
extern DELPHI_PACKAGE void __fastcall FDBin2HexBS(void * APtr, int ALen, Winapi::Windows::PByte ADest);
extern DELPHI_PACKAGE System::UnicodeString __fastcall FDBin2Hex(void * APtr, int ALen);
extern DELPHI_PACKAGE Firedac::Stan::Intf::TFDByteString __fastcall FDHex2Bin(System::UnicodeString AStr);
...
extern DELPHI_PACKAGE int __fastcall FDAnsiStrLen(Firedac::Stan::Intf::PFDAnsiString AStr);
...
extern DELPHI_PACKAGE int __fastcall FDCompareByteStr(const Winapi::Windows::PByte AStr1, const Winapi::Windows::PByte AStr2, int ALen1, int ALen2);
...
extern DELPHI_PACKAGE System::UnicodeString __fastcall FDStrSubst(const System::UnicodeString AStr, int AFrom, int ALen, const System::UnicodeString ARepl);
...
extern DELPHI_PACKAGE Firedac::Stan::Intf::TFDVersion __fastcall FDVerStr2Int(const System::UnicodeString AVersion);
extern DELPHI_PACKAGE System::UnicodeString __fastcall FDVerInt2Str(Firedac::Stan::Intf::TFDVersion AVersion);
...
extern DELPHI_PACKAGE System::NativeUInt __fastcall FDDisableFPExc(void);
extern DELPHI_PACKAGE void __fastcall FDResetFPExc(System::NativeUInt AValue);
