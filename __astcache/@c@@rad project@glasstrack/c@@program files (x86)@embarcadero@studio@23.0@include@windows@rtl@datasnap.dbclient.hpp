...
// (DO NOT EDIT: machine generated header) 'Datasnap.DBClient.pas' rev: 36.00 (Windows)
...
private:
	Datasnap::Dsintf::DBResult FErrorCode;
	
public:
	__fastcall EDBClient(System::UnicodeString Message, Datasnap::Dsintf::DBResult ErrorCode);
	__property Datasnap::Dsintf::DBResult ErrorCode = {read=FErrorCode, nodefault};
public:
	/* Exception.CreateFmt */ inline __fastcall EDBClient(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : Data::Db::EDatabaseError(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EDBClient(System::NativeUInt Ident)/* overload */ : Data::Db::EDatabaseError(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EDBClient(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : Data::Db::EDatabaseError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EDBClient(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : Data::Db::EDatabaseError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EDBClient(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : Data::Db::EDatabaseError(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EDBClient(System::NativeUInt Ident, int AHelpContext)/* overload */ : Data::Db::EDatabaseError(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EDBClient(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : Data::Db::EDatabaseError(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EDBClient(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : Data::Db::EDatabaseError(Ident, Args, Args_High, AHelpContext) { }
...
private:
	...
	Datasnap::Dsintf::DBResult FPreviousError;
	
public:
	__fastcall EReconcileError(System::UnicodeString NativeError, System::UnicodeString Context, Datasnap::Dsintf::DBResult ErrorCode, Datasnap::Dsintf::DBResult PreviousError);
...
public:
	/* Exception.CreateFmt */ inline __fastcall EReconcileError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : EDBClient(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EReconcileError(System::NativeUInt Ident)/* overload */ : EDBClient(Ident) { }
	/* Exception.CreateRes */ inline __fastcall EReconcileError(System::PResStringRec ResStringRec)/* overload */ : EDBClient(ResStringRec) { }
	/* Exception.CreateResFmt */ inline __fastcall EReconcileError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : EDBClient(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EReconcileError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : EDBClient(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EReconcileError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : EDBClient(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EReconcileError(System::NativeUInt Ident, int AHelpContext)/* overload */ : EDBClient(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EReconcileError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : EDBClient(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EReconcileError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : EDBClient(Ident, Args, Args_High, AHelpContext) { }
...
private:
	...
	Datasnap::Dsintf::TDataPacket FSavedPacket;
	Datasnap::Dsintf::TDataPacket FDeltaPacket;
	...
	System::NativeInt FFilterBuffer;
	int FGroupingLevel;
	...
	PKeyBuffer FKeyBuffer;
	System::NativeInt FNewValueBuffer;
	System::NativeInt FOldValueBuffer;
	System::NativeInt FCurValueBuffer;
	...
	Datasnap::Dsintf::DBResult __stdcall CalcFieldsCallBack(System::NativeInt RecBuf);
	...
	System::LongBool __stdcall FilterCallback(System::NativeInt RecBuf);
	void __fastcall DoAggUpdates(bool IsUpdate);
	System::Classes::TList* __fastcall GetActiveAggs(int Index);
	bool __fastcall GetActiveRecBuf(System::NativeInt &RecBuf);
	void __fastcall GetAggFieldData(System::NativeInt Buffer);
	...
	void __fastcall InternalCheck(Datasnap::Dsintf::DBResult Status, const Datasnap::Dsintf::_di_IDSBase ADSBase);
	...
	Datasnap::Dsintf::dsCBRType __stdcall ReconcileCallback(int iRslt, Datasnap::Dsintf::DSAttr iUpdateKind, Datasnap::Dsintf::dsCBRType iResAction, int iErrCode, void * pErrMessage, void * pErrContext, void * pRecUpd, void * pRecOrg, void * pRecConflict, int iLevels, System::PInteger piFieldIDs);
...
protected:
	...
	virtual void __fastcall ExecuteCommand(const System::UnicodeString ACommand, const System::TVarRec *Args, const System::NativeInt Args_High);
	...
	void __fastcall Check(Datasnap::Dsintf::DBResult Status);
	virtual void __fastcall CheckDetailRecords();
	virtual void __fastcall CheckProviderEOF();
	void __fastcall CheckSetKeyMode();
	virtual void __fastcall ClearCalcFields(Data::Db::TRecBuf Buffer)/* overload */;
	virtual void __fastcall ClearCalcFields _DEPRECATED_ATTRIBUTE1("Use overloaded method instead") (Data::Db::TRecordBuffer Buffer)/* overload */;
	virtual void __fastcall CloseCursor();
	virtual void __fastcall DataConvert(Data::Db::TField* Field, Data::Db::TValueBuffer Source, Data::Db::TValueBuffer &Dest, bool ToNative)/* overload */;
	...
	virtual void __fastcall GetBookmarkData(Data::Db::TRecBuf Buffer, Data::Db::TBookmark Data)/* overload */;
	virtual Data::Db::TBookmarkFlag __fastcall GetBookmarkFlag(Data::Db::TRecBuf Buffer)/* overload */;
	virtual void __fastcall GetBookmarkData _DEPRECATED_ATTRIBUTE1("Use overloaded method instead") (Data::Db::TRecordBuffer Buffer, Data::Db::TBookmark Data)/* overload */;
	virtual void __fastcall GetBookmarkData _DEPRECATED_ATTRIBUTE1("Use overloaded method instead") (Data::Db::TRecordBuffer Buffer, void * Data)/* overload */;
	virtual Data::Db::TBookmarkFlag __fastcall GetBookmarkFlag _DEPRECATED_ATTRIBUTE1("Use overloaded method instead") (Data::Db::TRecordBuffer Buffer)/* overload */;
	...
	virtual Data::Db::TGetResult __fastcall GetRecord(Data::Db::TRecBuf Buffer, Data::Db::TGetMode GetMode, bool DoCheck)/* overload */;
	virtual Data::Db::TGetResult __fastcall GetRecord _DEPRECATED_ATTRIBUTE1("Use overloaded method instead") (Data::Db::TRecordBuffer Buffer, Data::Db::TGetMode GetMode, bool DoCheck)/* overload */;
	...
	virtual void __fastcall InitRecord(Data::Db::TRecBuf Buffer)/* overload */;
	virtual void __fastcall InternalAddRecord(Data::Db::TRecBuf Buffer, bool Append)/* overload */;
	virtual void __fastcall InitRecord _DEPRECATED_ATTRIBUTE1("Use overloaded method instead") (Data::Db::TRecordBuffer Buffer)/* overload */;
	virtual void __fastcall InternalAddRecord _DEPRECATED_ATTRIBUTE1("Use overloaded method instead") (Data::Db::TRecordBuffer Buffer, bool Append)/* overload */;
	...
	virtual void __fastcall SetBookmarkFlag(Data::Db::TRecBuf Buffer, Data::Db::TBookmarkFlag Value)/* overload */;
	virtual void __fastcall SetBookmarkData _DEPRECATED_ATTRIBUTE1("Use overloaded method instead") (Data::Db::TRecordBuffer Buffer, Data::Db::TBookmark Data)/* overload */;
	virtual void __fastcall SetBookmarkData _DEPRECATED_ATTRIBUTE1("Use overloaded method instead") (Data::Db::TRecordBuffer Buffer, void * Data)/* overload */;
	virtual void __fastcall SetBookmarkFlag _DEPRECATED_ATTRIBUTE1("Use overloaded method instead") (Data::Db::TRecordBuffer Buffer, Data::Db::TBookmarkFlag Value)/* overload */;
...
public:
	...
	virtual bool __fastcall GetFieldData(int FieldNo, Data::Db::TValueBuffer &Buffer)/* overload */;
...
public:
	...
	inline bool __fastcall  GetFieldData(Data::Db::TField* Field, Data::Db::TValueBuffer &Buffer, bool NativeFormat){ return Data::Db::TDataSet::GetFieldData(Field, Buffer, NativeFormat); }
...
public:
#ifdef _WIN64
	inline System::Classes::TNativeCount __fastcall  Write(const void *Buffer, System::Classes::TNativeCount Count){ return System::Classes::TMemoryStream::Write(Buffer, Count); }
	inline System::NativeInt __fastcall  Write(const System::Sysutils::TBytes Buffer, System::NativeInt Offset, System::NativeInt Count){ return System::Classes::TStream::Write(Buffer, Offset, Count); }
#endif /* _WIN64 */
...
#ifdef _WIN64
	inline System::NativeInt __fastcall  Write(const System::Sysutils::TBytes Buffer, System::NativeInt Count){ return System::Classes::TStream::Write(Buffer, Count); }
#endif /* _WIN64 */
...
static _DELPHI_CONST System::Int8 AllRecords = System::Int8(-1);
