...
// (DO NOT EDIT: machine generated header) 'FireDAC.Comp.UI.pas' rev: 36.00 (Windows)
...
private:
	...
	System::UnicodeString __fastcall GetCancelCaption();
	void __fastcall SetCancelCaption(const System::UnicodeString AValue);
	bool __fastcall IsPS();
	bool __fastcall IsCCS();
