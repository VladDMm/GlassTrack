...
// (DO NOT EDIT: machine generated header) 'Vcl.Graphics.pas' rev: 36.00 (Windows)
...
class DELPHICLASS TScaledGraphicDrawer;
...
class DELPHICLASS TWICImageEx;
class DELPHICLASS TWICScaledGraphicDrawer;
...
public:
	...
	System::LongInt DIBSize;
	System::LongInt DIBOffset;
};
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EInvalidGraphic(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : System::Sysutils::Exception(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EInvalidGraphic(System::NativeUInt Ident)/* overload */ : System::Sysutils::Exception(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EInvalidGraphic(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EInvalidGraphic(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EInvalidGraphic(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : System::Sysutils::Exception(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EInvalidGraphic(System::NativeUInt Ident, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EInvalidGraphic(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EInvalidGraphic(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EInvalidGraphicOperation(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : System::Sysutils::Exception(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EInvalidGraphicOperation(System::NativeUInt Ident)/* overload */ : System::Sysutils::Exception(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EInvalidGraphicOperation(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EInvalidGraphicOperation(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EInvalidGraphicOperation(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : System::Sysutils::Exception(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EInvalidGraphicOperation(System::NativeUInt Ident, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EInvalidGraphicOperation(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EInvalidGraphicOperation(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High, AHelpContext) { }
...
#ifndef _WIN64
typedef System::TMetaClass* TScaledGraphicDrawerClass;
#else /* _WIN64 */
_DECLARE_METACLASS(System::TMetaClass, TScaledGraphicDrawerClass);
#endif /* _WIN64 */
...
private:
	...
	PResource FResource;
	Winapi::Windows::PRTLCriticalSection FOwnerLock;
...
#else /* _WIN64 */
	__property HFONT Handle = {read=GetHandle, write=SetHandle};
#endif /* _WIN64 */
...
#else /* _WIN64 */
	__property HPEN Handle = {read=GetHandle, write=SetHandle};
#endif /* _WIN64 */
...
#else /* _WIN64 */
	__property HBRUSH Handle = {read=GetHandle, write=SetHandle};
#endif /* _WIN64 */
...
typedef System::LongInt TCopyMode;
...
public:
	...
	static TTextFormatFlags __fastcall _op_Implicit(TDrawTextFlags Value);
	__fastcall operator TDrawTextFlags();
	
	TTextFormatFlags& operator =(TTextFormat Value) { *this = TTextFormatFlags::_op_Implicit(Value); return *this; }
	TTextFormatFlags& operator =(TDrawTextFlags Value) { *this = TTextFormatFlags::_op_Implicit(Value); return *this; }
};
...
private:
	...
	System::LongInt FTextFlags;
	Winapi::Windows::TRTLCriticalSection FLock;
	int FLockCount;
	
protected:
	virtual TCanvasOrientation __fastcall GetCanvasOrientation() = 0 ;
	virtual Winapi::Windows::TRect __fastcall GetClipRect() = 0 ;
	virtual Winapi::Windows::TPoint __fastcall GetPenPos() = 0 ;
	virtual System::Uitypes::TColor __fastcall GetPixel(int X, int Y) = 0 ;
	virtual void __fastcall SetPenPos(const Winapi::Windows::TPoint &Value) = 0 ;
...
public:
	...
	virtual void __fastcall BrushCopy(const Winapi::Windows::TRect &Dest, TBitmap* Bitmap, const Winapi::Windows::TRect &Source, System::Uitypes::TColor Color) = 0 ;
	...
	virtual void __fastcall DrawFocusRect(const Winapi::Windows::TRect &Rect) = 0 ;
	...
	virtual void __fastcall FrameRect(const Winapi::Windows::TRect &Rect) = 0 ;
	...
	virtual void __fastcall Polygon(const System::Types::TPoint *Points, const System::NativeInt Points_High) = 0 ;
	virtual void __fastcall Polyline(const System::Types::TPoint *Points, const System::NativeInt Points_High) = 0 ;
	virtual void __fastcall PolyBezier(const System::Types::TPoint *Points, const System::NativeInt Points_High) = 0 ;
	virtual void __fastcall PolyBezierTo(const System::Types::TPoint *Points, const System::NativeInt Points_High) = 0 ;
	...
	void __fastcall RoundRect(const Winapi::Windows::TRect &Rect, int CX, int CY)/* overload */;
	...
	virtual void __fastcall TextRect(Winapi::Windows::TRect &Rect, System::UnicodeString &Text, TTextFormat TextFormat = TTextFormat() ) = 0 /* overload */;
	virtual void __fastcall TextRect(const Winapi::Windows::TRect &Rect, int X, int Y, const System::UnicodeString Text) = 0 /* overload */;
	...
	__property Winapi::Windows::TPoint PenPos = {read=GetPenPos, write=SetPenPos};
	__property System::Uitypes::TColor Pixels[int X][int Y] = {read=GetPixel, write=SetPixel};
	__property System::LongInt TextFlags = {read=FTextFlags, write=FTextFlags, nodefault};
	__property System::Classes::TNotifyEvent OnChange = {read=FOnChange, write=FOnChange};
...
protected:
	...
	virtual Winapi::Windows::TRect __fastcall GetClipRect();
	virtual Winapi::Windows::TPoint __fastcall GetPenPos();
	...
	virtual void __fastcall SetPenPos(const Winapi::Windows::TPoint &Value);
...
public:
	...
	virtual void __fastcall BrushCopy(const Winapi::Windows::TRect &Dest, TBitmap* Bitmap, const Winapi::Windows::TRect &Source, System::Uitypes::TColor Color);
	virtual void __fastcall Chord(int X1, int Y1, int X2, int Y2, int X3, int Y3, int X4, int Y4);
	void __fastcall CopyRect(const Winapi::Windows::TRect &Dest, TCanvas* Canvas, const Winapi::Windows::TRect &Source);
	...
	virtual void __fastcall FillRect(const Winapi::Windows::TRect &Rect);
	virtual void __fastcall FloodFill(int X, int Y, System::Uitypes::TColor Color, TFillStyle FillStyle);
	virtual void __fastcall FrameRect(const Winapi::Windows::TRect &Rect);
	bool __fastcall HandleAllocated();
	...
	virtual void __fastcall Polyline(const System::Types::TPoint *Points, const System::NativeInt Points_High);
	virtual void __fastcall PolyBezier(const System::Types::TPoint *Points, const System::NativeInt Points_High);
	virtual void __fastcall PolyBezierTo(const System::Types::TPoint *Points, const System::NativeInt Points_High);
	...
	virtual void __fastcall TextRect(Winapi::Windows::TRect &Rect, System::UnicodeString &Text, TTextFormat TextFormat = TTextFormat() )/* overload */;
	virtual void __fastcall TextRect(const Winapi::Windows::TRect &Rect, int X, int Y, const System::UnicodeString Text)/* overload */;
#ifndef _WIN64
	__property HDC Handle = {read=GetHandle, write=SetHandle, nodefault};
#else /* _WIN64 */
	__property HDC Handle = {read=GetHandle, write=SetHandle};
#endif /* _WIN64 */
	
__published:
	__property TBrush* Brush = {read=FBrush, write=SetBrush};
	__property TCopyMode CopyMode = {read=FCopyMode, write=FCopyMode, default=13369376};
	__property TFont* Font = {read=FFont, write=SetFont};
	__property TPen* Pen = {read=FPen, write=SetPen};
	/* Hoisted overloads: */
	
public:
	inline void __fastcall  Ellipse(const Winapi::Windows::TRect &Rect){ TCustomCanvas::Ellipse(Rect); }
	inline void __fastcall  Rectangle(const Winapi::Windows::TRect &Rect){ TCustomCanvas::Rectangle(Rect); }
	inline void __fastcall  RoundRect(const Winapi::Windows::TRect &Rect, int CX, int CY){ TCustomCanvas::RoundRect(Rect, CX, CY); }
	
};


enum DECLSPEC_DENUM TCanvasRecallElements : unsigned char { creBrush, creFont, crePen };

typedef System::Set<TCanvasRecallElements, TCanvasRecallElements::creBrush, TCanvasRecallElements::crePen> TCanvasRecallElement;
...
private:
	...
	TPenRecall* FPen;
	TFontRecall* FFont;
	TCanvasRecallElement FRecallElement;
	
public:
	__fastcall TCanvasRecall(TCanvas* const Canvas, const TCanvasRecallElement RecallElement);
	__fastcall virtual ~TCanvasRecall();
};
...
#pragma pack(push,4)
#endif /* not _WIN64 */
class PASCALIMPLEMENTATION TScaledGraphicDrawer : public System::Classes::TPersistent
{
	typedef System::Classes::TPersistent inherited;
...
protected:
	...
	__property TGraphic* Graphic = {read=FGraphic};
	
public:
	__fastcall virtual TScaledGraphicDrawer(TGraphic* AGraphic, bool AInitialize);
	virtual void __fastcall Initialize() = 0 ;
	virtual void __fastcall Draw(TCanvas* ACanvas, const Winapi::Windows::TRect &ARect) = 0 /* overload */;
	__property bool Initialized = {read=GetInitialized, nodefault};
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TScaledGraphicDrawer() { }
...
private:
	...
	TScaledGraphicDrawer* FScaledDrawer;
	void __fastcall SetModified(bool Value);
	
protected:
	virtual void __fastcall Changed(System::TObject* Sender);
	virtual void __fastcall DefineProperties(System::Classes::TFiler* Filer);
	virtual void __fastcall Draw(TCanvas* ACanvas, const Winapi::Windows::TRect &Rect) = 0 ;
	virtual void __fastcall DrawTransparent(TCanvas* ACanvas, const Winapi::Windows::TRect &Rect, System::Byte Opacity);
	...
	virtual bool __fastcall GetIsAnimating();
	
public:
	__fastcall virtual TGraphic()/* overload */;
	...
	virtual void __fastcall LoadFromClipboardFormat(System::Word AFormat, Winapi::Windows::THandle AData, HPALETTE APalette) = 0 ;
	virtual void __fastcall SaveToClipboardFormat(System::Word &AFormat, Winapi::Windows::THandle &AData, HPALETTE &APalette) = 0 ;
	...
	virtual void __fastcall UpdateScaledDrawer();
	...
	__property bool IsAnimating = {read=GetIsAnimating, nodefault};
private:
...
typedef System::DynamicArray<TGraphic*> TGraphicArray;
...
private:
	...
	int __fastcall GetWidth();
	TWICImage* __fastcall GetWICImage();
	...
	void __fastcall SetWICImage(TWICImage* Value);
...
public:
	...
	void __fastcall LoadFromClipboardFormat(System::Word AFormat, Winapi::Windows::THandle AData, HPALETTE APalette);
	void __fastcall SaveToClipboardFormat(System::Word &AFormat, Winapi::Windows::THandle &AData, HPALETTE &APalette);
...
#else /* _WIN64 */
	unsigned __int64 __fastcall GetHandle();
#endif /* _WIN64 */
...
#else /* _WIN64 */
	void __fastcall SetHandle(unsigned __int64 Value);
#endif /* _WIN64 */
...
protected:
	...
	virtual void __fastcall Draw(TCanvas* ACanvas, const Winapi::Windows::TRect &Rect);
	virtual void __fastcall ReadData(System::Classes::TStream* Stream);
	void __fastcall ReadEMFStream(System::Classes::TStream* Stream);
	void __fastcall ReadWMFStream(System::Classes::TStream* Stream, System::LongInt Length);
...
public:
	...
	virtual void __fastcall SaveToClipboardFormat(System::Word &AFormat, Winapi::Windows::THandle &AData, HPALETTE &APalette);
	virtual void __fastcall Assign(System::Classes::TPersistent* Source);
#ifndef _WIN64
	unsigned __fastcall ReleaseHandle();
#else /* _WIN64 */
	unsigned __int64 __fastcall ReleaseHandle();
#endif /* _WIN64 */
	virtual void __fastcall SetSize(int AWidth, int AHeight);
...
#else /* _WIN64 */
	__property unsigned __int64 Handle = {read=GetHandle, write=SetHandle};
#endif /* _WIN64 */
...
protected:
	Winapi::Windows::TDIBSection FDIB;
	virtual void __fastcall FreeHandle();
...
private:
	...
	void __fastcall CopyImage(HBITMAP AHandle, HPALETTE APalette, const Winapi::Windows::TDIBSection &DIB);
	...
	void __fastcall ReadStream(System::Classes::TStream* Stream, System::LongInt Size);
	...
	void __fastcall NewImage(HBITMAP NewHandle, HPALETTE NewPalette, const Winapi::Windows::TDIBSection &NewDIB, bool OS2Format, System::Classes::TStream* RLEStream = (System::Classes::TStream*)(0x0));
	void __fastcall ReadDIB(System::Classes::TStream* Stream, System::LongWord ImageSize, Winapi::Windows::PBitmapFileHeader bmf = (Winapi::Windows::PBitmapFileHeader)(0x0));
	void __fastcall PreMultiplyAlpha();
	void __fastcall UnPreMultiplyAlpha();
	void __fastcall SetAlphaFormat(TAlphaFormat Value);
	bool __fastcall GetIsBottomTop();
...
public:
...
#else /* _WIN64 */
	__property HBITMAP Handle = {read=GetHandle, write=SetHandle};
#endif /* _WIN64 */
...
#else /* _WIN64 */
	__property HBITMAP MaskHandle = {read=GetMaskHandle, write=SetMaskHandle};
#endif /* _WIN64 */
	...
	__property bool IsBottomTop = {read=GetIsBottomTop, nodefault};
};
...
private:
	TIconImage* FImage;
	Winapi::Windows::TPoint FRequestedSize;
	System::Word FImageCount;
	System::Generics::Collections::TList__1<TIconRec>* FImages;
...
#else /* _WIN64 */
	__property HICON Handle = {read=GetHandle, write=SetHandle};
#endif /* _WIN64 */
	__property System::Word ImageCount = {read=FImageCount, nodefault};
	__property System::Generics::Collections::TList__1<TIconRec>* Images = {read=FImages};
	__property TIconImage* IconImage = {read=FImage};
};


enum DECLSPEC_DENUM TWICImageFormat : unsigned char { wifBmp, wifPng, wifJpeg, wifGif, wifTiff, wifWMPhoto, wifOther };

enum DECLSPEC_DENUM TWICImageInterpolationMode : unsigned char { wipmNone, wipmHighQualityCubic, wipmFant, wipmCubic, wipmLinear, wipmNearestNeighbor };
...
private:
	...
	TWICImage* FScaledBuffer;
	System::LongWord FFrameCount;
	System::LongWord FFrameIndex;
	TWICImageFormat FImageFormat;
	GUID FEncoderContainerFormat;
	bool FFormatChanged;
	TWICImageInterpolationMode FInterpolationMode;
	void __fastcall SetImageFormat(const TWICImageFormat Value);
	void __fastcall SetInterpolationMode(TWICImageInterpolationMode Value);
...
protected:
	...
	virtual void __fastcall Draw(TCanvas* ACanvas, const Winapi::Windows::TRect &Rect);
	virtual bool __fastcall GetEmpty();
	System::LongWord __fastcall GetFrameCount();
	virtual int __fastcall GetHeight();
	virtual int __fastcall GetWidth();
	virtual void __fastcall SetHeight(int Value);
	virtual void __fastcall SetWidth(int Value);
...
public:
	__fastcall virtual TWICImage()/* overload */;
	...
	__property System::LongWord FrameCount = {read=GetFrameCount, nodefault};
...
{
	typedef TWICImage inherited;
	
public:
	__classmethod virtual bool __fastcall CanLoadFromStream(System::Classes::TStream* Stream);
public:
	/* TWICImage.Create */ inline __fastcall virtual TWICImageEx()/* overload */ : TWICImage() { }
	/* TWICImage.Destroy */ inline __fastcall virtual ~TWICImageEx() { }
...
#pragma pack(push,4)
#endif /* not _WIN64 */
class PASCALIMPLEMENTATION TWICScaledGraphicDrawer : public TScaledGraphicDrawer
{
	typedef TScaledGraphicDrawer inherited;
	
private:
	TWICImage* FScaledBuffer;
	TWICImageInterpolationMode FInterpolationMode;
	void __fastcall SetInterpolationMode(TWICImageInterpolationMode AValue);
	
protected:
	virtual bool __fastcall GetInitialized();
	
public:
	__fastcall virtual TWICScaledGraphicDrawer(TGraphic* AGraphic, bool AInitialize);
	__fastcall virtual ~TWICScaledGraphicDrawer();
	virtual void __fastcall Initialize();
	virtual void __fastcall Draw(TCanvas* ACanvas, const Winapi::Windows::TRect &ARect)/* overload */;
	__property TWICImageInterpolationMode InterpolationMode = {read=FInterpolationMode, write=SetInterpolationMode, nodefault};
};
...
//-- var, const, procedure ---------------------------------------------------
static _DELPHI_CONST unsigned clSystemColor = unsigned(0xff000000);
static _DELPHI_CONST System::Uitypes::TColor clScrollBar = System::Uitypes::TColor(-16777216);
static _DELPHI_CONST System::Uitypes::TColor clBackground = System::Uitypes::TColor(-16777215);
static _DELPHI_CONST System::Uitypes::TColor clActiveCaption = System::Uitypes::TColor(-16777214);
static _DELPHI_CONST System::Uitypes::TColor clInactiveCaption = System::Uitypes::TColor(-16777213);
static _DELPHI_CONST System::Uitypes::TColor clMenu = System::Uitypes::TColor(-16777212);
static _DELPHI_CONST System::Uitypes::TColor clWindow = System::Uitypes::TColor(-16777211);
static _DELPHI_CONST System::Uitypes::TColor clWindowFrame = System::Uitypes::TColor(-16777210);
static _DELPHI_CONST System::Uitypes::TColor clMenuText = System::Uitypes::TColor(-16777209);
static _DELPHI_CONST System::Uitypes::TColor clWindowText = System::Uitypes::TColor(-16777208);
static _DELPHI_CONST System::Uitypes::TColor clCaptionText = System::Uitypes::TColor(-16777207);
static _DELPHI_CONST System::Uitypes::TColor clActiveBorder = System::Uitypes::TColor(-16777206);
static _DELPHI_CONST System::Uitypes::TColor clInactiveBorder = System::Uitypes::TColor(-16777205);
static _DELPHI_CONST System::Uitypes::TColor clAppWorkSpace = System::Uitypes::TColor(-16777204);
static _DELPHI_CONST System::Uitypes::TColor clHighlight = System::Uitypes::TColor(-16777203);
static _DELPHI_CONST System::Uitypes::TColor clHighlightText = System::Uitypes::TColor(-16777202);
static _DELPHI_CONST System::Uitypes::TColor clBtnFace = System::Uitypes::TColor(-16777201);
static _DELPHI_CONST System::Uitypes::TColor clBtnShadow = System::Uitypes::TColor(-16777200);
static _DELPHI_CONST System::Uitypes::TColor clGrayText = System::Uitypes::TColor(-16777199);
static _DELPHI_CONST System::Uitypes::TColor clBtnText = System::Uitypes::TColor(-16777198);
static _DELPHI_CONST System::Uitypes::TColor clInactiveCaptionText = System::Uitypes::TColor(-16777197);
static _DELPHI_CONST System::Uitypes::TColor clBtnHighlight = System::Uitypes::TColor(-16777196);
static _DELPHI_CONST System::Uitypes::TColor cl3DDkShadow = System::Uitypes::TColor(-16777195);
static _DELPHI_CONST System::Uitypes::TColor cl3DLight = System::Uitypes::TColor(-16777194);
static _DELPHI_CONST System::Uitypes::TColor clInfoText = System::Uitypes::TColor(-16777193);
static _DELPHI_CONST System::Uitypes::TColor clInfoBk = System::Uitypes::TColor(-16777192);
static _DELPHI_CONST System::Uitypes::TColor clHotLight = System::Uitypes::TColor(-16777190);
static _DELPHI_CONST System::Uitypes::TColor clGradientActiveCaption = System::Uitypes::TColor(-16777189);
static _DELPHI_CONST System::Uitypes::TColor clGradientInactiveCaption = System::Uitypes::TColor(-16777188);
static _DELPHI_CONST System::Uitypes::TColor clMenuHighlight = System::Uitypes::TColor(-16777187);
static _DELPHI_CONST System::Uitypes::TColor clMenuBar = System::Uitypes::TColor(-16777186);
static _DELPHI_CONST System::Uitypes::TColor clBlack = System::Uitypes::TColor(0);
static _DELPHI_CONST System::Uitypes::TColor clMaroon = System::Uitypes::TColor(128);
static _DELPHI_CONST System::Uitypes::TColor clGreen = System::Uitypes::TColor(32768);
static _DELPHI_CONST System::Uitypes::TColor clOlive = System::Uitypes::TColor(32896);
static _DELPHI_CONST System::Uitypes::TColor clNavy = System::Uitypes::TColor(8388608);
static _DELPHI_CONST System::Uitypes::TColor clPurple = System::Uitypes::TColor(8388736);
static _DELPHI_CONST System::Uitypes::TColor clTeal = System::Uitypes::TColor(8421376);
static _DELPHI_CONST System::Uitypes::TColor clGray = System::Uitypes::TColor(8421504);
static _DELPHI_CONST System::Uitypes::TColor clSilver = System::Uitypes::TColor(12632256);
static _DELPHI_CONST System::Uitypes::TColor clRed = System::Uitypes::TColor(255);
static _DELPHI_CONST System::Uitypes::TColor clLime = System::Uitypes::TColor(65280);
static _DELPHI_CONST System::Uitypes::TColor clYellow = System::Uitypes::TColor(65535);
static _DELPHI_CONST System::Uitypes::TColor clBlue = System::Uitypes::TColor(16711680);
static _DELPHI_CONST System::Uitypes::TColor clFuchsia = System::Uitypes::TColor(16711935);
static _DELPHI_CONST System::Uitypes::TColor clAqua = System::Uitypes::TColor(16776960);
static _DELPHI_CONST System::Uitypes::TColor clLtGray = System::Uitypes::TColor(12632256);
static _DELPHI_CONST System::Uitypes::TColor clDkGray = System::Uitypes::TColor(8421504);
static _DELPHI_CONST System::Uitypes::TColor clWhite = System::Uitypes::TColor(16777215);
static _DELPHI_CONST System::Int8 StandardColorsCount = System::Int8(0x10);
static _DELPHI_CONST System::Uitypes::TColor clMoneyGreen = System::Uitypes::TColor(12639424);
static _DELPHI_CONST System::Uitypes::TColor clSkyBlue = System::Uitypes::TColor(15780518);
static _DELPHI_CONST System::Uitypes::TColor clCream = System::Uitypes::TColor(15793151);
static _DELPHI_CONST System::Uitypes::TColor clMedGray = System::Uitypes::TColor(10789024);
static _DELPHI_CONST System::Int8 ExtendedColorsCount = System::Int8(0x4);
static _DELPHI_CONST System::Uitypes::TColor clNone = System::Uitypes::TColor(536870911);
static _DELPHI_CONST System::Uitypes::TColor clDefault = System::Uitypes::TColor(536870912);
static _DELPHI_CONST System::Uitypes::TColor clWebSnow = System::Uitypes::TColor(16448255);
static _DELPHI_CONST System::Uitypes::TColor clWebFloralWhite = System::Uitypes::TColor(15792895);
static _DELPHI_CONST System::Uitypes::TColor clWebLavenderBlush = System::Uitypes::TColor(16118015);
static _DELPHI_CONST System::Uitypes::TColor clWebOldLace = System::Uitypes::TColor(15136253);
static _DELPHI_CONST System::Uitypes::TColor clWebIvory = System::Uitypes::TColor(15794175);
static _DELPHI_CONST System::Uitypes::TColor clWebCornSilk = System::Uitypes::TColor(14481663);
static _DELPHI_CONST System::Uitypes::TColor clWebBeige = System::Uitypes::TColor(14480885);
static _DELPHI_CONST System::Uitypes::TColor clWebAntiqueWhite = System::Uitypes::TColor(14150650);
static _DELPHI_CONST System::Uitypes::TColor clWebWheat = System::Uitypes::TColor(11788021);
static _DELPHI_CONST System::Uitypes::TColor clWebAliceBlue = System::Uitypes::TColor(16775408);
static _DELPHI_CONST System::Uitypes::TColor clWebGhostWhite = System::Uitypes::TColor(16775416);
static _DELPHI_CONST System::Uitypes::TColor clWebLavender = System::Uitypes::TColor(16443110);
static _DELPHI_CONST System::Uitypes::TColor clWebSeashell = System::Uitypes::TColor(15660543);
static _DELPHI_CONST System::Uitypes::TColor clWebLightYellow = System::Uitypes::TColor(14745599);
static _DELPHI_CONST System::Uitypes::TColor clWebPapayaWhip = System::Uitypes::TColor(14020607);
static _DELPHI_CONST System::Uitypes::TColor clWebNavajoWhite = System::Uitypes::TColor(11394815);
static _DELPHI_CONST System::Uitypes::TColor clWebMoccasin = System::Uitypes::TColor(11920639);
static _DELPHI_CONST System::Uitypes::TColor clWebBurlywood = System::Uitypes::TColor(8894686);
static _DELPHI_CONST System::Uitypes::TColor clWebAzure = System::Uitypes::TColor(16777200);
static _DELPHI_CONST System::Uitypes::TColor clWebMintcream = System::Uitypes::TColor(16449525);
static _DELPHI_CONST System::Uitypes::TColor clWebHoneydew = System::Uitypes::TColor(15794160);
static _DELPHI_CONST System::Uitypes::TColor clWebLinen = System::Uitypes::TColor(15134970);
static _DELPHI_CONST System::Uitypes::TColor clWebLemonChiffon = System::Uitypes::TColor(13499135);
static _DELPHI_CONST System::Uitypes::TColor clWebBlanchedAlmond = System::Uitypes::TColor(13495295);
static _DELPHI_CONST System::Uitypes::TColor clWebBisque = System::Uitypes::TColor(12903679);
static _DELPHI_CONST System::Uitypes::TColor clWebPeachPuff = System::Uitypes::TColor(12180223);
static _DELPHI_CONST System::Uitypes::TColor clWebTan = System::Uitypes::TColor(9221330);
static _DELPHI_CONST System::Uitypes::TColor clWebYellow = System::Uitypes::TColor(65535);
static _DELPHI_CONST System::Uitypes::TColor clWebDarkOrange = System::Uitypes::TColor(36095);
static _DELPHI_CONST System::Uitypes::TColor clWebRed = System::Uitypes::TColor(255);
static _DELPHI_CONST System::Uitypes::TColor clWebDarkRed = System::Uitypes::TColor(139);
static _DELPHI_CONST System::Uitypes::TColor clWebMaroon = System::Uitypes::TColor(128);
static _DELPHI_CONST System::Uitypes::TColor clWebIndianRed = System::Uitypes::TColor(6053069);
static _DELPHI_CONST System::Uitypes::TColor clWebSalmon = System::Uitypes::TColor(7504122);
static _DELPHI_CONST System::Uitypes::TColor clWebCoral = System::Uitypes::TColor(5275647);
static _DELPHI_CONST System::Uitypes::TColor clWebGold = System::Uitypes::TColor(55295);
static _DELPHI_CONST System::Uitypes::TColor clWebTomato = System::Uitypes::TColor(4678655);
static _DELPHI_CONST System::Uitypes::TColor clWebCrimson = System::Uitypes::TColor(3937500);
static _DELPHI_CONST System::Uitypes::TColor clWebBrown = System::Uitypes::TColor(2763429);
static _DELPHI_CONST System::Uitypes::TColor clWebChocolate = System::Uitypes::TColor(1993170);
static _DELPHI_CONST System::Uitypes::TColor clWebSandyBrown = System::Uitypes::TColor(6333684);
static _DELPHI_CONST System::Uitypes::TColor clWebLightSalmon = System::Uitypes::TColor(8036607);
static _DELPHI_CONST System::Uitypes::TColor clWebLightCoral = System::Uitypes::TColor(8421616);
static _DELPHI_CONST System::Uitypes::TColor clWebOrange = System::Uitypes::TColor(42495);
static _DELPHI_CONST System::Uitypes::TColor clWebOrangeRed = System::Uitypes::TColor(17919);
static _DELPHI_CONST System::Uitypes::TColor clWebFirebrick = System::Uitypes::TColor(2237106);
static _DELPHI_CONST System::Uitypes::TColor clWebSaddleBrown = System::Uitypes::TColor(1262987);
static _DELPHI_CONST System::Uitypes::TColor clWebSienna = System::Uitypes::TColor(2970272);
static _DELPHI_CONST System::Uitypes::TColor clWebPeru = System::Uitypes::TColor(4163021);
static _DELPHI_CONST System::Uitypes::TColor clWebDarkSalmon = System::Uitypes::TColor(8034025);
static _DELPHI_CONST System::Uitypes::TColor clWebRosyBrown = System::Uitypes::TColor(9408444);
static _DELPHI_CONST System::Uitypes::TColor clWebPaleGoldenrod = System::Uitypes::TColor(11200750);
static _DELPHI_CONST System::Uitypes::TColor clWebLightGoldenrodYellow = System::Uitypes::TColor(13826810);
static _DELPHI_CONST System::Uitypes::TColor clWebOlive = System::Uitypes::TColor(32896);
static _DELPHI_CONST System::Uitypes::TColor clWebForestGreen = System::Uitypes::TColor(2263842);
static _DELPHI_CONST System::Uitypes::TColor clWebGreenYellow = System::Uitypes::TColor(3145645);
static _DELPHI_CONST System::Uitypes::TColor clWebChartreuse = System::Uitypes::TColor(65407);
static _DELPHI_CONST System::Uitypes::TColor clWebLightGreen = System::Uitypes::TColor(9498256);
static _DELPHI_CONST System::Uitypes::TColor clWebAquamarine = System::Uitypes::TColor(13959039);
static _DELPHI_CONST System::Uitypes::TColor clWebSeaGreen = System::Uitypes::TColor(5737262);
static _DELPHI_CONST System::Uitypes::TColor clWebGoldenRod = System::Uitypes::TColor(2139610);
static _DELPHI_CONST System::Uitypes::TColor clWebKhaki = System::Uitypes::TColor(9234160);
static _DELPHI_CONST System::Uitypes::TColor clWebOliveDrab = System::Uitypes::TColor(2330219);
static _DELPHI_CONST System::Uitypes::TColor clWebGreen = System::Uitypes::TColor(32768);
static _DELPHI_CONST System::Uitypes::TColor clWebYellowGreen = System::Uitypes::TColor(3329434);
static _DELPHI_CONST System::Uitypes::TColor clWebLawnGreen = System::Uitypes::TColor(64636);
static _DELPHI_CONST System::Uitypes::TColor clWebPaleGreen = System::Uitypes::TColor(10025880);
static _DELPHI_CONST System::Uitypes::TColor clWebMediumAquamarine = System::Uitypes::TColor(11193702);
static _DELPHI_CONST System::Uitypes::TColor clWebMediumSeaGreen = System::Uitypes::TColor(7451452);
static _DELPHI_CONST System::Uitypes::TColor clWebDarkGoldenRod = System::Uitypes::TColor(755384);
static _DELPHI_CONST System::Uitypes::TColor clWebDarkKhaki = System::Uitypes::TColor(7059389);
static _DELPHI_CONST System::Uitypes::TColor clWebDarkOliveGreen = System::Uitypes::TColor(3107669);
static _DELPHI_CONST System::Uitypes::TColor clWebDarkgreen = System::Uitypes::TColor(25600);
static _DELPHI_CONST System::Uitypes::TColor clWebLimeGreen = System::Uitypes::TColor(3329330);
static _DELPHI_CONST System::Uitypes::TColor clWebLime = System::Uitypes::TColor(65280);
static _DELPHI_CONST System::Uitypes::TColor clWebSpringGreen = System::Uitypes::TColor(8388352);
static _DELPHI_CONST System::Uitypes::TColor clWebMediumSpringGreen = System::Uitypes::TColor(10156544);
static _DELPHI_CONST System::Uitypes::TColor clWebDarkSeaGreen = System::Uitypes::TColor(9419919);
static _DELPHI_CONST System::Uitypes::TColor clWebLightSeaGreen = System::Uitypes::TColor(11186720);
static _DELPHI_CONST System::Uitypes::TColor clWebPaleTurquoise = System::Uitypes::TColor(15658671);
static _DELPHI_CONST System::Uitypes::TColor clWebLightCyan = System::Uitypes::TColor(16777184);
static _DELPHI_CONST System::Uitypes::TColor clWebLightBlue = System::Uitypes::TColor(15128749);
static _DELPHI_CONST System::Uitypes::TColor clWebLightSkyBlue = System::Uitypes::TColor(16436871);
static _DELPHI_CONST System::Uitypes::TColor clWebCornFlowerBlue = System::Uitypes::TColor(15570276);
static _DELPHI_CONST System::Uitypes::TColor clWebDarkBlue = System::Uitypes::TColor(9109504);
static _DELPHI_CONST System::Uitypes::TColor clWebIndigo = System::Uitypes::TColor(8519755);
static _DELPHI_CONST System::Uitypes::TColor clWebMediumTurquoise = System::Uitypes::TColor(13422920);
static _DELPHI_CONST System::Uitypes::TColor clWebTurquoise = System::Uitypes::TColor(13688896);
static _DELPHI_CONST System::Uitypes::TColor clWebCyan = System::Uitypes::TColor(16776960);
static _DELPHI_CONST System::Uitypes::TColor clWebAqua = System::Uitypes::TColor(16776960);
static _DELPHI_CONST System::Uitypes::TColor clWebPowderBlue = System::Uitypes::TColor(15130800);
static _DELPHI_CONST System::Uitypes::TColor clWebSkyBlue = System::Uitypes::TColor(15453831);
static _DELPHI_CONST System::Uitypes::TColor clWebRoyalBlue = System::Uitypes::TColor(14772545);
static _DELPHI_CONST System::Uitypes::TColor clWebMediumBlue = System::Uitypes::TColor(13434880);
static _DELPHI_CONST System::Uitypes::TColor clWebMidnightBlue = System::Uitypes::TColor(7346457);
static _DELPHI_CONST System::Uitypes::TColor clWebDarkTurquoise = System::Uitypes::TColor(13749760);
static _DELPHI_CONST System::Uitypes::TColor clWebCadetBlue = System::Uitypes::TColor(10526303);
static _DELPHI_CONST System::Uitypes::TColor clWebDarkCyan = System::Uitypes::TColor(9145088);
static _DELPHI_CONST System::Uitypes::TColor clWebTeal = System::Uitypes::TColor(8421376);
static _DELPHI_CONST System::Uitypes::TColor clWebDeepskyBlue = System::Uitypes::TColor(16760576);
static _DELPHI_CONST System::Uitypes::TColor clWebDodgerBlue = System::Uitypes::TColor(16748574);
static _DELPHI_CONST System::Uitypes::TColor clWebBlue = System::Uitypes::TColor(16711680);
static _DELPHI_CONST System::Uitypes::TColor clWebNavy = System::Uitypes::TColor(8388608);
static _DELPHI_CONST System::Uitypes::TColor clWebDarkViolet = System::Uitypes::TColor(13828244);
static _DELPHI_CONST System::Uitypes::TColor clWebDarkOrchid = System::Uitypes::TColor(13382297);
static _DELPHI_CONST System::Uitypes::TColor clWebMagenta = System::Uitypes::TColor(16711935);
static _DELPHI_CONST System::Uitypes::TColor clWebFuchsia = System::Uitypes::TColor(16711935);
static _DELPHI_CONST System::Uitypes::TColor clWebDarkMagenta = System::Uitypes::TColor(9109643);
static _DELPHI_CONST System::Uitypes::TColor clWebMediumVioletRed = System::Uitypes::TColor(8721863);
static _DELPHI_CONST System::Uitypes::TColor clWebPaleVioletRed = System::Uitypes::TColor(9662683);
static _DELPHI_CONST System::Uitypes::TColor clWebBlueViolet = System::Uitypes::TColor(14822282);
static _DELPHI_CONST System::Uitypes::TColor clWebMediumOrchid = System::Uitypes::TColor(13850042);
static _DELPHI_CONST System::Uitypes::TColor clWebMediumPurple = System::Uitypes::TColor(14381203);
static _DELPHI_CONST System::Uitypes::TColor clWebPurple = System::Uitypes::TColor(8388736);
static _DELPHI_CONST System::Uitypes::TColor clWebDeepPink = System::Uitypes::TColor(9639167);
static _DELPHI_CONST System::Uitypes::TColor clWebLightPink = System::Uitypes::TColor(12695295);
static _DELPHI_CONST System::Uitypes::TColor clWebViolet = System::Uitypes::TColor(15631086);
static _DELPHI_CONST System::Uitypes::TColor clWebOrchid = System::Uitypes::TColor(14053594);
static _DELPHI_CONST System::Uitypes::TColor clWebPlum = System::Uitypes::TColor(14524637);
static _DELPHI_CONST System::Uitypes::TColor clWebThistle = System::Uitypes::TColor(14204888);
static _DELPHI_CONST System::Uitypes::TColor clWebHotPink = System::Uitypes::TColor(11823615);
static _DELPHI_CONST System::Uitypes::TColor clWebPink = System::Uitypes::TColor(13353215);
static _DELPHI_CONST System::Uitypes::TColor clWebLightSteelBlue = System::Uitypes::TColor(14599344);
static _DELPHI_CONST System::Uitypes::TColor clWebMediumSlateBlue = System::Uitypes::TColor(15624315);
static _DELPHI_CONST System::Uitypes::TColor clWebLightSlateGray = System::Uitypes::TColor(10061943);
static _DELPHI_CONST System::Uitypes::TColor clWebWhite = System::Uitypes::TColor(16777215);
static _DELPHI_CONST System::Uitypes::TColor clWebLightgrey = System::Uitypes::TColor(13882323);
static _DELPHI_CONST System::Uitypes::TColor clWebGray = System::Uitypes::TColor(8421504);
static _DELPHI_CONST System::Uitypes::TColor clWebSteelBlue = System::Uitypes::TColor(11829830);
static _DELPHI_CONST System::Uitypes::TColor clWebSlateBlue = System::Uitypes::TColor(13458026);
static _DELPHI_CONST System::Uitypes::TColor clWebSlateGray = System::Uitypes::TColor(9470064);
static _DELPHI_CONST System::Uitypes::TColor clWebWhiteSmoke = System::Uitypes::TColor(16119285);
static _DELPHI_CONST System::Uitypes::TColor clWebSilver = System::Uitypes::TColor(12632256);
static _DELPHI_CONST System::Uitypes::TColor clWebDimGray = System::Uitypes::TColor(6908265);
static _DELPHI_CONST System::Uitypes::TColor clWebMistyRose = System::Uitypes::TColor(14804223);
static _DELPHI_CONST System::Uitypes::TColor clWebDarkSlateBlue = System::Uitypes::TColor(9125192);
static _DELPHI_CONST System::Uitypes::TColor clWebDarkSlategray = System::Uitypes::TColor(5197615);
static _DELPHI_CONST System::Uitypes::TColor clWebGainsboro = System::Uitypes::TColor(14474460);
static _DELPHI_CONST System::Uitypes::TColor clWebDarkGray = System::Uitypes::TColor(11119017);
static _DELPHI_CONST System::Uitypes::TColor clWebBlack = System::Uitypes::TColor(0);
static _DELPHI_CONST System::Byte WebColorsCount = System::Byte(0x8c);
static _DELPHI_CONST System::Int8 cmBlackness = System::Int8(0x42);
static _DELPHI_CONST int cmDstInvert = int(0x550009);
static _DELPHI_CONST int cmMergeCopy = int(0xc000ca);
static _DELPHI_CONST int cmMergePaint = int(0xbb0226);
static _DELPHI_CONST int cmNotSrcCopy = int(0x330008);
static _DELPHI_CONST int cmNotSrcErase = int(0x1100a6);
static _DELPHI_CONST int cmPatCopy = int(0xf00021);
static _DELPHI_CONST int cmPatInvert = int(0x5a0049);
static _DELPHI_CONST int cmPatPaint = int(0xfb0a09);
static _DELPHI_CONST int cmSrcAnd = int(0x8800c6);
static _DELPHI_CONST int cmSrcCopy = int(0xcc0020);
static _DELPHI_CONST int cmSrcErase = int(0x440328);
static _DELPHI_CONST int cmSrcInvert = int(0x660046);
static _DELPHI_CONST int cmSrcPaint = int(0xee0086);
static _DELPHI_CONST int cmWhiteness = int(0xff0062);
static _DELPHI_CONST System::Int8 rc3_StockIcon = System::Int8(0x0);
static _DELPHI_CONST System::Int8 rc3_Icon = System::Int8(0x1);
static _DELPHI_CONST System::Int8 rc3_Cursor = System::Int8(0x2);
...
extern DELPHI_PACKAGE System::LongInt __fastcall ColorToRGB(System::Uitypes::TColor Color);
...
extern DELPHI_PACKAGE bool __fastcall IdentToColor(const System::UnicodeString Ident, System::LongInt &Color);
extern DELPHI_PACKAGE void __fastcall GetCharsetValues(System::Classes::TGetStrProc Proc);
extern DELPHI_PACKAGE bool __fastcall CharsetToIdent(System::LongInt Charset, System::UnicodeString &Ident);
extern DELPHI_PACKAGE bool __fastcall IdentToCharset(const System::UnicodeString Ident, System::LongInt &Charset);
extern DELPHI_PACKAGE System::LongInt __fastcall BytesPerScanline(System::LongInt PixelsPerScanline, System::LongInt BitsPerPixel, System::LongInt Alignment);
