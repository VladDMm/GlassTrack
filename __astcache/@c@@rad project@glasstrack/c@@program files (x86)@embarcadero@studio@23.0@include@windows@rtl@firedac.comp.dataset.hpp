...
// (DO NOT EDIT: machine generated header) 'FireDAC.Comp.DataSet.pas' rev: 36.00 (Windows)
...
enum DECLSPEC_DENUM TFDDataSetFlag : unsigned int { dfOpenBlob, dfOfflining, dfKeyBuffersAllocated, dfRangeFromExclusive, dfRangeToExclusive, dfLockNoBMK, dfClearIndexDefs, dfColumnAttributesUpdated, dfCalcFieldInIndex, dfStreamedActive, dfPreserveCurrentIndex, dfPostRow, dfDataSetOpened, dfNoRecNoCmp, dfDataSetOpening, dfDeleting };
...
enum DECLSPEC_DENUM TFDCopyDataSetOption : unsigned int { coStructure, coCalcFields, coIndexesReset, coIndexesCopy, coConstraintsReset, coConstraintsCopy, coAggregatesReset, coAggregatesCopy, coRestart, coAppend, coEdit, coDelete, coRefresh };

typedef System::Set<TFDCopyDataSetOption, TFDCopyDataSetOption::coStructure, TFDCopyDataSetOption::coRefresh> TFDCopyDataSetOptions;

enum DECLSPEC_DENUM TFDStoredActivationUsageItem : unsigned int { auDesignTime, auRunTime };

typedef System::Set<TFDStoredActivationUsageItem, TFDStoredActivationUsageItem::auDesignTime, TFDStoredActivationUsageItem::auRunTime> TFDStoredActivationUsage;

enum DECLSPEC_DENUM TFDUpdateRecordType : unsigned int { rtModified, rtInserted, rtDeleted, rtUnmodified, rtHasErrors };
...
private:
	...
	void *FDataLoadSave;
	Firedac::Stan::Intf::TFDObjList* FCreatedConstraints;
	Firedac::Dats::TFDDatSRow* FLocateRow;
	Firedac::Dats::TFDDatSColumnSublist* FLocateColumns;
	Firedac::Stan::Intf::TFDObjList* FTempIndexViews;
	System::LongWord FLastSavePoint;
	...
	Data::Db::TFieldDef* __fastcall AddFieldDesc(Firedac::Stan::Option::TFDFormatOptions* AFmtOpts, Data::Db::TFieldDefs* ADefs, Firedac::Dats::TFDDatSColumn* AColumn, int &AFieldId, Firedac::Stan::Intf::TFDPtrList* APath);
	void __fastcall AddTableDesc(Firedac::Stan::Option::TFDFormatOptions* AFmtOpts, Data::Db::TFieldDefs* ADefs, Firedac::Dats::TFDDatSTable* ATable, int &AFieldId, Firedac::Stan::Intf::TFDPtrList* APath);
	void __fastcall SetIndexName(const System::UnicodeString AValue);
	...
	void __fastcall SetKeyFields(TFDKeyIndex AKeyIndex, const System::TVarRec *AValues, const System::NativeInt AValues_High, bool AExclusive = false);
	...
	bool __fastcall GetFieldColumn(Data::Db::TRecBuf ARecBuff, int AFieldNo, Firedac::Dats::TFDDatSColumn* &AColumn, int &AColumnIndex, Firedac::Dats::TFDDatSRow* &ARow, bool AInitNested = false)/* overload */;
	...
	void __fastcall SetSecurityOptions(Firedac::Stan::Option::TFDSecurityOptions* const AValue);
	...
	Firedac::Stan::Option::TFDSecurityOptions* __fastcall GetSecurityOptions();
	...
	Firedac::Dats::TFDDatSRow* __fastcall GetRowFromBookmark(Data::Db::TBookmark ABookmark, /* out */ int &ARowIndex, /* out */ int &AResultSetNum);
	...
	PFDRecInfo __fastcall GetRecInfo(Data::Db::TRecBuf ABuffer)/* overload */;
...
protected:
	...
	virtual System::NativeUInt __fastcall GetConn();
	...
	Data::Db::TRecBuf __fastcall AllocRecBuf();
	void __fastcall FreeRecBuf(Data::Db::TRecBuf &Buffer);
	...
	virtual void __fastcall ClearCalcFields(Data::Db::TRecordBuffer Buffer)/* overload */;
	...
	bool __fastcall GetActiveRecBuf(Data::Db::TRecBuf &RecBuf);
	...
	virtual Data::Db::TFieldKinds __fastcall GetStoredFieldKinds();
#ifndef _WIN64
	int __fastcall GetRowIndex(Data::Db::TRecBuf ABuffer = 0x0);
#else /* _WIN64 */
	int __fastcall GetRowIndex(Data::Db::TRecBuf ABuffer = (__int64)(0LL));
#endif /* _WIN64 */
	...
	virtual void __fastcall SetBookmarkFlag(Data::Db::TRecBuf Buffer, Data::Db::TBookmarkFlag AValue)/* overload */;
	virtual void __fastcall SetBookmarkFlag(Data::Db::TRecordBuffer Buffer, Data::Db::TBookmarkFlag AValue)/* overload */;
	...
	virtual System::LongWord __fastcall CalcBookmarkSize();
	...
	virtual void __fastcall DoMasterParamSetValues(TFDFieldList* AMasterFieldList);
	virtual bool __fastcall DoMasterParamDependent(TFDFieldList* AMasterFieldList);
	...
	void __fastcall CheckRefreshStoredCalcFields();
	...
	__property Firedac::Stan::Option::TFDSecurityOptions* SecurityOptions = {read=GetSecurityOptions, write=SetSecurityOptions};
...
public:
	...
	virtual bool __fastcall BookmarkValid(Data::Db::TBookmark ABookmark);
	bool __fastcall BookmarkStrValid(Data::Db::TBookmarkStr ABookmarkStr);
	...
	virtual void __fastcall CloneCursor(TFDDataSet* ASource, bool AReset = false, bool AKeepSettings = false, bool AFields = false);
	...
	virtual bool __fastcall GetFieldData(int AFieldNo, Data::Db::TValueBuffer &ABuffer)/* overload */;
	virtual bool __fastcall GetFieldData(Data::Db::TField* AField, Data::Db::TValueBuffer &ABuffer)/* overload */;
...
#else /* _WIN64 */
	Firedac::Dats::TFDDatSRow* __fastcall GetRow(Data::Db::TRecBuf ABuffer = (__int64)(0LL), bool AForceBufferRead = false);
#endif /* _WIN64 */
	...
	void __fastcall RefreshUnknownRecord(const System::Variant *AValues, const System::NativeInt AValues_High, bool AReread = true, bool ASetPos = true);
	...
	void __fastcall SetRange(const System::TVarRec *AStartValues, const System::NativeInt AStartValues_High, const System::TVarRec *AEndValues, const System::NativeInt AEndValues_High, bool AStartExclusive = false, bool AEndExclusive = false);
...
protected:
	inline void __fastcall  GetBookmarkData _DEPRECATED_ATTRIBUTE1("Use overloaded method instead") (Data::Db::TRecordBuffer Buffer, Data::Db::TBookmark Data){ Data::Db::TDataSet::GetBookmarkData(Buffer, Data); }
	inline void __fastcall  GetBookmarkData _DEPRECATED_ATTRIBUTE1("Use overloaded method instead") (Data::Db::TRecordBuffer Buffer, void * Data){ Data::Db::TDataSet::GetBookmarkData(Buffer, Data); }
	inline Data::Db::TBookmarkFlag __fastcall  GetBookmarkFlag _DEPRECATED_ATTRIBUTE1("Use overloaded method instead") (Data::Db::TRecordBuffer Buffer){ return Data::Db::TDataSet::GetBookmarkFlag(Buffer); }
	inline void __fastcall  InitRecord _DEPRECATED_ATTRIBUTE1("Use overloaded method instead") (Data::Db::TRecordBuffer Buffer){ Data::Db::TDataSet::InitRecord(Buffer); }
	inline void __fastcall  InternalAddRecord _DEPRECATED_ATTRIBUTE1("Use overloaded method instead") (Data::Db::TRecordBuffer Buffer, bool Append){ Data::Db::TDataSet::InternalAddRecord(Buffer, Append); }
	...
	inline void __fastcall  InternalSetToRecord _DEPRECATED_ATTRIBUTE1("Use overloaded method instead") (Data::Db::TRecordBuffer Buffer){ Data::Db::TDataSet::InternalSetToRecord(Buffer); }
...
private:
	void *__IBatchDataSet;	// Data::Db::IBatchDataSet 
...
public:
	...
	{
		Data::Db::_di_IBatchDataSet intf;
		this->GetInterface(intf);
		return intf;
	}
	#else
	operator Data::Db::IBatchDataSet*(void) { return (Data::Db::IBatchDataSet*)&__IBatchDataSet; }
	#endif
	#if defined(MANAGED_INTERFACE_OPERATORS)
...
//-- var, const, procedure ---------------------------------------------------
#ifndef _WIN64
static _DELPHI_CONST int C_NIL = int(0);
#else /* _WIN64 */
static _DELPHI_CONST __int64 C_NIL = 0LL;
#endif /* _WIN64 */
