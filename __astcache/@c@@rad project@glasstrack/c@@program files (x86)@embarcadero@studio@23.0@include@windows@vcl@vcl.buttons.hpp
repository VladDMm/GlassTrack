...
private:
	...
	bool FModifiedGlyph;
	bool FMouseInControl;
	void __fastcall DrawItem(const Winapi::Windows::TDrawItemStruct &DrawItemStruct);
	void __fastcall SetGlyph(Vcl::Graphics::TBitmap* Value);
	Vcl::Graphics::TBitmap* __fastcall GetGlyph();
	TNumGlyphs __fastcall GetNumGlyphs();
	void __fastcall SetNumGlyphs(TNumGlyphs Value);
...
__published:
	...
	__property DoubleBufferedMode = {default=1};
...
protected:
	...
	public:
		...
		int ImageIndex;
		Winapi::Windows::HINST GlyphResInstance;
...
private:
	...
	int ButtonWidth;
	int ButtonHeight;
	Winapi::Windows::TPoint MinBtnSize;
	TNavBtnID FocusedButton;
	bool FConfirmDelete;
	bool FFlat;
	...
	bool __fastcall UseGlyphs();
	
protected:
	virtual void __fastcall BtnIDClick(TNavBtnID Index);
	void __fastcall DefineButtons(const System::DynamicArray<TButtonDescription> ADescriptions);
	TNavButton* __fastcall GetButton(TNavBtnID Index);
	HIDESBASE void __fastcall SetVisible(const System::DynamicArray<int> Value);
	...
	virtual void __fastcall Loaded();
	virtual void __fastcall Paint();
	virtual void __fastcall SetButtonGlyph(TNavBtnID Index);
...
enum DECLSPEC_DENUM TNavButtonStyleItem : unsigned char { nsAllowTimer };

typedef System::Set<TNavButtonStyleItem, TNavButtonStyleItem::nsAllowTimer, TNavButtonStyleItem::nsAllowTimer> TNavButtonStyle;
...
public:
	...
	__property TNavBtnID Index = {read=FIndex, write=FIndex, nodefault};
