...
// (DO NOT EDIT: machine generated header) 'Data.FmtBcd.pas' rev: 36.00 (Windows)
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EBcdException(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : System::Sysutils::Exception(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EBcdException(System::NativeUInt Ident)/* overload */ : System::Sysutils::Exception(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EBcdException(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EBcdException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EBcdException(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : System::Sysutils::Exception(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EBcdException(System::NativeUInt Ident, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EBcdException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EBcdException(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EBcdOverflowException(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : EBcdException(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EBcdOverflowException(System::NativeUInt Ident)/* overload */ : EBcdException(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EBcdOverflowException(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : EBcdException(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EBcdOverflowException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : EBcdException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EBcdOverflowException(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : EBcdException(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EBcdOverflowException(System::NativeUInt Ident, int AHelpContext)/* overload */ : EBcdException(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EBcdOverflowException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : EBcdException(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EBcdOverflowException(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : EBcdException(Ident, Args, Args_High, AHelpContext) { }
...
//-- var, const, procedure ---------------------------------------------------
static _DELPHI_CONST System::Int8 MaxStringDigits = System::Int8(0x64);
static _DELPHI_CONST short _NoDecimal = short(-255);
static _DELPHI_CONST System::Int8 _DefaultDecimals = System::Int8(0xa);
static _DELPHI_CONST System::Int8 MaxFMTBcdFractionSize = System::Int8(0x40);
static _DELPHI_CONST System::Int8 MaxFMTBcdDigits = System::Int8(0x20);
static _DELPHI_CONST System::Int8 DefaultFMTBcdScale = System::Int8(0x6);
static _DELPHI_CONST System::Int8 MaxBcdPrecision = System::Int8(0x12);
static _DELPHI_CONST System::Int8 MaxBcdScale = System::Int8(0x4);
static _DELPHI_CONST System::Int8 SizeOfFraction = System::Int8(0x20);
static _DELPHI_CONST System::Int8 SizeOfTBCD = System::Int8(0x22);
...
extern DELPHI_PACKAGE System::TVarType __fastcall VarFMTBcd(void);
