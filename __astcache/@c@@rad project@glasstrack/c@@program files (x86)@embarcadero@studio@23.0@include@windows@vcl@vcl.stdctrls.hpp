...
// (DO NOT EDIT: machine generated header) 'Vcl.StdCtrls.pas' rev: 36.00 (Windows)
...
class DELPHICLASS TEditMargins;
...
private:
	...
	bool __fastcall IsHeaderFontStored();
	void __fastcall SetDefaultHeaderFont(bool Value);
...
protected:
	...
	virtual void __fastcall CheckDefaultHeaderFont();
	virtual void __fastcall CreateParams(Vcl::Controls::TCreateParams &Params);
	virtual void __fastcall Paint();
	
public:
	__fastcall virtual TCustomGroupBox(System::Classes::TComponent* AOwner);
	__fastcall virtual ~TCustomGroupBox();
	__property bool DefaultHeaderFont = {read=FDefaultHeaderFont, write=SetDefaultHeaderFont, default=1};
...
public:
	...
	/* TCustomGroupBox.Destroy */ inline __fastcall virtual ~TGroupBox() { }
...
typedef void __fastcall (__closure *TFNDrawText)(HDC DC, const System::UnicodeString Text, Winapi::Windows::TRect &TextRect, unsigned TextFlags);
...
private:
	...
	void __fastcall DoDrawThemeTextEx(HDC DC, const System::UnicodeString Text, Winapi::Windows::TRect &TextRect, unsigned TextFlags);
	void __fastcall DoDrawNormalText(HDC DC, const System::UnicodeString Text, Winapi::Windows::TRect &TextRect, unsigned TextFlags);
...
protected:
	...
	DYNAMIC void __fastcall DoDrawText(Winapi::Windows::TRect &Rect, System::LongInt Flags);
...
private:
	...
	bool FSavedReadOnly;
	System::Classes::TAlignment FSavedAlignment;
	int FSavedMaxLength;
	bool FCanUndoSelText;
...
private:
	...
	HIDESBASE MESSAGE void __fastcall CMCtl3DChanged(Winapi::Messages::TMessage &Message);
	HIDESBASE MESSAGE void __fastcall CMEnter(Vcl::Controls::TCMEnter &Message);
...
class PASCALIMPLEMENTATION TEditMargins : public System::Classes::TPersistent
{
	typedef System::Classes::TPersistent inherited;
	
private:
	Vcl::Controls::TMarginSize FLeft;
	Vcl::Controls::TMarginSize FRight;
	bool FAuto;
	System::Classes::TNotifyEvent FOnChange;
	void __fastcall SetLeftMargin(Vcl::Controls::TMarginSize Value);
	void __fastcall SetRightMargin(Vcl::Controls::TMarginSize Value);
	void __fastcall SetAutoMargin(bool Value);
...
__published:
	__property Vcl::Controls::TMarginSize Left = {read=FLeft, write=SetLeftMargin, default=0};
	__property Vcl::Controls::TMarginSize Right = {read=FRight, write=SetRightMargin, default=0};
	__property bool Auto = {read=FAuto, write=SetAutoMargin, default=0};
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TEditMargins() { }
	
public:
	/* TObject.Create */ inline __fastcall TEditMargins() : System::Classes::TPersistent() { }
...
private:
	void __fastcall DoEditMarginChange(System::TObject* Sender);
	HIDESBASE MESSAGE void __fastcall CMFontChanged(Winapi::Messages::TMessage &Message);
...
protected:
	...
	void __fastcall SetEditMargins(TEditMargins* Value);
...
public:
	...
	__property Winapi::Windows::TPoint CaretPos = {read=GetCaretPos, write=SetCaretPos};
	__property TEditMargins* EditMargins = {read=FEditMargins, write=SetEditMargins};
...
typedef void __fastcall (__closure *TDrawItemEvent)(Vcl::Controls::TWinControl* Control, int Index, const Winapi::Windows::TRect &Rect, Winapi::Windows::TOwnerDrawState State);
...
#else /* _WIN64 */
_DECLARE_METACLASS(System::TMetaClass, TCustomComboBoxStringsClass);
#endif /* _WIN64 */
...
protected:
	...
	Vcl::Controls::TWindowProcPtr FDefListProc;
	bool FDroppingDown;
	bool FFocusChanged;
	bool FIsFocused;
	int FSaveIndex;
	void *FEditInstance;
	void *FListInstance;
	System::Types::TSmallPoint FLastEditMousePos;
	System::Types::TSmallPoint FLastComboMousePos;
	virtual void __fastcall AdjustDropDown();
	virtual void __fastcall ComboWndProc(Winapi::Messages::TMessage &Message, HWND ComboWnd, Vcl::Controls::TWindowProcPtr ComboProc);
	virtual void __fastcall CreateWnd();
	DYNAMIC void __fastcall ChangeScale(int M, int D, bool isDpiChange)/* overload */;
...
protected:
	...
	virtual void __fastcall DrawItem(int Index, const Winapi::Windows::TRect &Rect, Winapi::Windows::TOwnerDrawState State);
...
public:
	...
	__property bool ExtendedUI = {read=FExtendedUI, write=SetExtendedUI, default=0};
	__property bool CanUndoSelText = {read=FCanUndoSelText, write=FCanUndoSelText, default=0};
	__property System::UnicodeString SelText = {read=GetSelText, write=SetSelText};
	__property System::UnicodeString TextHint = {read=FTextHint, write=SetTextHint};
public:
...
__published:
	...
	__property Enabled = {default=1};
	__property ExtendedUI = {default=0};
	__property Font;
	__property ImeMode = {default=3};
	__property ImeName = {default=0};
...
#else /* _WIN64 */
_DECLARE_METACLASS(System::TMetaClass, TButtonActionLinkClass);
#endif /* _WIN64 */
...
private:
	...
	MESSAGE void __fastcall CNCtlColorStatic(Winapi::Messages::TWMCtlColorStatic &Message);
	HIDESBASE MESSAGE void __fastcall WMEraseBkGnd(Winapi::Messages::TWMEraseBkgnd &Message);
...
#else /* _WIN64 */
_DECLARE_METACLASS(System::TMetaClass, TPushButtonActionLinkClass);
#endif /* _WIN64 */
...
private:
	...
	System::Uitypes::TImageName FStylusHotImageName;
...
private:
	...
	HIDESBASE MESSAGE void __fastcall CMDialogChar(Vcl::Controls::TCMDialogChar &Message);
	MESSAGE void __fastcall CNCommand(Winapi::Messages::TWMCommand &Message);
	MESSAGE void __fastcall CNCtlColorBtn(Winapi::Messages::TWMCtlColorBtn &Message);
	...
	void __fastcall SetStylusHotImageName(const System::Uitypes::TImageName Value);
...
#ifndef _WIN64
	virtual void __fastcall SetImageList(unsigned AHandle);
#else /* _WIN64 */
	virtual void __fastcall SetImageList(unsigned __int64 AHandle);
#endif /* _WIN64 */
...
public:
	...
	__property System::Uitypes::TImageName StylusHotImageName = {read=FStylusHotImageName, write=SetStylusHotImageName};
	__property TabStop = {default=1};
...
__published:
	...
	__property StylusHotImageName = {default=0};
	__property TabOrder = {default=-1};
	__property TabStop = {default=1};
	__property Visible = {default=1};
	__property WordWrap = {default=0};
...
private:
	System::Classes::TLeftRight FAlignment;
	bool FAllowGrayed;
...
#ifndef _WIN64
typedef int TListBoxItemData;
#else /* _WIN64 */
typedef __int64 TListBoxItemData;
#endif /* _WIN64 */
...
protected:
	...
	virtual void __fastcall Loaded();
	virtual void __fastcall MeasureItem(int Index, int &Height);
	DYNAMIC TListBoxItemData __fastcall InternalGetItemData(int Index);
	DYNAMIC void __fastcall InternalSetItemData(int Index, TListBoxItemData AData);
	DYNAMIC TListBoxItemData __fastcall GetItemData(int Index);
	virtual int __fastcall GetItemIndex();
	...
	DYNAMIC void __fastcall SetItemData(int Index, TListBoxItemData AData);
...
public:
	...
	Winapi::Windows::TRect __fastcall ItemRect(int Index);
	virtual void __fastcall SelectAll();
	__property unsigned AutoCompleteDelay = {read=FAutoCompleteDelay, write=FAutoCompleteDelay, default=500};
	__property bool AutoComplete = {read=FAutoComplete, write=FAutoComplete, default=1};
	__property Vcl::Graphics::TCanvas* Canvas = {read=FCanvas};
...
private:
	...
	Winapi::Windows::TRect __fastcall ControlBounds();
	bool __fastcall Horizontal();
	Winapi::Windows::TRect __fastcall HorzDownButtonRect();
	Winapi::Windows::TRect __fastcall HorzScrollRect();
	Winapi::Windows::TRect __fastcall HorzSliderRect();
	Winapi::Windows::TRect __fastcall HorzTrackRect();
	Winapi::Windows::TRect __fastcall HorzUpButtonRect();
	void __fastcall InitScrollBar();
	void __fastcall PaintScrollBar();
	Winapi::Windows::TRect __fastcall VertDownButtonRect();
	Winapi::Windows::TRect __fastcall VertScrollRect();
	Winapi::Windows::TRect __fastcall VertSliderRect();
	Winapi::Windows::TRect __fastcall VertTrackRect();
	Winapi::Windows::TRect __fastcall VertUpButtonRect();
	...
	MESSAGE void __fastcall WMWindowPosChanged(Winapi::Messages::TWMWindowPosChanging &Message);
...
private:
	Winapi::Windows::TPoint FDownPos;
	Winapi::Windows::TPoint FMovePos;
	int FDownSliderPos;
	int FOldIdx;
	int FInvsibleCount;
	int FSliderSize;
	...
	Winapi::Windows::TRect __fastcall ListBoxBoundsRect();
	Winapi::Windows::TRect __fastcall ListBoxClientRect();
	void __fastcall ListBoxSetTimer(int ATimerCode);
	void __fastcall ListBoxStopTimer();
	Winapi::Windows::TRect __fastcall ListBoxVertScrollRect();
	Winapi::Windows::TRect __fastcall ListBoxVertDownButtonRect();
	Winapi::Windows::TRect __fastcall ListBoxVertUpButtonRect();
	Winapi::Windows::TRect __fastcall ListBoxVertScrollArea();
	Winapi::Windows::TRect __fastcall ListBoxVertSliderRect();
	Winapi::Windows::TRect __fastcall ListBoxVertTrackRect();
	Winapi::Windows::TRect __fastcall ListBoxVertTrackRectUp();
	Winapi::Windows::TRect __fastcall ListBoxVertTrackRectDown();
	void __fastcall PaintListBoxBorder(Vcl::Graphics::TCanvas* Canvas, const Winapi::Windows::TRect &R);
	void __fastcall UpdateColors();
...
protected:
	...
	virtual bool __fastcall AcceptMessage(Winapi::Messages::TMessage &Message);
	virtual void __fastcall DrawItem(Vcl::Graphics::TCanvas* Canvas, int Index, const Winapi::Windows::TRect &R, bool Selected);
...
protected:
	Winapi::Windows::TRect __fastcall GetBoxRect(Vcl::Graphics::TCanvas* Canvas);
	virtual Winapi::Windows::TRect __fastcall GetCaptionRect(Vcl::Graphics::TCanvas* Canvas);
	virtual void __fastcall Paint(Vcl::Graphics::TCanvas* Canvas);
	virtual void __fastcall PaintBackground(Vcl::Graphics::TCanvas* Canvas);
	virtual void __fastcall WndProc(Winapi::Messages::TMessage &Message);
	
public:
	__fastcall virtual TGroupBoxStyleHook(Vcl::Controls::TWinControl* AControl);
	virtual void __fastcall DrawControlText(Vcl::Graphics::TCanvas* Canvas, const Vcl::Themes::TThemedElementDetails &Details, const System::UnicodeString S, Winapi::Windows::TRect &R, unsigned Flags);
public:
...
//-- var, const, procedure ---------------------------------------------------
static _DELPHI_CONST System::Uitypes::TEditCharCase ecNormal = (System::Uitypes::TEditCharCase)(0);
static _DELPHI_CONST System::Uitypes::TEditCharCase ecUpperCase = (System::Uitypes::TEditCharCase)(1);
static _DELPHI_CONST System::Uitypes::TEditCharCase ecLowerCase = (System::Uitypes::TEditCharCase)(2);
static _DELPHI_CONST System::Uitypes::TScrollStyle ssNone = (System::Uitypes::TScrollStyle)(0);
static _DELPHI_CONST System::Uitypes::TScrollStyle ssHorizontal = (System::Uitypes::TScrollStyle)(1);
static _DELPHI_CONST System::Uitypes::TScrollStyle ssVertical = (System::Uitypes::TScrollStyle)(2);
static _DELPHI_CONST System::Uitypes::TScrollStyle ssBoth = (System::Uitypes::TScrollStyle)(3);
static _DELPHI_CONST System::Uitypes::TScrollCode scLineUp = (System::Uitypes::TScrollCode)(0);
static _DELPHI_CONST System::Uitypes::TScrollCode scLineDown = (System::Uitypes::TScrollCode)(1);
static _DELPHI_CONST System::Uitypes::TScrollCode scPageUp = (System::Uitypes::TScrollCode)(2);
static _DELPHI_CONST System::Uitypes::TScrollCode scPageDown = (System::Uitypes::TScrollCode)(3);
static _DELPHI_CONST System::Uitypes::TScrollCode scPosition = (System::Uitypes::TScrollCode)(4);
static _DELPHI_CONST System::Uitypes::TScrollCode scTrack = (System::Uitypes::TScrollCode)(5);
static _DELPHI_CONST System::Uitypes::TScrollCode scTop = (System::Uitypes::TScrollCode)(6);
static _DELPHI_CONST System::Uitypes::TScrollCode scBottom = (System::Uitypes::TScrollCode)(7);
static _DELPHI_CONST System::Uitypes::TScrollCode scEndScroll = (System::Uitypes::TScrollCode)(8);
}	/* namespace Stdctrls */
}	/* namespace Vcl */
