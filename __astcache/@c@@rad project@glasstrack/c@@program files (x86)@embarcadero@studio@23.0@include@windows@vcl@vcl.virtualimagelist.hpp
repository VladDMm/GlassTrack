...
// (DO NOT EDIT: machine generated header) 'Vcl.VirtualImageList.pas' rev: 36.00 (Windows)
...
private:
	...
	System::StaticArray<int, 15> FOverlays;
	...
	void __fastcall ResetOverlays();
	void __fastcall UpdateOverlays();
