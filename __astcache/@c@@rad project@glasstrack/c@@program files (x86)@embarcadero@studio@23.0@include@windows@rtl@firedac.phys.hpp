...
// (DO NOT EDIT: machine generated header) 'FireDAC.Phys.pas' rev: 36.00 (Windows)
...
typedef System::Set<TFDPhysRecoveryFlag, TFDPhysRecoveryFlag::rfInRecovery, TFDPhysRecoveryFlag::rfEmergencyClose> TFDPhysRecoveryFlags;
...
private:
	...
	Firedac::Stan::Intf::TFDClassList* FDriverClasses;
	Firedac::Stan::Intf::TFDPtrList* FDriverList;
	Firedac::Stan::Intf::TFDObjList* FDriverLinkList;
...
protected:
	...
	Firedac::Phys::Intf::_di_IFDPhysConnectionDefStat __fastcall GetConnectionDefStat(const Firedac::Stan::Intf::_di_IFDStanConnectionDef AConnectionDef);
...
private:
	...
	Firedac::Stan::Intf::TFDPtrList* FConnHostList;
	Firedac::Stan::Intf::TFDPtrList* FConnectionList;
...
private:
	...
	Firedac::Stan::Intf::TFDObjList* FServiceList;
...
private:
	...
	unsigned FCreatedConnections;
	unsigned FAliveConnections;
	Firedac::Stan::Intf::_di_IFDStanObjectFactory FPool;
	System::LongWord FPassCode;
...
protected:
	...
	unsigned __fastcall GetCreatedConnections();
	unsigned __fastcall GetAliveConnections();
	unsigned __fastcall GetBusyConnections();
...
private:
	void *__IFDPhysConnectionDefStat;	// Firedac::Phys::Intf::IFDPhysConnectionDefStat 
	void *__IFDStanObjectHost;	// Firedac::Stan::Intf::IFDStanObjectHost 
	
public:
	#if defined(MANAGED_INTERFACE_OPERATORS)
	// {3E9B315B-F456-4175-A864-B2573C4A2122}
	operator Firedac::Phys::Intf::_di_IFDPhysConnectionDefStat()
	{
		Firedac::Phys::Intf::_di_IFDPhysConnectionDefStat intf;
		this->GetInterface(intf);
		return intf;
	}
	#else
	operator Firedac::Phys::Intf::IFDPhysConnectionDefStat*(void) { return (Firedac::Phys::Intf::IFDPhysConnectionDefStat*)&__IFDPhysConnectionDefStat; }
	#endif
	#if defined(MANAGED_INTERFACE_OPERATORS)
	...
	#else
	operator System::IInterface*(void) { return (System::IInterface*)&__IFDPhysConnectionDefStat; }
	#endif
...
private:
	...
	PFDPhysCliHandles FSharedHandle;
	...
	unsigned __int64 FCommandsExecuted;
...
protected:
	...
	Firedac::Stan::Intf::_di_IFDMoniClient FMonitor;
	bool FTracing;
	System::LongWord __fastcall GetHandle();
	...
	Firedac::Stan::Intf::TFDPtrList* FCommandList;
	Firedac::Stan::Intf::TFDPtrList* FTransactionList;
	Firedac::Stan::Intf::TFDPtrList* FEventList;
	...
	void __fastcall Trace(Firedac::Stan::Intf::TFDMoniEventKind AKind, Firedac::Stan::Intf::TFDMoniEventStep AStep, const System::UnicodeString AMsg, const System::TVarRec *AArgs, const System::NativeInt AArgs_High);
...
protected:
	...
	System::LongWord __fastcall GetTopSerialID();
	System::LongWord __fastcall GetSerialID();
	System::LongWord __fastcall GetNestingLevel();
	...
	System::LongWord __fastcall StartTransaction();
	...
	System::LongWord FIDAutoCommit;
	virtual void __fastcall InternalStartTransaction(System::LongWord AID) = 0 ;
	virtual void __fastcall InternalCommit(System::LongWord AID) = 0 ;
	virtual void __fastcall InternalRollback(System::LongWord AID) = 0 ;
...
private:
	...
	void __fastcall UpdateMonitor();
	void __fastcall DumpParams(Firedac::Stan::Intf::TFDMoniEventKind AKind, Data::Db::TParamTypes ATypes);
...
protected:
	...
	void __fastcall CheckExact(bool AUseRecsMax, int ATimes, int AOffset, Firedac::Stan::Intf::TFDCounter AValue, bool AFetch);
	void __fastcall CheckArrayDMLWithIntStr(bool AHasIntStreams, int ATimes, int AOffset);
	void __fastcall InitRowsAffected();
	void __fastcall UpdateRowsAffected(Firedac::Stan::Intf::TFDCounter AValue);
	...
	virtual bool __fastcall InternalOpen(Firedac::Stan::Intf::TFDCounter &ACount) = 0 ;
	virtual bool __fastcall InternalNextRecordSet() = 0 ;
	virtual void __fastcall InternalClose() = 0 ;
	virtual void __fastcall InternalExecute(int ATimes, int AOffset, Firedac::Stan::Intf::TFDCounter &ACount) = 0 ;
	...
	virtual System::LongWord __fastcall InternalFetchRowSet(Firedac::Dats::TFDDatSTable* ATable, Firedac::Dats::TFDDatSRow* AParentRow, System::LongWord ARowsetSize) = 0 ;
