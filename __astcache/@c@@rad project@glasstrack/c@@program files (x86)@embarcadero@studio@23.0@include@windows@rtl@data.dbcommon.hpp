...
// (DO NOT EDIT: machine generated header) 'Data.DBCommon.pas' rev: 36.00 (Windows)
...
private:
	...
	void __fastcall SetNodeOp(int Node, int Index, System::NativeInt Data);
...
//-- var, const, procedure ---------------------------------------------------
static _DELPHI_CONST System::Int8 CANEXPRSIZE = System::Int8(0xa);
static _DELPHI_CONST System::Int8 CANHDRSIZE = System::Int8(0x8);
