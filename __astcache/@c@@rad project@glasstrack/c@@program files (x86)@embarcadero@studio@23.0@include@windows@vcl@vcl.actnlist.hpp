...
// (DO NOT EDIT: machine generated header) 'Vcl.ActnList.pas' rev: 36.00 (Windows)
...
public:
	...
	/* TStringList.Create */ inline __fastcall TShortCutList(System::Classes::TDuplicates Duplicates, bool Sorted, bool CaseSensitive)/* overload */ : System::Actions::TCustomShortCutList(Duplicates, Sorted, CaseSensitive) { }
