...
// (DO NOT EDIT: machine generated header) 'Vcl.Printers.pas' rev: 36.00 (Windows)
...
#pragma alias "@Vcl@Printers@TPrinter@GetPrinterA$qqrr20System@UnicodeStringt1t1rui"="@Vcl@Printers@TPrinter@GetPrinter$qqrr20System@UnicodeStringt1t1rui"
#pragma alias "@Vcl@Printers@TPrinter@SetPrinterA$qqr20System@UnicodeStringt1t1ui"="@Vcl@Printers@TPrinter@SetPrinter$qqr20System@UnicodeStringt1t1ui"
#else
...
#pragma alias "@Vcl@Printers@TPrinter@GetPrinterW$qqrr20System@UnicodeStringt1t1rui"="@Vcl@Printers@TPrinter@GetPrinter$qqrr20System@UnicodeStringt1t1rui"
#pragma alias "@Vcl@Printers@TPrinter@SetPrinterW$qqr20System@UnicodeStringt1t1ui"="@Vcl@Printers@TPrinter@SetPrinter$qqr20System@UnicodeStringt1t1ui"
#endif
#endif
namespace Vcl
{
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EPrinter(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : System::Sysutils::Exception(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EPrinter(System::NativeUInt Ident)/* overload */ : System::Sysutils::Exception(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EPrinter(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EPrinter(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EPrinter(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : System::Sysutils::Exception(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EPrinter(System::NativeUInt Ident, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EPrinter(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EPrinter(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High, AHelpContext) { }
...
//-- var, const, procedure ---------------------------------------------------
static _DELPHI_CONST System::Uitypes::TPrinterOrientation poPortrait = (System::Uitypes::TPrinterOrientation)(0);
static _DELPHI_CONST System::Uitypes::TPrinterOrientation poLandscape = (System::Uitypes::TPrinterOrientation)(1);
static _DELPHI_CONST System::Uitypes::TPrinterCapability pcCopies = (System::Uitypes::TPrinterCapability)(0);
static _DELPHI_CONST System::Uitypes::TPrinterCapability pcOrientation = (System::Uitypes::TPrinterCapability)(1);
static _DELPHI_CONST System::Uitypes::TPrinterCapability pcCollation = (System::Uitypes::TPrinterCapability)(2);
