...
// (DO NOT EDIT: machine generated header) 'Winapi.Windows.pas' rev: 36.00 (Windows)
...
typedef System::NativeUInt THandle;

#ifndef _WIN64
typedef unsigned *PHandle;
#else /* _WIN64 */
typedef unsigned __int64 *PHandle;
#endif /* _WIN64 */
...
public:
	...
	TImageOptionalHeader32 OptionalHeader;
};
#pragma pack(pop)
...
typedef System::NativeUInt HINST;

#ifndef _WIN64
typedef unsigned *PHMODULE;
#else /* _WIN64 */
typedef unsigned __int64 *PHMODULE;
#endif /* _WIN64 */

using System::Uitypes::TColorRef;

using System::Types::PPoint;

using System::Types::TPoint;

typedef System::Types::TPoint tagPoint;
...
#ifndef _WIN64
typedef unsigned TKAffinity;
#else /* _WIN64 */
typedef unsigned __int64 TKAffinity;
#endif /* _WIN64 */
...
typedef TFarProc TFNThreadStartRoutine;

typedef TFarProc TFNFiberStartRoutine;

typedef TFarProc TFNFLSCallBackFunction;

typedef TFarProc TFNLPOverlappedCompletionRoutine;
...
typedef MakeIntAtomW MakeIntAtom;
...
typedef TFarProc TFNTopLevelExceptionFilter;
...
typedef TFarProc TFNRTLUMSSchedulerEntryPoint;
...
#ifndef _WIN64
typedef System::StaticArray<unsigned, 64> TWOHandleArray;
#else /* _WIN64 */
typedef System::StaticArray<unsigned __int64, 64> TWOHandleArray;
#endif /* _WIN64 */
...
typedef TFarProc TPROverlappedCompletionRoutine;
...
typedef TFarProc TFNProgressRoutine;
...
typedef PWINTRUST_FILE_INFO PWinTrustFileInfo;
...
typedef TFarProc TFNOldFontEnumProcA;

typedef TFarProc TFNOldFontEnumProcW;

typedef TFNOldFontEnumProcW TFNOldFontEnumProc;

typedef TFarProc TFNGObjEnumProc;

typedef TFarProc TFNLineDDAProc;

typedef TFarProc TFNFontEnumProcA;

typedef TFarProc TFNFontEnumProcW;

typedef TFNFontEnumProcW TFNFontEnumProc;

typedef TFarProc TFNDevMode;

typedef TFarProc TFNDevCaps;
...
typedef TFarProc TFNMFEnumProc;

typedef TFarProc TFNEnhMFEnumProc;
...
typedef TFarProc TFNICMEnumProc;
...
typedef TFarProc TFNWndProc;

typedef TFarProc TFNDlgProc;

typedef TFarProc TFNTimerProc;

typedef TFarProc TFNGrayStringProc;

typedef TFarProc TFNWndEnumProc;

typedef TFarProc TFNSendAsyncProc;

typedef TFarProc TFNDrawStateProc;

#ifndef _WIN64
typedef int __stdcall (*TFNHookProc)(int code, unsigned wparam, int lparam);
#else /* _WIN64 */
typedef __int64 __stdcall (*TFNHookProc)(int code, unsigned __int64 wparam, __int64 lparam);
#endif /* _WIN64 */

typedef TFarProc TFNPropEnumProc;

typedef TFarProc TFNPropEnumProcEx;

typedef TFarProc TFNEditWordBreakProc;

typedef TFarProc TFNNameEnumProc;

typedef TFNNameEnumProc TFNWinStaEnumProc;

typedef TFNNameEnumProc TFNDeskTopEnumProc;

typedef char * MakeIntResourceA;

typedef System::WideChar * MakeIntResourceW;

typedef MakeIntResourceW MakeIntResource;
...
enum DECLSPEC_DENUM TOwnerDrawStateItem : unsigned int { odSelected, odGrayed, odDisabled, odChecked, odFocused, odDefault, odHotLight, odInactive, odNoAccel, odNoFocusRect, odReserved1, odReserved2, odComboBoxEdit };

typedef System::Set<TOwnerDrawStateItem, TOwnerDrawStateItem::odSelected, TOwnerDrawStateItem::odComboBoxEdit> TOwnerDrawState;
...
typedef void __fastcall (*TPRMsgBoxCallback)(THelpInfo &lpHelpInfo);
...
public:
	...
	TPoint pt;
	TColorRef clrForeground;
	TColorRef clrBackground;
	TRect rcMargins;
...
#ifndef _WIN64
typedef System::LongBool __stdcall (*TFNLanguageGroupEnumProcA)(unsigned dw1, char * p1, char * p2, unsigned dw2, int p3);
#else /* _WIN64 */
typedef System::LongBool __stdcall (*TFNLanguageGroupEnumProcA)(unsigned dw1, char * p1, char * p2, unsigned dw2, __int64 p3);
#endif /* _WIN64 */

#ifndef _WIN64
typedef System::LongBool __stdcall (*TFNLanguageGroupEnumProcW)(unsigned dw1, System::WideChar * p1, System::WideChar * p2, unsigned dw2, int p3);
#else /* _WIN64 */
typedef System::LongBool __stdcall (*TFNLanguageGroupEnumProcW)(unsigned dw1, System::WideChar * p1, System::WideChar * p2, unsigned dw2, __int64 p3);
#endif /* _WIN64 */

typedef TFNLanguageGroupEnumProcW TFNLanguageGroupEnumProc;

#ifndef _WIN64
typedef System::LongBool __stdcall (*TFNLangGroupLocaleEnumProcA)(unsigned dw1, unsigned dw2, char * p1, int p2);
#else /* _WIN64 */
typedef System::LongBool __stdcall (*TFNLangGroupLocaleEnumProcA)(unsigned dw1, unsigned dw2, char * p1, __int64 p2);
#endif /* _WIN64 */

#ifndef _WIN64
typedef System::LongBool __stdcall (*TFNLangGroupLocaleEnumProcW)(unsigned dw1, unsigned dw2, System::WideChar * p1, int p2);
#else /* _WIN64 */
typedef System::LongBool __stdcall (*TFNLangGroupLocaleEnumProcW)(unsigned dw1, unsigned dw2, System::WideChar * p1, __int64 p2);
#endif /* _WIN64 */

typedef TFNLangGroupLocaleEnumProcW TFNLangGroupLocaleEnumProc;

#ifndef _WIN64
typedef System::LongBool __stdcall (*TFNUILanguageEnumProcA)(char * p1, int p2);
#else /* _WIN64 */
typedef System::LongBool __stdcall (*TFNUILanguageEnumProcA)(char * p1, __int64 p2);
#endif /* _WIN64 */

#ifndef _WIN64
typedef System::LongBool __stdcall (*TFNUILanguageEnumProcW)(System::WideChar * p1, int p2);
#else /* _WIN64 */
typedef System::LongBool __stdcall (*TFNUILanguageEnumProcW)(System::WideChar * p1, __int64 p2);
#endif /* _WIN64 */

typedef TFNUILanguageEnumProcW TFNUILanguageEnumProc;

typedef TFarProc TFNLocaleEnumProcA;

typedef TFarProc TFNLocaleEnumProcW;

typedef TFNLocaleEnumProcW TFNLocaleEnumProc;

typedef TFarProc TFNCodepageEnumProcA;

typedef TFarProc TFNCodepageEnumProcW;

typedef TFNCodepageEnumProcW TFNCodepageEnumProc;

typedef TFarProc TFNDateFmtEnumProcA;

typedef TFarProc TFNDateFmtEnumProcW;

typedef TFNDateFmtEnumProcW TFNDateFmtEnumProc;
...
typedef TFarProc TFNTimeFmtEnumProcA;

typedef TFarProc TFNTimeFmtEnumProcW;

typedef TFNTimeFmtEnumProcW TFNTimeFmtEnumProc;

typedef TFarProc TFNCalInfoEnumProcA;

typedef TFarProc TFNCalInfoEnumProcW;

typedef TFNCalInfoEnumProcW TFNCalInfoEnumProc;
...
#ifndef _WIN64
typedef System::LongBool __stdcall (*TFNCalInfoEnumProcExEx)(System::WideChar * p1, unsigned dw1, System::WideChar * p2, int p3);
#else /* _WIN64 */
typedef System::LongBool __stdcall (*TFNCalInfoEnumProcExEx)(System::WideChar * p1, unsigned dw1, System::WideChar * p2, __int64 p3);
#endif /* _WIN64 */

#ifndef _WIN64
typedef System::LongBool __stdcall (*TFNDateFmtEnumProcExEx)(System::WideChar * p1, unsigned dw1, int p2);
#else /* _WIN64 */
typedef System::LongBool __stdcall (*TFNDateFmtEnumProcExEx)(System::WideChar * p1, unsigned dw1, __int64 p2);
#endif /* _WIN64 */

#ifndef _WIN64
typedef System::LongBool __stdcall (*TFNTimeFmtEnumProcEx)(System::WideChar * p1, int p2);
#else /* _WIN64 */
typedef System::LongBool __stdcall (*TFNTimeFmtEnumProcEx)(System::WideChar * p1, __int64 p2);
#endif /* _WIN64 */

#ifndef _WIN64
typedef unsigned __stdcall (*TFNLocaleEnumProcEx)(System::WideChar * p1, unsigned dw1, int p2);
#else /* _WIN64 */
typedef unsigned __stdcall (*TFNLocaleEnumProcEx)(System::WideChar * p1, unsigned dw1, __int64 p2);
#endif /* _WIN64 */
...
typedef TFarProc TFNHandlerRoutine;
...
typedef TFarProc TFNQueryHandler;
...
typedef TFarProc TFNGetProfilePath;

typedef TFarProc TFNReconcileProfile;

typedef TFarProc TFNProcessPolicies;
...
#ifndef _WIN64
typedef unsigned HGESTUREINFO;
#else /* _WIN64 */
typedef unsigned __int64 HGESTUREINFO;
#endif /* _WIN64 */
...
//-- var, const, procedure ---------------------------------------------------
static _DELPHI_CONST unsigned LDTF_BASEMID = unsigned(0xff000000);
static _DELPHI_CONST int LDTF_TYPE_8 = int(0xf80000);
static _DELPHI_CONST int LDTF_DPL = int(0x60000);
static _DELPHI_CONST int LDTF_PRES = int(0x10000);
static _DELPHI_CONST System::Word LDTF_LIMITHI = System::Word(0xf000);
static _DELPHI_CONST System::Word LDTF_SYS = System::Word(0x800);
static _DELPHI_CONST System::Word LDTF_RESERVED_0 = System::Word(0x400);
static _DELPHI_CONST System::Word LDTF_DEFAULT_BIG = System::Word(0x200);
static _DELPHI_CONST System::Word LDTF_GRANULARITY = System::Word(0x100);
static _DELPHI_CONST System::Byte LDTF_BASEHI = System::Byte(0xff);
static _DELPHI_CONST int _DELETE = int(0x10000);
static _DELPHI_CONST System::Int8 THREAD_CREATE_RUN_IMMEDIATELY = System::Int8(0x0);
static _DELPHI_CONST System::Int8 THREAD_CREATE_SUSPENDED = System::Int8(0x4);
static _DELPHI_CONST System::Int8 _ABORTDOC = System::Int8(0x2);
static _DELPHI_CONST System::Int8 _SETABORTPROC = System::Int8(0x9);
static _DELPHI_CONST System::Int8 _STARTDOC = System::Int8(0xa);
static _DELPHI_CONST System::Int8 _ENDDOC = System::Int8(0xb);
static _DELPHI_CONST System::Int8 _SETMITERLIMIT = System::Int8(0x17);
static _DELPHI_CONST System::Word _EXTTEXTOUT = System::Word(0x200);
static _DELPHI_CONST System::Word _STRETCHBLT = System::Word(0x800);
static _DELPHI_CONST System::Byte GCP_GLYPHINDEXING = System::Byte(0x80);
static _DELPHI_CONST int GCP_NODIACRITICS = int(0x20000);
static _DELPHI_CONST System::Int8 COLOR_ENDCOLORS = System::Int8(0x1e);
static _DELPHI_CONST System::Int8 ID_OK = System::Int8(0x1);
static _DELPHI_CONST System::Int8 ID_CANCEL = System::Int8(0x2);
static _DELPHI_CONST System::Int8 ID_ABORT = System::Int8(0x3);
static _DELPHI_CONST System::Int8 ID_RETRY = System::Int8(0x4);
static _DELPHI_CONST System::Int8 ID_IGNORE = System::Int8(0x5);
static _DELPHI_CONST System::Int8 ID_YES = System::Int8(0x6);
static _DELPHI_CONST System::Int8 ID_NO = System::Int8(0x7);
static _DELPHI_CONST System::Int8 ID_CLOSE = System::Int8(0x8);
static _DELPHI_CONST System::Int8 ID_HELP = System::Int8(0x9);
static _DELPHI_CONST System::Int8 _MOUSE_EVENT = System::Int8(0x2);
static _DELPHI_CONST System::Byte dde_AppReturnCode = System::Byte(0xff);
static _DELPHI_CONST System::Word dde_Busy = System::Word(0x4000);
static _DELPHI_CONST System::Word dde_Ack = System::Word(0x8000);
static _DELPHI_CONST System::Word dde_DeferUpd = System::Word(0x4000);
static _DELPHI_CONST System::Word dde_AckReq = System::Word(0x8000);
static _DELPHI_CONST System::Word dde_Response = System::Word(0x1000);
static _DELPHI_CONST System::Word dde_Release = System::Word(0x2000);
...
extern DELPHI_PACKAGE System::LongWord __fastcall MakeULong(System::Word A, System::Word B);
...
#ifndef _WIN64
extern DELPHI_PACKAGE int __fastcall PointToLParam(const TPoint &P);
#else /* _WIN64 */
extern DELPHI_PACKAGE __int64 __fastcall PointToLParam(const TPoint &P);
#endif /* _WIN64 */
