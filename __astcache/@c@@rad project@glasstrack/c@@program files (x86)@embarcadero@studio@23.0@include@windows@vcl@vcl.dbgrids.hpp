...
// (DO NOT EDIT: machine generated header) 'Vcl.DBGrids.pas' rev: 36.00 (Windows)
...
//-- type declarations -------------------------------------------------------
enum DECLSPEC_DENUM TColumnValue : unsigned char { cvColor, cvWidth, cvFont, cvAlignment, cvReadOnly, cvTitleColor, cvTitleCaption, cvTitleAlignment, cvTitleFont, cvImeMode, cvImeName, cvBiDiMode };

typedef System::Set<TColumnValue, TColumnValue::cvColor, TColumnValue::cvBiDiMode> TColumnValues;
...
public:
	...
	virtual void __fastcall Assign(System::Classes::TPersistent* Source);
	System::Classes::TAlignment __fastcall DefaultAlignment();
	System::Classes::TBiDiMode __fastcall DefaultBiDiMode();
	System::Uitypes::TColor __fastcall DefaultColor();
	Vcl::Graphics::TFont* __fastcall DefaultFont();
...
__published:
	__property System::Classes::TAlignment Alignment = {read=GetAlignment, write=SetAlignment, stored=IsAlignmentStored, nodefault};
	__property System::Classes::TBiDiMode BiDiMode = {read=GetBiDiMode, write=SetBiDiMode, stored=IsBiDiModeStored, nodefault};
...
public:
	Data::Db::TBookmark operator[](int Index) { return this->Items[Index]; }
	
private:
	_TBookmarkList__1 FList;
	TCustomDBGrid* FGrid;
	Data::Db::TBookmark FCache;
	int FCacheIndex;
	bool FCacheFind;
	bool FLinkActive;
	int __fastcall GetCount();
	bool __fastcall GetCurrentRowSelected();
	Data::Db::TBookmark __fastcall GetItem(int Index);
	void __fastcall InsertItem(int Index, Data::Db::TBookmark Item);
...
protected:
	Data::Db::TBookmark __fastcall CurrentRow();
	int __fastcall Compare(const Data::Db::TBookmark Item1, const Data::Db::TBookmark Item2);
...
public:
	...
	bool __fastcall Find(const Data::Db::TBookmark Item, int &Index);
	int __fastcall IndexOf(const Data::Db::TBookmark Item);
	...
	__property Data::Db::TBookmark Items[int Index] = {read=GetItem/*, default*/};
};
...
private:
	...
	Data::Db::TBookmark FSelectionAnchor;
	...
	static void __fastcall InitImageCollection();
...
protected:
	...
	Winapi::Windows::TRect __fastcall CalcTitleRect(TColumn* Col, int ARow, TColumn* &MasterCol);
	...
	virtual void __fastcall DrawCellBackground(const Winapi::Windows::TRect &ARect, System::Uitypes::TColor AColor, Vcl::Grids::TGridDrawState AState, int ACol, int ARow);
	virtual void __fastcall DrawCellHighlight(const Winapi::Windows::TRect &ARect, Vcl::Grids::TGridDrawState AState, int ACol, int ARow);
	DYNAMIC void __fastcall DrawDataCell(const Winapi::Windows::TRect &Rect, Data::Db::TField* Field, Vcl::Grids::TGridDrawState State);
	DYNAMIC void __fastcall DrawColumnCell(const Winapi::Windows::TRect &Rect, int DataCol, TColumn* Column, Vcl::Grids::TGridDrawState State);
	...
	DYNAMIC bool __fastcall BeginColumnDrag(int &Origin, int &Destination, const Winapi::Windows::TPoint &MousePt);
	DYNAMIC bool __fastcall CheckColumnDrag(int &Origin, int &Destination, const Winapi::Windows::TPoint &MousePt);
	DYNAMIC bool __fastcall EndColumnDrag(int &Origin, int &Destination, const Winapi::Windows::TPoint &MousePt);
...
public:
	...
	void __fastcall DefaultDrawDataCell(const Winapi::Windows::TRect &Rect, Data::Db::TField* Field, Vcl::Grids::TGridDrawState State);
...
private:
	Vcl::Dbctrls::TDBLookupListBox* FDataList;
	bool FUseDataList;
...
public:
	...
	__property Vcl::Dbctrls::TDBLookupListBox* DataList = {read=FDataList};
public:
	...
	/* TWinControl.Destroy */ inline __fastcall virtual ~TDBGridInplaceEdit() { }
	
};


//-- var, const, procedure ---------------------------------------------------
#define ColumnTitleValues (System::Set<TColumnValue, TColumnValue::cvColor, TColumnValue::cvBiDiMode>() << TColumnValue::cvTitleColor << TColumnValue::cvTitleCaption << TColumnValue::cvTitleAlignment << TColumnValue::cvTitleFont )
static _DELPHI_CONST System::Word cm_DeferLayout = System::Word(0x464);
static _DELPHI_CONST System::Int8 IndicatorWidth = System::Int8(0xb);
}	/* namespace Dbgrids */
}	/* namespace Vcl */
