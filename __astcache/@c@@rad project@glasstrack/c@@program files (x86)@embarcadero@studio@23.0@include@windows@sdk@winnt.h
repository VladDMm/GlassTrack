...
#if defined(__CODEGEARC__) && defined(__clang__) && (__clang_major__ >= 15)
...
// begin_ntoshvp
#ifndef FORCEINLINE
#if (_MSC_VER >= 1200) || (defined(__CODEGEARC__) && defined(__clang__))
...
#if defined(_M_AMD64) && !defined(_M_ARM64EC) && !defined(__CODEGEARC__)
