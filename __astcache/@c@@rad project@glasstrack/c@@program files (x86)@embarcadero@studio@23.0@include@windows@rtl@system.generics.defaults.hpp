...
// (DO NOT EDIT: machine generated header) 'System.Generics.Defaults.pas' rev: 36.00 (Windows)
...
class DELPHICLASS TPointerComparer;
//-- type declarations -------------------------------------------------------
...
private:
	static int __fastcall EQOperCompare(void * Self, const T Left, const T Right);
	static void * __fastcall TryUseRecEqualityOperator();
...
private:
	static bool __fastcall EQOperEquals(void * Self, const T Left, const T Right);
	static int __fastcall EQOperGetHashCode(void * Self, const T Value);
	static void * __fastcall TryUseRecEqualityOperator();
...
protected:
	...
	HIDESBASE virtual int __fastcall GetHashCode(const T Value) = 0 /* overload */;
public:
	/* TObject.Create */ inline __fastcall TCustomComparer__1() : System::TNoRefCountObject() { }
...
#pragma pack(push,4)
#endif /* not _WIN64 */
class PASCALIMPLEMENTATION TPointerComparer : public TCustomComparer__1<void *>
{
	typedef TCustomComparer__1<void *> inherited;
	
private:
	static TCustomComparer__1<void *>* FNoAlign;
	static TCustomComparer__1<void *>* FAlign2;
	static TCustomComparer__1<void *>* FAlign4;
	static TCustomComparer__1<void *>* FAlign8;
	static TCustomComparer__1<void *>* FAlign16;
	static TCustomComparer__1<void *>* FAlign32;
	static TCustomComparer__1<void *>* FAlign64;
	
private:
	// __classmethod void __fastcall Destroy@();
	
public:
	__classmethod TPointerComparer* __fastcall NoAlign();
	__classmethod TPointerComparer* __fastcall Align2();
	__classmethod TPointerComparer* __fastcall Align4();
	__classmethod TPointerComparer* __fastcall Align8();
	__classmethod TPointerComparer* __fastcall Align16();
	__classmethod TPointerComparer* __fastcall Align32();
	__classmethod TPointerComparer* __fastcall Align64();
	__classmethod TPointerComparer* __fastcall Ordinal();
	
private:
	// __classmethod void __fastcall Create@();
public:
	/* TObject.Create */ inline __fastcall TPointerComparer() : TCustomComparer__1<void *>() { }
	/* TObject.Destroy */ inline __fastcall virtual ~TPointerComparer() { }
...
template<typename T> using TRecEqualityOperator__1 = bool __fastcall (*)(const T Left, const T Right);
#endif
...
extern DELPHI_PACKAGE bool __fastcall _AreAnonMethodsCapturing(const System::TVarRec *AnonMethodPtrs, const System::NativeInt AnonMethodPtrs_High);
