...
// (DO NOT EDIT: machine generated header) 'System.SyncObjs.pas' rev: 36.00 (Windows)
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall ESyncObjectException(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : System::Sysutils::Exception(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall ESyncObjectException(System::NativeUInt Ident)/* overload */ : System::Sysutils::Exception(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall ESyncObjectException(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall ESyncObjectException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall ESyncObjectException(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : System::Sysutils::Exception(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall ESyncObjectException(System::NativeUInt Ident, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall ESyncObjectException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall ESyncObjectException(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High, AHelpContext) { }
...
public:
	...
	TWaitResult __fastcall WaitFor(const System::Timespan::TTimeSpan &Timeout)/* overload */;
public:
...
public:
	...
	__classmethod TWaitResult __fastcall WaitForMultiple(const THandleObjectArray HandleObjs, unsigned Timeout, bool AAll, /* out */ THandleObject* &SignaledObj, bool UseCOMWait = false, int Len = 0x0);
...
public:
	...
	HIDESBASE TWaitResult __fastcall WaitFor(TMutex* AExternalMutex, unsigned TimeOut = (unsigned)(0xffffffff));
};
...
protected:
	Winapi::Windows::TRTLConditionVariable FConditionVariable;
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall ELockRecursionException(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : ESyncObjectException(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall ELockRecursionException(System::NativeUInt Ident)/* overload */ : ESyncObjectException(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall ELockRecursionException(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : ESyncObjectException(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall ELockRecursionException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : ESyncObjectException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall ELockRecursionException(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : ESyncObjectException(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall ELockRecursionException(System::NativeUInt Ident, int AHelpContext)/* overload */ : ESyncObjectException(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall ELockRecursionException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : ESyncObjectException(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall ELockRecursionException(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : ESyncObjectException(Ident, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall ELockException(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : ESyncObjectException(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall ELockException(System::NativeUInt Ident)/* overload */ : ESyncObjectException(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall ELockException(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : ESyncObjectException(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall ELockException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : ESyncObjectException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall ELockException(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : ESyncObjectException(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall ELockException(System::NativeUInt Ident, int AHelpContext)/* overload */ : ESyncObjectException(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall ELockException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : ESyncObjectException(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall ELockException(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : ESyncObjectException(Ident, Args, Args_High, AHelpContext) { }
...
private:
	static _DELPHI_CONST System::Int8 DefaultSpinMulticore = System::Int8(0xa);
	
	static _DELPHI_CONST System::Int8 DefaultSpinSinglecore = System::Int8(0x1);
	
	static _DELPHI_CONST System::Word SpinMask = System::Word(0xfff);
	
	static _DELPHI_CONST System::Word MaxSpin = System::Word(0xfff);
	
	static _DELPHI_CONST int EventSignaled = int(-2147483648);
	
	static _DELPHI_CONST System::Int8 EventUnsignaled = System::Int8(0x0);
	
	static _DELPHI_CONST int SignalMask = int(-2147483648);
...
typedef System::Int8 TBitOffset64;
...
public:
	...
	static __int64 __fastcall Read(__int64 &Target)/* overload */;
	static unsigned __int64 __fastcall Read(unsigned __int64 &Target)/* overload */;
public:
