...
// (DO NOT EDIT: machine generated header) 'System.TypInfo.pas' rev: 36.00 (Windows)
...
public:
	...
	/* TCustomVariantType.Create */ inline __fastcall TPublishableVariantType(System::TVarType RequestedVarType)/* overload */ : System::Variants::TInvokeableVariantType(RequestedVarType) { }
...
typedef System::Set<TMemberVisibility, TMemberVisibility::mvPrivate, TMemberVisibility::mvPublished> TMemberVisibilities;
...
public:
	...
	System::Sysutils::TBytes __fastcall ToByteArray();
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EPropertyError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : System::Sysutils::Exception(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EPropertyError(System::NativeUInt Ident)/* overload */ : System::Sysutils::Exception(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EPropertyError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EPropertyError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EPropertyError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : System::Sysutils::Exception(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EPropertyError(System::NativeUInt Ident, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EPropertyError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EPropertyError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EPropertyConvertError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : System::Sysutils::Exception(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EPropertyConvertError(System::NativeUInt Ident)/* overload */ : System::Sysutils::Exception(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EPropertyConvertError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EPropertyConvertError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EPropertyConvertError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : System::Sysutils::Exception(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EPropertyConvertError(System::NativeUInt Ident, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EPropertyConvertError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EPropertyConvertError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High, AHelpContext) { }
...
#ifndef _WIN64
static _DELPHI_CONST unsigned PROPSLOT_MASK = unsigned(0xff000000);
static _DELPHI_CONST unsigned PROPSLOT_FIELD = unsigned(0xff000000);
static _DELPHI_CONST unsigned PROPSLOT_VIRTUAL = unsigned(0xfe000000);
#else /* _WIN64 */
static _DELPHI_CONST unsigned __int64 PROPSLOT_MASK = 0xff00000000000000ULL;
static _DELPHI_CONST unsigned __int64 PROPSLOT_FIELD = 0xff00000000000000ULL;
static _DELPHI_CONST unsigned __int64 PROPSLOT_VIRTUAL = 0xfe00000000000000ULL;
#endif /* _WIN64 */
...
extern DELPHI_PACKAGE void __fastcall (*GetRecCompareAddrs)(PTypeInfo Info, /* out */ void * &PEQOper, /* out */ void * &PGetHashCode);
...
extern DELPHI_PACKAGE bool __fastcall PropIsType(System::TClass AClass, const System::UnicodeString PropName, TTypeKind TypeKind)/* overload */;
...
extern DELPHI_PACKAGE System::NativeInt __fastcall GetOrdProp(System::TObject* Instance, const System::UnicodeString PropName)/* overload */;
extern DELPHI_PACKAGE void __fastcall SetOrdProp(System::TObject* Instance, const System::UnicodeString PropName, System::NativeInt Value)/* overload */;
...
extern DELPHI_PACKAGE void __fastcall AddEnumElementAliases(PTypeInfo TypeInfo, const System::UnicodeString *Names, const System::NativeInt Names_High, int StartValue = 0x0);
...
#ifndef _WIN64
extern DELPHI_PACKAGE int __fastcall GetOrdProp(System::TObject* Instance, PPropInfo PropInfo)/* overload */;
#else /* _WIN64 */
extern DELPHI_PACKAGE __int64 __fastcall GetOrdProp(System::TObject* Instance, PPropInfo PropInfo)/* overload */;
#endif /* _WIN64 */
extern DELPHI_PACKAGE void __fastcall SetOrdProp(System::TObject* Instance, PPropInfo PropInfo, System::NativeInt Value)/* overload */;
...
extern DELPHI_PACKAGE void __fastcall GetRecordCompareAddrs(PTypeInfo Info, /* out */ void * &PEQOper, /* out */ void * &PGetHashCode);
}	/* namespace Typinfo */
}	/* namespace System */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_SYSTEM_TYPINFO)
