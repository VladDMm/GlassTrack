...
// (DO NOT EDIT: machine generated header) 'FireDAC.Stan.Intf.pas' rev: 36.00 (Windows)
...
__interface DELPHIINTERFACE TFDStanExpressionFieldToSQL;
typedef System::DelphiInterface<TFDStanExpressionFieldToSQL> _di_TFDStanExpressionFieldToSQL;
...
public:
	static _DELPHI_CONST System::Int8 Unknown = System::Int8(0x0);
	
	static _DELPHI_CONST System::Int8 Oracle = System::Int8(0x1);
	
	static _DELPHI_CONST System::Int8 MSSQL = System::Int8(0x2);
	
	static _DELPHI_CONST System::Int8 MSAccess = System::Int8(0x3);
	
	static _DELPHI_CONST System::Int8 MySQL = System::Int8(0x4);
	
	static _DELPHI_CONST System::Int8 DB2 = System::Int8(0x5);
	
	static _DELPHI_CONST System::Int8 SQLAnywhere = System::Int8(0x6);
	
	static _DELPHI_CONST System::Int8 Advantage = System::Int8(0x7);
	
	static _DELPHI_CONST System::Int8 Interbase = System::Int8(0x8);
	
	static _DELPHI_CONST System::Int8 Firebird = System::Int8(0x9);
	
	static _DELPHI_CONST System::Int8 SQLite = System::Int8(0xa);
	
	static _DELPHI_CONST System::Int8 PostgreSQL = System::Int8(0xb);
	
	static _DELPHI_CONST System::Int8 NexusDB = System::Int8(0xc);
	
	static _DELPHI_CONST System::Int8 DataSnap = System::Int8(0xd);
	
	static _DELPHI_CONST System::Int8 Informix = System::Int8(0xe);
	
	static _DELPHI_CONST System::Int8 Teradata = System::Int8(0xf);
	
	static _DELPHI_CONST System::Int8 MongoDB = System::Int8(0x10);
	
	static _DELPHI_CONST System::Int8 Other = System::Int8(0x11);
...
enum DECLSPEC_DENUM TFDCommandKind : unsigned int { skUnknown, skSelect, skSelectForLock, skSelectForUnLock, skDelete, skInsert, skMerge, skUpdate, skCreate, skAlter, skDrop, skStoredProc, skStoredProcWithCrs, skStoredProcNoCrs, skExecute, skStartTransaction, skCommit, skRollback, skSet, skSetSchema, skOther, skNotResolved };

typedef System::Set<TFDCommandKind, TFDCommandKind::skUnknown, TFDCommandKind::skNotResolved> TFDCommandKinds;

enum DECLSPEC_DENUM TFDDataType : unsigned int { dtUnknown, dtBoolean, dtSByte, dtInt16, dtInt32, dtInt64, dtByte, dtUInt16, dtUInt32, dtUInt64, dtSingle, dtDouble, dtExtended, dtCurrency, dtBCD, dtFmtBCD, dtDateTime, dtTime, dtDate, dtDateTimeStamp, dtTimeIntervalFull, dtTimeIntervalYM, dtTimeIntervalDS, dtAnsiString, dtWideString, dtByteString, dtBlob, dtMemo, dtWideMemo, dtXML, dtHBlob, dtHMemo, dtWideHMemo, dtHBFile, dtRowSetRef, dtCursorRef, dtRowRef, dtArrayRef, dtParentRowRef, dtGUID, dtObject, dtDateTimeStampOff };

typedef System::Set<TFDDataType, TFDDataType::dtUnknown, TFDDataType::dtDateTimeStampOff> TFDDataTypes;
...
enum DECLSPEC_DENUM TFDMergeOption : unsigned int { moPreserveState };
...
typedef System::NativeUInt TFDsize_t;

typedef System::NativeInt TFDssize_t;
...
#ifndef _WIN64
typedef unsigned *PFDsize_t;
#else /* _WIN64 */
typedef unsigned __int64 *PFDsize_t;
#endif /* _WIN64 */
...
typedef System::LongWord TFDLocalID;
...
private:
	...
	System::LongWord __fastcall GetInts(int AIndex);
	void __fastcall SetInts(int AIndex, const System::LongWord AValue);
	
public:
	void __fastcall AddPtr(const System::UnicodeString AStr, void * APtr);
	void __fastcall AddInt(const System::UnicodeString AStr, System::LongWord AInt);
	__property void * Ptrs[int AIndex] = {read=GetPtrs, write=SetPtrs};
	__property System::LongWord Ints[int AIndex] = {read=GetInts, write=SetInts};
public:
	...
	/* TStringList.Create */ inline __fastcall TFDStringList(System::Classes::TDuplicates Duplicates, bool Sorted, bool CaseSensitive)/* overload */ : System::Classes::TStringList(Duplicates, Sorted, CaseSensitive) { }
...
{
	virtual unsigned __fastcall GetBusyObjects() = 0 ;
	...
	__property unsigned BusyObjects = {read=GetBusyObjects};
};
...
__interface  INTERFACE_UUID("{3E9B315B-F456-4175-A864-B2573C4A2013}") IFDStanDefinition  : public System::IInterface 
{
	...
	virtual System::LongInt __fastcall GetAsInteger(const System::UnicodeString AName) = 0 ;
	...
	virtual void __fastcall SetAsInteger(const System::UnicodeString AName, const System::LongInt AValue) = 0 ;
	...
	virtual void __fastcall ToggleUpdates(System::LongWord APassCode, bool ADisableDelete, bool ADisableModify) = 0 ;
	...
	__property System::LongInt AsInteger[const System::UnicodeString AName] = {read=GetAsInteger, write=SetAsInteger};
...
__interface  INTERFACE_UUID("{3E9B315B-F456-4175-A864-B2573C4A2015}") IFDStanConnectionDef  : public IFDStanDefinition 
{
	...
	virtual void __fastcall WriteOptions(System::TObject* AFormatOptions, System::TObject* AUpdateOptions, System::TObject* AFetchOptions, System::TObject* AResourceOptions, System::TObject* ASecurityOptions) = 0 ;
	virtual void __fastcall ReadOptions(System::TObject* AFormatOptions, System::TObject* AUpdateOptions, System::TObject* AFetchOptions, System::TObject* AResourceOptions, System::TObject* ASecurityOptions) = 0 ;
...
__interface TFDStanExpressionFieldToSQL  : public System::IInterface 
{
	virtual System::UnicodeString __fastcall Invoke(const System::UnicodeString AFieldName) = 0 ;
};
...
__interface  INTERFACE_UUID("{3E9B315B-F456-4175-A864-B2573C4A2010}") IFDStanExpressionEvaluator  : public System::IInterface 
{
	...
	virtual bool __fastcall HandleNotification(System::Word AKind, System::Word AReason, System::NativeInt AParam1, System::NativeInt AParam2) = 0 ;
...
enum DECLSPEC_DENUM TFDStoreItem : unsigned int { siMeta, siData, siDelta, siVisible, siCurrent };

typedef System::Set<TFDStoreItem, TFDStoreItem::siMeta, TFDStoreItem::siCurrent> TFDStoreItems;
...
__interface  INTERFACE_UUID("{3E9B315B-F456-4175-A864-B2573C4A2031}") IFDStanStorage  : public System::IInterface 
{
	...
	virtual TFDAnsiString __fastcall ReadAnsiString(const System::UnicodeString APropName, const TFDAnsiString ADefValue) = 0 ;
	...
	virtual void __fastcall WriteAnsiString(const System::UnicodeString APropName, const TFDAnsiString AValue, const TFDAnsiString ADefValue) = 0 ;
...
enum DECLSPEC_DENUM TFDMoniEventKind : unsigned int { ekLiveCycle, ekError, ekConnConnect, ekConnTransact, ekConnService, ekCmdPrepare, ekCmdExecute, ekCmdDataIn, ekCmdDataOut, ekAdaptUpdate, ekVendor, ekComponent, ekSQL, ekSQLVarIn, ekSQLVarOut };
...
__interface  INTERFACE_UUID("{3E9B315B-F456-4175-A864-B2573C4A2005}") IFDMoniClient  : public System::IInterface 
{
	...
	virtual void __fastcall Notify(TFDMoniEventKind AKind, TFDMoniEventStep AStep, System::TObject* ASender, const System::UnicodeString AMsg, const System::TVarRec *AArgs, const System::NativeInt AArgs_High) = 0 ;
	virtual System::LongWord __fastcall RegisterAdapter(const _di_IFDMoniAdapter AAdapter) = 0 ;
...
public:
	...
	__property System::Classes::TComponentName Name = {read=GetName};
	__property _di_IFDStanObject Parent = {read=GetParent};
	__property System::LongWord Handle = {read=FHandle, nodefault};
};
...
{
	virtual System::LongWord __fastcall GetHandle() = 0 ;
	...
	__property System::LongWord Handle = {read=GetHandle};
	__property int ItemCount = {read=GetItemCount};
	__property TFDMoniAdapterItemKinds SupportItems = {read=GetSupportItems};
};

typedef System::StaticArray<System::UnicodeString, 42> Firedac_Stan_Intf__9;

//-- var, const, procedure ---------------------------------------------------
static _DELPHI_CONST System::Word varFDAString = System::Word(0x100);
extern DELPHI_PACKAGE __int64 C_FD_MaxInt64;
extern DELPHI_PACKAGE __int64 C_FD_MinInt64;
static _DELPHI_CONST System::Int8 C_FD_MaxUTF8Len = System::Int8(0x3);
static _DELPHI_CONST System::Int8 C_FD_Alignment = System::Int8(0x2);
static _DELPHI_CONST System::Word C_FD_MonitorPort = System::Word(0x1f72);
static _DELPHI_CONST System::Word C_FD_MonitorTimeout = System::Word(0xbb8);
#define C_FD_MonitorFileName L"$(TEMP)\\trace$(NEXT).txt"
static _DELPHI_CONST bool C_FD_MonitorAppend = false;
#define C_FD_MonitorColumns (System::Set<TFDTraceFileColumn, TFDTraceFileColumn::tiRefNo, TFDTraceFileColumn::tiMsgText>() << TFDTraceFileColumn::tiRefNo << TFDTraceFileColumn::tiTime << TFDTraceFileColumn::tiMsgText )
static _DELPHI_CONST System::Int8 C_FD_MonitorEncoding = System::Int8(0x0);
#define C_FD_AllTypes (System::Set<TFDDataType, TFDDataType::dtUnknown, TFDDataType::dtDateTimeStampOff>() << TFDDataType::dtBoolean << TFDDataType::dtSByte << TFDDataType::dtInt16 << TFDDataType::dtInt32 << TFDDataType::dtInt64 << TFDDataType::dtByte << TFDDataType::dtUInt16 << TFDDataType::dtUInt32 << TFDDataType::dtUInt64 << TFDDataType::dtSingle << TFDDataType::dtDouble << TFDDataType::dtExtended << TFDDataType::dtCurrency << TFDDataType::dtBCD << TFDDataType::dtFmtBCD << TFDDataType::dtDateTime << TFDDataType::dtTime << TFDDataType::dtDate << TFDDataType::dtDateTimeStamp << TFDDataType::dtTimeIntervalFull << TFDDataType::dtTimeIntervalYM << TFDDataType::dtTimeIntervalDS << TFDDataType::dtAnsiString << TFDDataType::dtWideString << TFDDataType::dtByteString \
	<< TFDDataType::dtBlob << TFDDataType::dtMemo << TFDDataType::dtWideMemo << TFDDataType::dtXML << TFDDataType::dtHBlob << TFDDataType::dtHMemo << TFDDataType::dtWideHMemo << TFDDataType::dtHBFile << TFDDataType::dtRowSetRef << TFDDataType::dtCursorRef << TFDDataType::dtRowRef << TFDDataType::dtArrayRef << TFDDataType::dtParentRowRef << TFDDataType::dtGUID << TFDDataType::dtObject << TFDDataType::dtDateTimeStampOff )
#define C_FD_InvariantDataTypes (System::Set<TFDDataType, TFDDataType::dtUnknown, TFDDataType::dtDateTimeStampOff>() << TFDDataType::dtRowSetRef << TFDDataType::dtCursorRef << TFDDataType::dtRowRef << TFDDataType::dtArrayRef << TFDDataType::dtParentRowRef )
#define C_FD_BlobTypes (System::Set<TFDDataType, TFDDataType::dtUnknown, TFDDataType::dtDateTimeStampOff>() << TFDDataType::dtBlob << TFDDataType::dtMemo << TFDDataType::dtWideMemo << TFDDataType::dtXML << TFDDataType::dtHBlob << TFDDataType::dtHMemo << TFDDataType::dtWideHMemo << TFDDataType::dtHBFile )
#define C_FD_StrTypes (System::Set<TFDDataType, TFDDataType::dtUnknown, TFDDataType::dtDateTimeStampOff>() << TFDDataType::dtAnsiString << TFDDataType::dtWideString << TFDDataType::dtByteString )
#define C_FD_VarLenTypes (System::Set<TFDDataType, TFDDataType::dtUnknown, TFDDataType::dtDateTimeStampOff>() << TFDDataType::dtAnsiString << TFDDataType::dtWideString << TFDDataType::dtByteString << TFDDataType::dtBlob << TFDDataType::dtMemo << TFDDataType::dtWideMemo << TFDDataType::dtXML << TFDDataType::dtHBlob << TFDDataType::dtHMemo << TFDDataType::dtWideHMemo << TFDDataType::dtHBFile )
#define C_FD_WideTypes (System::Set<TFDDataType, TFDDataType::dtUnknown, TFDDataType::dtDateTimeStampOff>() << TFDDataType::dtWideString << TFDDataType::dtWideMemo << TFDDataType::dtXML << TFDDataType::dtWideHMemo )
#define C_FD_AnsiTypes (System::Set<TFDDataType, TFDDataType::dtUnknown, TFDDataType::dtDateTimeStampOff>() << TFDDataType::dtAnsiString << TFDDataType::dtMemo << TFDDataType::dtHMemo )
#define C_FD_CharTypes (System::Set<TFDDataType, TFDDataType::dtUnknown, TFDDataType::dtDateTimeStampOff>() << TFDDataType::dtAnsiString << TFDDataType::dtWideString << TFDDataType::dtMemo << TFDDataType::dtWideMemo << TFDDataType::dtXML << TFDDataType::dtHMemo << TFDDataType::dtWideHMemo )
#define C_FD_NumTypes (System::Set<TFDDataType, TFDDataType::dtUnknown, TFDDataType::dtDateTimeStampOff>() << TFDDataType::dtSByte << TFDDataType::dtInt16 << TFDDataType::dtInt32 << TFDDataType::dtInt64 << TFDDataType::dtByte << TFDDataType::dtUInt16 << TFDDataType::dtUInt32 << TFDDataType::dtUInt64 << TFDDataType::dtSingle << TFDDataType::dtDouble << TFDDataType::dtExtended << TFDDataType::dtCurrency << TFDDataType::dtBCD << TFDDataType::dtFmtBCD )
#define C_FD_LateSerTypes (System::Set<TFDDataType, TFDDataType::dtUnknown, TFDDataType::dtDateTimeStampOff>() << TFDDataType::dtByteString << TFDDataType::dtBlob << TFDDataType::dtMemo << TFDDataType::dtWideMemo << TFDDataType::dtXML << TFDDataType::dtHBlob << TFDDataType::dtHMemo << TFDDataType::dtWideHMemo << TFDDataType::dtHBFile )
#define C_FD_NumUnsignedTypes (System::Set<TFDDataType, TFDDataType::dtUnknown, TFDDataType::dtDateTimeStampOff>() << TFDDataType::dtByte << TFDDataType::dtUInt16 << TFDDataType::dtUInt32 << TFDDataType::dtUInt64 )
#define C_FD_NonSearchableDataTypes (System::Set<TFDDataType, TFDDataType::dtUnknown, TFDDataType::dtDateTimeStampOff>() << TFDDataType::dtRowSetRef << TFDDataType::dtCursorRef << TFDDataType::dtRowRef << TFDDataType::dtArrayRef << TFDDataType::dtParentRowRef )
extern DELPHI_PACKAGE Firedac_Stan_Intf__9 C_FD_DataTypeNames;
