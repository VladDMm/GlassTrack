...
// (DO NOT EDIT: machine generated header) 'Vcl.ImageCollection.pas' rev: 36.00 (Windows)
...
public:
	...
	__property Vcl::Controls::TCustomData Data = {read=FData, write=FData};
...
typedef void __fastcall (__closure *TImageCollectionOnDrawEvent)(Vcl::Graphics::TWICImage* ASourceImage, Vcl::Graphics::TCanvas* ACanvas, const Winapi::Windows::TRect &ARect, bool AProportional/* = false*/);
...
protected:
	...
	int __fastcall GetSourceImageIndex(int AIndex, int AWidth, int AHeight, bool AProportional);
	Vcl::Graphics::TWICImage* __fastcall GetSourceImageByIndex(int AIndex, int ASourceIndex);
	void __fastcall DoDraw(Vcl::Graphics::TCanvas* ACanvas, const Winapi::Windows::TRect &ARect, int AIndex, bool AProportional);
...
public:
	...
	void __fastcall DrawSource(Vcl::Graphics::TCanvas* ACanvas, const Winapi::Windows::TRect &ARect, int AIndex, int ASourceIndex, bool AProportional = false);
	virtual void __fastcall Draw(Vcl::Graphics::TCanvas* ACanvas, const Winapi::Windows::TRect &ARect, int AIndex, bool AProportional = false)/* overload */;
	HIDESBASE void __fastcall Draw(Vcl::Graphics::TCanvas* ACanvas, const Winapi::Windows::TRect &ARect, const System::UnicodeString AName, bool AProportional = false)/* overload */;
	...
	void __fastcall Add(System::UnicodeString AName, Winapi::Windows::THandle AInstance, const System::UnicodeString AResourceName)/* overload */;
	void __fastcall Add(System::UnicodeString AName, Winapi::Windows::THandle AInstance, const System::UnicodeString AResourceName, System::UnicodeString *ASuffixes, const System::NativeInt ASuffixes_High)/* overload */;
