...
// (DO NOT EDIT: machine generated header) 'System.Win.Registry.pas' rev: 36.00 (Windows)
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall ERegistryException(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : System::Sysutils::Exception(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall ERegistryException(System::NativeUInt Ident)/* overload */ : System::Sysutils::Exception(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall ERegistryException(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall ERegistryException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall ERegistryException(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : System::Sysutils::Exception(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall ERegistryException(System::NativeUInt Ident, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall ERegistryException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall ERegistryException(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High, AHelpContext) { }
...
enum DECLSPEC_DENUM TRegDataType : unsigned char { rdUnknown, rdString, rdExpandString, rdInteger, rdBinary, rdIntegerBE, rdLink, rdMultiString, rdInt64 };
...
private:
	...
	bool FCloseRootKey;
	System::LongWord FAccess;
	System::LongInt FLastError;
...
protected:
	...
	bool __fastcall CheckResult(System::LongInt RetVal);
...
public:
	...
	__int64 __fastcall ReadInt64(const System::UnicodeString Name);
	...
	System::DynamicArray<System::UnicodeString> __fastcall ReadMultiString(const System::UnicodeString Name);
	...
	void __fastcall WriteInteger(const System::UnicodeString Name, int Value)/* overload */;
	void __fastcall WriteInteger(const System::UnicodeString Name, int Value, System::Types::TEndian Endian)/* overload */;
	void __fastcall WriteInt64(const System::UnicodeString Name, __int64 Value);
	...
	void __fastcall WriteMultiString(const System::UnicodeString Name, const System::DynamicArray<System::UnicodeString> Value);
#ifndef _WIN64
	...
	__property System::LongWord Access = {read=FAccess, write=FAccess, nodefault};
...
public:
	...
	__fastcall TRegIniFile(const System::UnicodeString FileName, System::LongWord AAccess)/* overload */;
...
public:
	...
	/* TRegistry.Create */ inline __fastcall TRegIniFile(System::LongWord AAccess)/* overload */ : TRegistry(AAccess) { }
...
public:
	...
	__fastcall TRegistryIniFile(const System::UnicodeString FileName, System::LongWord AAccess)/* overload */;
...
//-- var, const, procedure ---------------------------------------------------
static _DELPHI_CONST TRegDataType rdNone = (TRegDataType)(9);
extern DELPHI_PACKAGE bool __fastcall ReadNone(TRegistry* Instance, const System::UnicodeString Name);
extern DELPHI_PACKAGE void __fastcall WriteNone(TRegistry* Instance, const System::UnicodeString Name);
}	/* namespace Registry */
}	/* namespace Win */
}	/* namespace System */
