...
#ifdef _WIN64
 #if defined(USEPACKAGES) && (__clang_major__ < 15)
...
#elif defined(_PLAT_IOS32)
    typedef long                 Longint;          // -2147483648..2147483647
#else
...
// TODO: This does not work w/ v15 COFF/WIN64
#if __cplusplus >= 201103L && defined(_WIN32) && !defined(NO_TOBJECT_MAKE_SHARED) && !defined(_MSC_VER)
#include <memory>
namespace std {
...
#if defined(__clang__)
  #define _DELPHI_CONST constexpr
#else
