...
// (DO NOT EDIT: machine generated header) 'System.Win.Taskbar.pas' rev: 36.00 (Windows)
...
#endif /* _WIN64 */
	bool __fastcall SetThumbnailClip(const Winapi::Windows::TRect &AClipRect)/* overload */;
	bool __fastcall SetThumbnailClip(HWND AWindow, const Winapi::Windows::TRect &AClipRect)/* overload */;
...
#ifndef _WIN64
	bool __fastcall ThumbBarAddButtons(THUMBBUTTON *AButtonList, const System::NativeInt AButtonList_High, HWND ATabHandle = (HWND)(0x0));
#else /* _WIN64 */
	bool __fastcall ThumbBarAddButtons(THUMBBUTTON *AButtonList, const System::NativeInt AButtonList_High, HWND ATabHandle = (HWND)(0ULL));
#endif /* _WIN64 */
	bool __fastcall ThumbBarSetImageList(HWND AHwnd, Winapi::Windows::THandle AImageList);
#ifndef _WIN64
	bool __fastcall ThumbBarUpdateButtons(THUMBBUTTON *AButtonList, const System::NativeInt AButtonList_High, HWND ATabHandle = (HWND)(0x0));
#else /* _WIN64 */
	bool __fastcall ThumbBarUpdateButtons(THUMBBUTTON *AButtonList, const System::NativeInt AButtonList_High, HWND ATabHandle = (HWND)(0ULL));
#endif /* _WIN64 */
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall ETaskbarException(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : System::Sysutils::Exception(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall ETaskbarException(System::NativeUInt Ident)/* overload */ : System::Sysutils::Exception(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall ETaskbarException(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall ETaskbarException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall ETaskbarException(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : System::Sysutils::Exception(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall ETaskbarException(System::NativeUInt Ident, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall ETaskbarException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall ETaskbarException(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High, AHelpContext) { }
