...
// (DO NOT EDIT: machine generated header) 'Vcl.Grids.pas' rev: 36.00 (Windows)
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EInvalidGridOperation(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : System::Sysutils::Exception(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EInvalidGridOperation(System::NativeUInt Ident)/* overload */ : System::Sysutils::Exception(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EInvalidGridOperation(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EInvalidGridOperation(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EInvalidGridOperation(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : System::Sysutils::Exception(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EInvalidGridOperation(System::NativeUInt Ident, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EInvalidGridOperation(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EInvalidGridOperation(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High, AHelpContext) { }
...
typedef int __fastcall (__closure *TGetExtentsFunc)(System::LongInt Index);
...
typedef System::Set<TGridDrawStateItem, TGridDrawStateItem::gdSelected, TGridDrawStateItem::gdPressed> TGridDrawState;

enum DECLSPEC_DENUM TGridScrollDirectionItem : unsigned char { sdLeft, sdRight, sdUp, sdDown };

typedef System::Set<TGridScrollDirectionItem, TGridScrollDirectionItem::sdLeft, TGridScrollDirectionItem::sdDown> TGridScrollDirection;
...
typedef void __fastcall (__closure *TFixedCellClickEvent)(System::TObject* Sender, System::LongInt ACol, System::LongInt ARow);
...
private:
	...
	void __fastcall MoveCurrent(System::LongInt ACol, System::LongInt ARow, bool MoveAnchor, bool Show);
	void __fastcall MoveTopLeft(System::LongInt ALeft, System::LongInt ATop);
	void __fastcall ResizeCol(System::LongInt Index, int OldSize, int NewSize);
	void __fastcall ResizeRow(System::LongInt Index, int OldSize, int NewSize);
	...
	int __fastcall GetColWidths(System::LongInt Index);
	int __fastcall GetRowHeights(System::LongInt Index);
	TGridRect __fastcall GetSelection();
	bool __fastcall GetTabStops(System::LongInt Index);
	...
	void __fastcall SetColWidths(System::LongInt Index, int Value);
	...
	void __fastcall SetRowHeights(System::LongInt Index, int Value);
	void __fastcall SetScrollBars(System::Uitypes::TScrollStyle Value);
	void __fastcall SetSelection(const TGridRect &Value);
	void __fastcall SetTabStops(System::LongInt Index, bool Value);
	...
	HIDESBASE MESSAGE void __fastcall CMDesignHitTest(Vcl::Controls::TCMDesignHitTest &Msg);
	...
	HIDESBASE MESSAGE void __fastcall WMCancelMode(Winapi::Messages::TWMCancelMode &Msg);
	...
	System::Classes::TAlignment __fastcall GetColAlignments(System::LongInt Index);
	void __fastcall SetColAlignments(System::LongInt Index, const System::Classes::TAlignment Value);
	...
	System::Classes::TAlignment __fastcall GetCellAlignments(System::LongInt ACol, System::LongInt ARow);
...
protected:
	...
	virtual void __fastcall CalcSizingState(int X, int Y, TGridState &State, System::LongInt &Index, int &SizingPos, int &SizingOfs, TGridDrawInfo &FixedInfo);
	...
	HIDESBASEDYNAMIC void __fastcall AdjustSize(System::LongInt Index, System::LongInt Amount, bool Rows);
	System::Types::TRect __fastcall BoxRect(System::LongInt ALeft, System::LongInt ATop, System::LongInt ARight, System::LongInt ABottom);
	DYNAMIC void __fastcall DoExit();
	virtual TGridRect __fastcall CalcExpandedCellRect(const TGridCoord &Coord);
	System::Types::TRect __fastcall CellRect(System::LongInt ACol, System::LongInt ARow);
	...
	DYNAMIC void __fastcall FixedCellClick(System::LongInt ACol, System::LongInt ARow);
	void __fastcall FocusCell(System::LongInt ACol, System::LongInt ARow, bool MoveAnchor);
	DYNAMIC System::UnicodeString __fastcall GetEditText(System::LongInt ACol, System::LongInt ARow);
	DYNAMIC void __fastcall SetEditText(System::LongInt ACol, System::LongInt ARow, const System::UnicodeString Value);
	DYNAMIC int __fastcall GetEditLimit();
	DYNAMIC System::UnicodeString __fastcall GetEditMask(System::LongInt ACol, System::LongInt ARow);
	DYNAMIC TEditStyle __fastcall GetEditStyle(System::LongInt ACol, System::LongInt ARow);
	...
	DYNAMIC void __fastcall ColumnMoved(System::LongInt FromIndex, System::LongInt ToIndex);
	...
	virtual void __fastcall DrawCell(System::LongInt ACol, System::LongInt ARow, const System::Types::TRect &ARect, TGridDrawState AState) = 0 ;
	...
	void __fastcall MoveColRow(System::LongInt ACol, System::LongInt ARow, bool MoveAnchor, bool Show);
	virtual bool __fastcall SelectCell(System::LongInt ACol, System::LongInt ARow);
	DYNAMIC void __fastcall SizeChanged(System::LongInt OldColCount, System::LongInt OldRowCount);
	...
	virtual void __fastcall DeleteColumn(System::LongInt ACol);
	virtual void __fastcall DeleteRow(System::LongInt ARow);
	...
	__property int ColOffset = {read=FColOffset, nodefault};
	__property int ColWidths[System::LongInt Index] = {read=GetColWidths, write=SetColWidths};
	...
	__property int RowHeights[System::LongInt Index] = {read=GetRowHeights, write=SetRowHeights};
	...
	__property bool TabStops[System::LongInt Index] = {read=GetTabStops, write=SetTabStops};
...
public:
	...
	int __fastcall ActualGridLineWidth();
...
typedef void __fastcall (__closure *TSetEditEvent)(System::TObject* Sender, System::LongInt ACol, System::LongInt ARow, const System::UnicodeString Value);
...
protected:
	DYNAMIC void __fastcall ColumnMoved(System::LongInt FromIndex, System::LongInt ToIndex);
	virtual void __fastcall DrawCell(System::LongInt ACol, System::LongInt ARow, const System::Types::TRect &ARect, TGridDrawState AState);
	DYNAMIC System::UnicodeString __fastcall GetEditMask(System::LongInt ACol, System::LongInt ARow);
	DYNAMIC System::UnicodeString __fastcall GetEditText(System::LongInt ACol, System::LongInt ARow);
	DYNAMIC void __fastcall RowMoved(System::LongInt FromIndex, System::LongInt ToIndex);
	virtual bool __fastcall SelectCell(System::LongInt ACol, System::LongInt ARow);
...
public:
	HIDESBASE System::Types::TRect __fastcall CellRect(System::LongInt ACol, System::LongInt ARow);
...
private:
	...
	Vcl::Controls::TCustomData FRows;
	Vcl::Controls::TCustomData FCols;
...
private:
	...
	Vcl::Controls::TCustomData __fastcall EnsureDataRow(int ARow);
...
//-- var, const, procedure ---------------------------------------------------
static _DELPHI_CONST int MaxGridSize = int(0x7ffffff);
static _DELPHI_CONST System::Int8 MaxShortInt = System::Int8(127);
static _DELPHI_CONST int MaxCustomExtents = int(0x7ffffff);
}	/* namespace Grids */
}	/* namespace Vcl */
