...
// (DO NOT EDIT: machine generated header) 'Winapi.Winsock2.pas' rev: 36.00 (Windows)
...
//-- type declarations -------------------------------------------------------
#ifndef _WIN64
typedef unsigned TSocket;
#else /* _WIN64 */
typedef unsigned __int64 TSocket;
#endif /* _WIN64 */
...
#else /* _WIN64 */
typedef unsigned __int64 TWsaEvent;
#endif /* _WIN64 */
...
typedef PWsaProtocolInfoW PWsaProtocolInfo;
...
typedef PWsaNameSpaceInfoW PWsaNameSpaceInfo;
...
typedef PWsaNameSpaceInfoEXW PWsaNameSpaceInfoEX;
...
//-- var, const, procedure ---------------------------------------------------
extern DELPHI_PACKAGE void __fastcall _FD_SET(TSocket fd, TFdSet &fdset);
}	/* namespace Winsock2 */
}	/* namespace Winapi */
