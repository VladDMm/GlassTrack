...
// (DO NOT EDIT: machine generated header) 'Winapi.CommCtrl.pas' rev: 36.00 (Windows)
...
typedef TFNPSPCallbackW TFNPSPCallback;
...
public:
	union
	{
		...
		struct 
		{
			PNMTVCustomDraw NMTVCustomDraw;
		};
		struct 
		{
			PNMTreeView NMTreeView;
		};
		struct 
		{
			PNMCustomDraw NMCustomDraw;
		};
		struct 
		{
			Winapi::Windows::PNMHdr NMHdr;
...
public:
	union
	{
		...
		struct 
		{
			PNMReBarChevron NMReBarChevron;
		};
		struct 
		{
			Winapi::Windows::PNMHdr NMHdr;
...
public:
	union
	{
		struct 
		{
			PNMLVODStateChange NMLVODStateChange;
#ifndef _WIN64
			int Result;
#else /* _WIN64 */
			__int64 Result;
		...
		struct 
		{
			PNMLVFinditem NMLVFindItem;
		};
		struct 
		{
			PNMLVCustomDraw NMLVCustomDraw;
		};
		struct 
		{
			PNMLVCacheHint NMLVCacheHint;
		};
		struct 
		{
			PNMListView NMListView;
		};
		struct 
		{
			PNMCustomDraw NMCustomDraw;
...
public:
	union
	{
		...
		struct 
		{
			PNMTBCustomDraw NMTBCustomDraw;
		};
		struct 
		{
			Winapi::Windows::PNMHdr NMHdr;
...
public:
	union
	{
		struct 
		{
			PNMDateTimeString NMDateTimeString;
#ifndef _WIN64
			int Result;
#else /* _WIN64 */
			__int64 Result;
		...
		struct 
		{
			PNMDateTimeChange NMDateTimeChange;
		};
		struct 
		{
			Winapi::Windows::PNMHdr NMHdr;
...
//-- var, const, procedure ---------------------------------------------------
static _DELPHI_CONST System::Int8 PSH_MULTILINETABS = System::Int8(0x10);
static _DELPHI_CONST short TBN_CLOSEUP = short(-711);
static _DELPHI_CONST System::Word RB_GETBANDINFO_PRE_IE4 = System::Word(0x405);
#define HOTKEYCLASS L"msctls_hotkey32"
static _DELPHI_CONST System::Int8 LVA_ALIGNRIGHT = System::Int8(0x3);
static _DELPHI_CONST System::Int8 LVA_ALIGNBOTTOM = System::Int8(0x4);
static _DELPHI_CONST System::Word LVA_SORTASCENDING = System::Word(0x100);
static _DELPHI_CONST System::Word LVA_SORTDESCENDING = System::Word(0x200);
static _DELPHI_CONST System::Word LVM_SETWORKAREA = System::Word(0x1041);
static _DELPHI_CONST System::Int8 TVIS_FOCUSED = System::Int8(0x1);
static _DELPHI_CONST System::Int8 MCS_NOTODAY_PRE_IE4 = System::Int8(0x8);
static _DELPHI_CONST System::Int8 DCHF_TOPALIGN = System::Int8(0x2);
static _DELPHI_CONST System::Int8 DCHF_HORIZONTAL = System::Int8(0x4);
static _DELPHI_CONST System::Int8 DCHF_HOT = System::Int8(0x8);
static _DELPHI_CONST System::Int8 DCHF_PUSHED = System::Int8(0x10);
static _DELPHI_CONST System::Int8 DCHF_FLIPPED = System::Int8(0x20);
static _DELPHI_CONST System::Int8 DCHF_TRANSPARENT = System::Int8(0x40);
static _DELPHI_CONST System::Byte DCHF_INACTIVE = System::Byte(0x80);
static _DELPHI_CONST System::Word DCHF_NOBORDER = System::Word(0x100);
extern DELPHI_PACKAGE System::LongInt __fastcall StateImageMaskToIndex(int I);
...
extern DELPHI_PACKAGE HTREEITEM __fastcall TreeView_InsertItemA(HWND hwnd, const TTVInsertStructA &lpis);
extern DELPHI_PACKAGE HTREEITEM __fastcall TreeView_InsertItemW(HWND hwnd, const TTVInsertStructW &lpis);
}	/* namespace Commctrl */
}	/* namespace Winapi */
