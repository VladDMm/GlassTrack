...
// (DO NOT EDIT: machine generated header) 'FireDAC.DApt.Intf.pas' rev: 36.00 (Windows)
...
private:
	...
	Firedac::Stan::Option::TFDUpdateRequest FRequest;
...
public:
	/* Exception.CreateFmt */ inline __fastcall EFDDAptRowUpdateException(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : Firedac::Stan::Error::EFDException(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EFDDAptRowUpdateException(System::NativeUInt Ident)/* overload */ : Firedac::Stan::Error::EFDException(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EFDDAptRowUpdateException(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : Firedac::Stan::Error::EFDException(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EFDDAptRowUpdateException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : Firedac::Stan::Error::EFDException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EFDDAptRowUpdateException(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : Firedac::Stan::Error::EFDException(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EFDDAptRowUpdateException(System::NativeUInt Ident, int AHelpContext)/* overload */ : Firedac::Stan::Error::EFDException(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EFDDAptRowUpdateException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : Firedac::Stan::Error::EFDException(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EFDDAptRowUpdateException(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : Firedac::Stan::Error::EFDException(Ident, Args, Args_High, AHelpContext) { }
