...
// (DO NOT EDIT: machine generated header) 'FireDAC.Stan.SQLTimeInt.pas' rev: 36.00 (Windows)
...
extern DELPHI_PACKAGE System::TVarType __fastcall FDVarSQLTimeInterval(void);
