...
// (DO NOT EDIT: machine generated header) 'Data.SqlTimSt.pas' rev: 36.00 (Windows)
...
extern DELPHI_PACKAGE System::TVarType __fastcall VarSQLTimeStamp(void);
...
extern DELPHI_PACKAGE TSQLTimeStamp __fastcall OffsetToUTC(const TSQLTimeStampOffset &Value);
extern DELPHI_PACKAGE TSQLTimeStampOffset __fastcall UTCToOffset(const TSQLTimeStamp &Value);
extern DELPHI_PACKAGE TSQLTimeStamp __fastcall OffsetToLocal(const TSQLTimeStampOffset &Value);
extern DELPHI_PACKAGE TSQLTimeStampOffset __fastcall LocalToOffset(const TSQLTimeStamp &Value);
}	/* namespace Sqltimst */
}	/* namespace Data */
