...
// (DO NOT EDIT: machine generated header) 'FireDAC.Stan.Param.pas' rev: 36.00 (Windows)
...
private:
	...
	void __fastcall DoChanging(TFDMacro* AMacro);
	void __fastcall DoChanged(TFDMacro* AMacro);
...
private:
	...
	Firedac::Stan::Intf::TFDByteString __fastcall GetAsByteStrs(int AIndex);
	...
	void __fastcall SetAsBlobs(int AIndex, const Firedac::Stan::Intf::TFDByteString AValue);
	void __fastcall SetAsBooleans(int AIndex, const bool AValue);
	void __fastcall SetAsByteStrs(int AIndex, const Firedac::Stan::Intf::TFDByteString AValue);
	void __fastcall SetAsVarByteStrs(int AIndex, const Firedac::Stan::Intf::TFDByteString AValue);
	...
	void __fastcall SetAsMemos(int AIndex, const Firedac::Stan::Intf::TFDAnsiString AValue);
	...
	void __fastcall SetBytesValue(int AIndex, System::PByte ABuff, System::LongWord ASize);
	...
	Data::Db::Largeint __fastcall GetAsLargeInt();
	Data::Db::Largeint __fastcall GetAsLargeInts(int AIndex);
	void __fastcall SetAsLargeInt(const Data::Db::Largeint AValue);
	void __fastcall SetAsLargeInts(int AIndex, const Data::Db::Largeint AValue);
	...
	Firedac::Stan::Intf::TFDAnsiString __fastcall GetAsAnsiString();
	Firedac::Stan::Intf::TFDAnsiString __fastcall GetAsAnsiStrings(int AIndex);
	System::Extended __fastcall GetAsExtended();
	System::Extended __fastcall GetAsExtendeds(int AIndex);
	System::LongWord __fastcall GetAsLongWord();
	System::LongWord __fastcall GetAsLongWords(int AIndex);
	void __fastcall SetAsAnsiString(const Firedac::Stan::Intf::TFDAnsiString AValue);
	void __fastcall SetAsAnsiStrings(int AIndex, const Firedac::Stan::Intf::TFDAnsiString AValue);
	...
	void __fastcall SetAsLongWord(const System::LongWord AValue);
	void __fastcall SetAsLongWords(int AIndex, const System::LongWord AValue);
	...
	Firedac::Stan::Intf::TFDByteString __fastcall GetAsByteStr();
	System::TDateTime __fastcall GetAsDateTime();
	...
	void __fastcall SetAsBlob(const Firedac::Stan::Intf::TFDByteString AValue);
	void __fastcall SetAsByteStr(const Firedac::Stan::Intf::TFDByteString AValue);
	void __fastcall SetAsVarByteStr(const Firedac::Stan::Intf::TFDByteString AValue);
	...
	void __fastcall SetAsFloat(const double AValue);
	void __fastcall SetAsInteger(const int AValue);
	void __fastcall SetAsMemo(const Firedac::Stan::Intf::TFDAnsiString AValue);
	void __fastcall SetAsString(const System::UnicodeString AValue);
	...
	System::PByte __fastcall EndSetBlobRawData(System::LongWord ALen, System::PByte APtr, int AIndex);
	...
	Data::Sqltimst::TSQLTimeStampOffset __fastcall GetAsSQLTimeStampOffsets(int AIndex);
	void __fastcall SetAsSQLTimeStampOffset(const Data::Sqltimst::TSQLTimeStampOffset &AValue);
	void __fastcall SetAsSQLTimeStampOffsets(int AIndex, const Data::Sqltimst::TSQLTimeStampOffset &AValue);
...
public:
	...
	bool __fastcall GetBlobRawData(System::LongWord &ALen, System::PByte &APtr, int AIndex = 0xffffffff);
	System::PByte __fastcall SetBlobRawData(System::LongWord ALen, System::PByte APtr, int AIndex = 0xffffffff);
	...
	__property Firedac::Stan::Intf::TFDAnsiString AsAnsiString = {read=GetAsAnsiString, write=SetAsAnsiString};
	__property Firedac::Stan::Intf::TFDByteString AsBlob = {read=GetAsByteStr, write=SetAsBlob};
	__property Firedac::Stan::Intf::TFDAnsiString AsMemo = {read=GetAsAnsiString, write=SetAsMemo};
	...
	__property Data::Db::Largeint AsLargeInts[int AIndex] = {read=GetAsLargeInts, write=SetAsLargeInts};
	...
	__property Firedac::Stan::Intf::TFDAnsiString AsAnsiStrings[int AIndex] = {read=GetAsAnsiStrings, write=SetAsAnsiStrings};
	...
	__property Data::Sqltimst::TSQLTimeStampOffset AsSQLTimeStampOffsets[int AIndex] = {read=GetAsSQLTimeStampOffsets, write=SetAsSQLTimeStampOffsets};
