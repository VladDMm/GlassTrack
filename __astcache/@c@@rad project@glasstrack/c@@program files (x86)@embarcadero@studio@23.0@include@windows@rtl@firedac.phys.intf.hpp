...
// (DO NOT EDIT: machine generated header) 'FireDAC.Phys.Intf.pas' rev: 36.00 (Windows)
...
__interface DELPHIINTERFACE IFDPhysConnectionDefStat;
typedef System::DelphiInterface<IFDPhysConnectionDefStat> _di_IFDPhysConnectionDefStat;
//-- type declarations -------------------------------------------------------
typedef Firedac::Stan::Intf::TFDCommandKind TFDPhysCommandKind;
...
typedef System::Set<TFDPhysLimitOption, TFDPhysLimitOption::loSkip, TFDPhysLimitOption::loRows> TFDPhysLimitOptions;

enum DECLSPEC_DENUM TFDPhysSelectOption : unsigned int { soWithoutFrom, soInlineView };

typedef System::Set<TFDPhysSelectOption, TFDPhysSelectOption::soWithoutFrom, TFDPhysSelectOption::soInlineView> TFDPhysSelectOptions;
...
enum DECLSPEC_DENUM TFDPhysCommandGeneratorOption : unsigned int { goForceQuoteTab, goForceNoQuoteTab, goForceQuoteCol, goForceNoQuoteCol, goBeautify, goNoVersion, goSkipUnsupTypes };

typedef System::Set<TFDPhysCommandGeneratorOption, TFDPhysCommandGeneratorOption::goForceQuoteTab, TFDPhysCommandGeneratorOption::goSkipUnsupTypes> TFDPhysCommandGeneratorOptions;
...
enum DECLSPEC_DENUM TFDPhysCreateTableOption : unsigned int { ctDefaultFirst, ctNoAlterTableConstraint };

typedef System::Set<TFDPhysCreateTableOption, TFDPhysCreateTableOption::ctDefaultFirst, TFDPhysCreateTableOption::ctNoAlterTableConstraint> TFDPhysCreateTableOptions;

enum DECLSPEC_DENUM TFDPhysCreateTablePart : unsigned int { tpTable, tpGenerators, tpTriggers, tpPrimaryKey, tpIndexes };
...
public:
	...
	bool FFilterNoCase;
	bool FFilterPartial;
	Firedac::Dats::TFDDatSTable* FFilterTable;
	bool FRanged;
...
__interface  INTERFACE_UUID("{3E9B315B-F456-4175-A864-B2573C4A2101}") IFDPhysManager  : public System::IInterface 
{
	...
	virtual _di_IFDPhysConnectionDefStat __fastcall GetConnectionDefStat(const Firedac::Stan::Intf::_di_IFDStanConnectionDef AConnectionDef) = 0 ;
...
__interface  INTERFACE_UUID("{3E9B315B-F456-4175-A864-B2573C4A2104}") IFDPhysConnectionMetadata  : public System::IInterface 
{
	...
	virtual Firedac::Stan::Intf::TFDVersion __fastcall GetClientVersion() = 0 ;
	virtual Firedac::Stan::Intf::TFDVersion __fastcall GetServerVersion() = 0 ;
	...
	__property Firedac::Stan::Intf::TFDVersion ClientVersion = {read=GetClientVersion};
	__property Firedac::Stan::Intf::TFDVersion ServerVersion = {read=GetServerVersion};
...
enum DECLSPEC_DENUM TFDPhysLocalSQLAdapterFeature : unsigned int { afCachedUpdates, afSavePoints, afIndexFieldNames, afRanges, afFilters, afPrimaryKey, afTransactions };

typedef System::Set<TFDPhysLocalSQLAdapterFeature, TFDPhysLocalSQLAdapterFeature::afCachedUpdates, TFDPhysLocalSQLAdapterFeature::afTransactions> TFDPhysLocalSQLAdapterFeatures;
...
__interface  INTERFACE_UUID("{3E9B315B-F456-4175-A864-B2573C4A2118}") IFDPhysLocalSQLAdapter  : public System::IInterface 
{
	...
	virtual System::NativeUInt __fastcall GetConn() = 0 ;
	...
	__property System::NativeUInt Conn = {read=GetConn};
};
...
__interface  INTERFACE_UUID("{3E9B315B-F456-4175-A864-B2573C4A2105}") IFDPhysConnection  : public System::IInterface 
{
	...
	virtual unsigned __int64 __fastcall GetCommandsExecuted() = 0 ;
...
__interface  INTERFACE_UUID("{3E9B315B-F456-4175-A864-B2573C4A2113}") IFDPhysTransaction  : public System::IInterface 
{
	...
	virtual System::LongWord __fastcall GetSerialID() = 0 ;
	virtual System::LongWord __fastcall GetTopSerialID() = 0 ;
	virtual System::LongWord __fastcall GetNestingLevel() = 0 ;
	virtual void * __fastcall GetCliObj() = 0 ;
	...
	virtual System::LongWord __fastcall StartTransaction() = 0 ;
	...
	__property System::LongWord TopSerialID = {read=GetTopSerialID};
	__property System::LongWord SerialID = {read=GetSerialID};
	__property System::LongWord NestingLevel = {read=GetNestingLevel};
	__property void * CliObj = {read=GetCliObj};
...
enum DECLSPEC_DENUM TFDPhysCommandGeneratorFlag : unsigned int { gfHasHBlob, gfFetchGenerator, gfIdentityInsert, gfInlineView, gfCreateIdentityTrigger, gfCreateIdentityGenerator };

typedef System::Set<TFDPhysCommandGeneratorFlag, TFDPhysCommandGeneratorFlag::gfHasHBlob, TFDPhysCommandGeneratorFlag::gfCreateIdentityGenerator> TFDPhysCommandGeneratorFlags;
...
__interface  INTERFACE_UUID("{3E9B315B-F456-4175-A864-B2573C4A2109}") IFDPhysCommand  : public System::IInterface 
{
	...
	virtual Firedac::Stan::Intf::TFDCounter __fastcall GetRowsAffected() = 0 ;
...
__interface  INTERFACE_UUID("{3E9B315B-F456-4175-A864-B2573C4A2122}") IFDPhysConnectionDefStat  : public System::IInterface 
{
	virtual unsigned __fastcall GetCreatedConnections() = 0 ;
	virtual unsigned __fastcall GetAliveConnections() = 0 ;
	virtual unsigned __fastcall GetBusyConnections() = 0 ;
	__property unsigned CreatedConnections = {read=GetCreatedConnections};
	__property unsigned AliveConnections = {read=GetAliveConnections};
	__property unsigned BusyConnections = {read=GetBusyConnections};
};

//-- var, const, procedure ---------------------------------------------------
extern DELPHI_PACKAGE TFDPhysCommandGeneratorFlag gfInlinePK;
