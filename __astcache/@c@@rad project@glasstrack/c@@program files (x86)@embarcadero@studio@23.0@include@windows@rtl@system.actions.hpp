...
// (DO NOT EDIT: machine generated header) 'System.Actions.pas' rev: 36.00 (Windows)
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EActionError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : System::Sysutils::Exception(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EActionError(System::NativeUInt Ident)/* overload */ : System::Sysutils::Exception(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EActionError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EActionError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EActionError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : System::Sysutils::Exception(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EActionError(System::NativeUInt Ident, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EActionError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EActionError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* TStringList.Create */ inline __fastcall TCustomShortCutList(System::Classes::TDuplicates Duplicates, bool Sorted, bool CaseSensitive)/* overload */ : System::Classes::TStringList(Duplicates, Sorted, CaseSensitive) { }
...
protected:
	...
	virtual void __fastcall SetActionList(TContainedActionList* AActionList);
...
typedef void __fastcall (__closure *TEnumActionProc)(const System::UnicodeString Category, System::Classes::TBasicActionClass ActionClass, TEnumActionProcInfo Info);

//-- var, const, procedure ---------------------------------------------------
extern DELPHI_PACKAGE bool vDesignAction;
extern DELPHI_PACKAGE void __fastcall (*RegisterActionsProc)(const System::UnicodeString CategoryName, System::Classes::TBasicActionClass const *AClasses, const System::NativeInt AClasses_High, System::Classes::TComponentClass Resource);
extern DELPHI_PACKAGE void __fastcall (*UnRegisterActionsProc)(System::Classes::TBasicActionClass const *AClasses, const System::NativeInt AClasses_High);
...
extern DELPHI_PACKAGE void __fastcall UnRegisterActions(System::Classes::TBasicActionClass const *AClasses, const System::NativeInt AClasses_High);
extern DELPHI_PACKAGE void __fastcall EnumRegisteredActions(TEnumActionProc Proc, TEnumActionProcInfo Info, System::UnicodeString FrameworkType = System::UnicodeString());
