...
// (DO NOT EDIT: machine generated header) 'System.Classes.pas' rev: 36.00 (Windows)
...
class DELPHICLASS TProxyAggregateStream;
...
class DELPHICLASS TTextReaderEnumerator;
...
typedef System::UInt32 TPlatformIds;
...
enum DECLSPEC_DENUM TShiftStateItem : unsigned char { ssShift, ssAlt, ssCtrl, ssLeft, ssRight, ssMiddle, ssDouble, ssTouch, ssPen, ssCommand, ssHorizontal };
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EStreamError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : System::Sysutils::Exception(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EStreamError(System::NativeUInt Ident)/* overload */ : System::Sysutils::Exception(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EStreamError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EStreamError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EStreamError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : System::Sysutils::Exception(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EStreamError(System::NativeUInt Ident, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EStreamError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EStreamError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High, AHelpContext) { }
...
public:
	/* Exception.CreateFmt */ inline __fastcall EFileStreamError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : EStreamError(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EFileStreamError(System::NativeUInt Ident)/* overload */ : EStreamError(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EFileStreamError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : EStreamError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EFileStreamError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : EStreamError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EFileStreamError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : EStreamError(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EFileStreamError(System::NativeUInt Ident, int AHelpContext)/* overload */ : EStreamError(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EFileStreamError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : EStreamError(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EFileStreamError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : EStreamError(Ident, Args, Args_High, AHelpContext) { }
...
public:
	/* Exception.CreateFmt */ inline __fastcall EFCreateError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : EFileStreamError(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EFCreateError(System::NativeUInt Ident)/* overload */ : EFileStreamError(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EFCreateError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : EFileStreamError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EFCreateError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : EFileStreamError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EFCreateError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : EFileStreamError(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EFCreateError(System::NativeUInt Ident, int AHelpContext)/* overload */ : EFileStreamError(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EFCreateError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : EFileStreamError(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EFCreateError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : EFileStreamError(Ident, Args, Args_High, AHelpContext) { }
...
public:
	/* Exception.CreateFmt */ inline __fastcall EFOpenError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : EFileStreamError(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EFOpenError(System::NativeUInt Ident)/* overload */ : EFileStreamError(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EFOpenError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : EFileStreamError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EFOpenError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : EFileStreamError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EFOpenError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : EFileStreamError(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EFOpenError(System::NativeUInt Ident, int AHelpContext)/* overload */ : EFileStreamError(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EFOpenError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : EFileStreamError(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EFOpenError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : EFileStreamError(Ident, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EFilerError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : EStreamError(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EFilerError(System::NativeUInt Ident)/* overload */ : EStreamError(Ident) { }
	/* Exception.CreateRes */ inline __fastcall EFilerError(System::PResStringRec ResStringRec)/* overload */ : EStreamError(ResStringRec) { }
	/* Exception.CreateResFmt */ inline __fastcall EFilerError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : EStreamError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EFilerError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : EStreamError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EFilerError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : EStreamError(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EFilerError(System::NativeUInt Ident, int AHelpContext)/* overload */ : EStreamError(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EFilerError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : EStreamError(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EFilerError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : EStreamError(Ident, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EReadError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : EFilerError(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EReadError(System::NativeUInt Ident)/* overload */ : EFilerError(Ident) { }
	/* Exception.CreateRes */ inline __fastcall EReadError(System::PResStringRec ResStringRec)/* overload */ : EFilerError(ResStringRec) { }
	/* Exception.CreateResFmt */ inline __fastcall EReadError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : EFilerError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EReadError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : EFilerError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EReadError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : EFilerError(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EReadError(System::NativeUInt Ident, int AHelpContext)/* overload */ : EFilerError(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EReadError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : EFilerError(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EReadError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : EFilerError(Ident, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EWriteError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : EFilerError(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EWriteError(System::NativeUInt Ident)/* overload */ : EFilerError(Ident) { }
	/* Exception.CreateRes */ inline __fastcall EWriteError(System::PResStringRec ResStringRec)/* overload */ : EFilerError(ResStringRec) { }
	/* Exception.CreateResFmt */ inline __fastcall EWriteError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : EFilerError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EWriteError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : EFilerError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EWriteError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : EFilerError(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EWriteError(System::NativeUInt Ident, int AHelpContext)/* overload */ : EFilerError(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EWriteError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : EFilerError(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EWriteError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : EFilerError(Ident, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EClassNotFound(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : EFilerError(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EClassNotFound(System::NativeUInt Ident)/* overload */ : EFilerError(Ident) { }
	/* Exception.CreateRes */ inline __fastcall EClassNotFound(System::PResStringRec ResStringRec)/* overload */ : EFilerError(ResStringRec) { }
	/* Exception.CreateResFmt */ inline __fastcall EClassNotFound(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : EFilerError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EClassNotFound(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : EFilerError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EClassNotFound(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : EFilerError(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EClassNotFound(System::NativeUInt Ident, int AHelpContext)/* overload */ : EFilerError(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EClassNotFound(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : EFilerError(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EClassNotFound(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : EFilerError(Ident, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EMethodNotFound(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : EFilerError(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EMethodNotFound(System::NativeUInt Ident)/* overload */ : EFilerError(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EMethodNotFound(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : EFilerError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EMethodNotFound(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : EFilerError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EMethodNotFound(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : EFilerError(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EMethodNotFound(System::NativeUInt Ident, int AHelpContext)/* overload */ : EFilerError(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EMethodNotFound(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : EFilerError(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EMethodNotFound(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : EFilerError(Ident, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EInvalidImage(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : EFilerError(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EInvalidImage(System::NativeUInt Ident)/* overload */ : EFilerError(Ident) { }
	/* Exception.CreateRes */ inline __fastcall EInvalidImage(System::PResStringRec ResStringRec)/* overload */ : EFilerError(ResStringRec) { }
	/* Exception.CreateResFmt */ inline __fastcall EInvalidImage(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : EFilerError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EInvalidImage(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : EFilerError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EInvalidImage(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : EFilerError(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EInvalidImage(System::NativeUInt Ident, int AHelpContext)/* overload */ : EFilerError(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EInvalidImage(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : EFilerError(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EInvalidImage(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : EFilerError(Ident, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EResNotFound(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : System::Sysutils::Exception(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EResNotFound(System::NativeUInt Ident)/* overload */ : System::Sysutils::Exception(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EResNotFound(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EResNotFound(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EResNotFound(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : System::Sysutils::Exception(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EResNotFound(System::NativeUInt Ident, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EResNotFound(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EResNotFound(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High, AHelpContext) { }
...
using System::Sysutils::EListError;
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EBitsError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : System::Sysutils::Exception(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EBitsError(System::NativeUInt Ident)/* overload */ : System::Sysutils::Exception(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EBitsError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EBitsError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EBitsError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : System::Sysutils::Exception(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EBitsError(System::NativeUInt Ident, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EBitsError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EBitsError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High, AHelpContext) { }
...
public:
	/* Exception.Create */ inline __fastcall EStringListError(const System::UnicodeString Msg) : System::Sysutils::EListError(Msg) { }
	/* Exception.CreateFmt */ inline __fastcall EStringListError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : System::Sysutils::EListError(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EStringListError(System::NativeUInt Ident)/* overload */ : System::Sysutils::EListError(Ident) { }
	/* Exception.CreateRes */ inline __fastcall EStringListError(System::PResStringRec ResStringRec)/* overload */ : System::Sysutils::EListError(ResStringRec) { }
	/* Exception.CreateResFmt */ inline __fastcall EStringListError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::EListError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EStringListError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::EListError(ResStringRec, Args, Args_High) { }
	/* Exception.CreateHelp */ inline __fastcall EStringListError(const System::UnicodeString Msg, int AHelpContext) : System::Sysutils::EListError(Msg, AHelpContext) { }
	/* Exception.CreateFmtHelp */ inline __fastcall EStringListError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : System::Sysutils::EListError(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EStringListError(System::NativeUInt Ident, int AHelpContext)/* overload */ : System::Sysutils::EListError(Ident, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EStringListError(System::PResStringRec ResStringRec, int AHelpContext)/* overload */ : System::Sysutils::EListError(ResStringRec, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EStringListError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::EListError(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EStringListError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::EListError(Ident, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EComponentError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : System::Sysutils::Exception(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EComponentError(System::NativeUInt Ident)/* overload */ : System::Sysutils::Exception(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EComponentError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EComponentError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EComponentError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : System::Sysutils::Exception(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EComponentError(System::NativeUInt Ident, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EComponentError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EComponentError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EParserError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : System::Sysutils::Exception(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EParserError(System::NativeUInt Ident)/* overload */ : System::Sysutils::Exception(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EParserError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EParserError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EParserError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : System::Sysutils::Exception(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EParserError(System::NativeUInt Ident, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EParserError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EParserError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EOutOfResources(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : System::Sysutils::EOutOfMemory(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EOutOfResources(System::NativeUInt Ident)/* overload */ : System::Sysutils::EOutOfMemory(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EOutOfResources(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::EOutOfMemory(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EOutOfResources(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::EOutOfMemory(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EOutOfResources(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : System::Sysutils::EOutOfMemory(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EOutOfResources(System::NativeUInt Ident, int AHelpContext)/* overload */ : System::Sysutils::EOutOfMemory(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EOutOfResources(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::EOutOfMemory(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EOutOfResources(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::EOutOfMemory(Ident, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EInvalidOperation(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : System::Sysutils::Exception(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EInvalidOperation(System::NativeUInt Ident)/* overload */ : System::Sysutils::Exception(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EInvalidOperation(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EInvalidOperation(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EInvalidOperation(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : System::Sysutils::Exception(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EInvalidOperation(System::NativeUInt Ident, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EInvalidOperation(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EInvalidOperation(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High, AHelpContext) { }
...
public:
	...
	System::NativeInt __fastcall IndexOf(void * Item);
	System::NativeInt __fastcall IndexOfItem(void * Item, System::Types::TDirection Direction);
	void __fastcall Insert(System::NativeInt Index, void * Item);
	...
	System::NativeInt __fastcall RemoveItem(void * Item, System::Types::TDirection Direction);
...
#ifndef _WIN64
	__property System::NativeInt Capacity = {read=FCapacity, write=SetCapacity, nodefault};
	__property System::NativeInt Count = {read=FCount, write=SetCount, nodefault};
#else /* _WIN64 */
	__property System::NativeInt Capacity = {read=FCapacity, write=SetCapacity};
	__property System::NativeInt Count = {read=FCount, write=SetCount};
#endif /* _WIN64 */
	__property bool IsEmpty = {read=GetIsEmpty, nodefault};
	__property void * Items[System::NativeInt Index] = {read=Get, write=Put/*, default*/};
...
enum DECLSPEC_DENUM TStringsDefinedItem : unsigned char { sdDelimiter, sdQuoteChar, sdNameValueSeparator, sdLineBreak, sdStrictDelimiter };
...
public:
	...
	void __fastcall AddStrings(const System::UnicodeString *Strings, const System::NativeInt Strings_High);
	void __fastcall AddStrings(const System::DynamicArray<System::UnicodeString> Strings) {
	   if (Strings.Length)
	     AddStrings(Strings.data(), Strings.High);
	};
	void __fastcall AddStrings(const System::UnicodeString *Strings, const System::NativeInt Strings_High,
	                 System::TObject* const *Objects, const System::NativeInt Objects_High);
	void __fastcall AddStrings(const System::DynamicArray<System::UnicodeString> Strings,
...
private:
	enum DECLSPEC_DENUM TOverriddenItem : unsigned char { sloCompareStrings, sloGetObject };
	
	typedef System::Set<TOverriddenItem, TOverriddenItem::sloCompareStrings, TOverriddenItem::sloGetObject> TOverridden;
...
public:
	...
	__fastcall TStringList(TDuplicates Duplicates, bool Sorted, bool CaseSensitive)/* overload */;
...
public:
	inline void __fastcall  AddStrings(const System::UnicodeString *Strings, const System::NativeInt Strings_High){ TStrings::AddStrings(Strings, Strings_High); }
	inline void __fastcall  AddStrings(const System::UnicodeString *Strings, const System::NativeInt Strings_High, System::TObject* const *Objects, const System::NativeInt Objects_High){ TStrings::AddStrings(Strings, Strings_High, Objects, Objects_High); }
...
typedef System::Set<TStreamCapability, TStreamCapability::stcPreallocateOptimization, TStreamCapability::stcOSErrorInfo> TStreamCapabilities;

#ifndef _WIN64
typedef System::LongInt TNativeCount;
#else /* _WIN64 */
typedef System::NativeInt TNativeCount;
#endif /* _WIN64 */
...
protected:
	...
	virtual TStreamCapabilities __fastcall GetCapabilities();
	...
	System::LongInt __fastcall GetByteCount(const System::Sysutils::TBytes Buffer, System::LongInt Offset, System::LongInt Count);
...
public:
...
#endif /* _WIN64 */
	virtual __int64 __fastcall Read64(System::Sysutils::TBytes Buffer, __int64 Offset, __int64 Count);
	virtual __int64 __fastcall Write64(const System::Sysutils::TBytes Buffer, __int64 Offset, __int64 Count);
	...
	void __fastcall WriteBufferData(int &Buffer, System::NativeInt Count)/* overload */;
#ifndef _WIN64
	...
	__property TStreamCapabilities Capabilities = {read=GetCapabilities, nodefault};
public:
...
public:
	__fastcall THandleStream(Winapi::Windows::THandle AHandle);
	virtual System::LongInt __fastcall Read(void *Buffer, System::LongInt Count)/* overload */;
	virtual System::LongInt __fastcall Write(const void *Buffer, System::LongInt Count)/* overload */;
	virtual __int64 __fastcall Seek(const __int64 Offset, TSeekOrigin Origin)/* overload */;
#ifndef _WIN64
...
#else /* _WIN64 */
	__property Winapi::Windows::THandle Handle = {read=FHandle};
#endif /* _WIN64 */
public:
...
public:
#ifdef _WIN64
	inline System::NativeInt __fastcall  Read(void *Buffer, System::NativeInt Count){ return TStream::Read(Buffer, Count); }
#endif /* _WIN64 */
...
#ifdef _WIN64
	inline System::NativeInt __fastcall  Read(System::Sysutils::TBytes Buffer, System::NativeInt Offset, System::NativeInt Count){ return TStream::Read(Buffer, Offset, Count); }
#endif /* _WIN64 */
...
#ifdef _WIN64
	inline System::NativeInt __fastcall  Read(System::Sysutils::TBytes &Buffer, System::NativeInt Count){ return TStream::Read(Buffer, Count); }
	inline System::NativeInt __fastcall  Write(const void *Buffer, System::NativeInt Count){ return TStream::Write(Buffer, Count); }
#endif /* _WIN64 */
...
#ifdef _WIN64
	inline System::NativeInt __fastcall  Write(const System::Sysutils::TBytes Buffer, System::NativeInt Offset, System::NativeInt Count){ return TStream::Write(Buffer, Offset, Count); }
#endif /* _WIN64 */
...
#ifdef _WIN64
	inline System::NativeInt __fastcall  Write(const System::Sysutils::TBytes Buffer, System::NativeInt Count){ return TStream::Write(Buffer, Count); }
#endif /* _WIN64 */
...
private:
	void *FMemory;
	System::NativeInt FSize;
	System::NativeInt FPosition;
...
protected:
	virtual TStreamCapabilities __fastcall GetCapabilities();
	virtual void __fastcall SetCapacity(System::NativeInt NewCapacity);
	virtual void * __fastcall Realloc(System::NativeInt &NewCapacity);
#ifndef _WIN64
	__property System::NativeInt Capacity = {read=FCapacity, write=SetCapacity, nodefault};
#else /* _WIN64 */
	__property System::NativeInt Capacity = {read=FCapacity, write=SetCapacity};
...
public:
	...
	virtual System::LongInt __fastcall Write(const void *Buffer, System::LongInt Count)/* overload */;
#endif /* _WIN64 */
	virtual TNativeCount __fastcall Write(const void *Buffer, TNativeCount Count)/* overload */;
public:
...
public:
	__fastcall TBytesStream(const System::Sysutils::TBytes ABytes)/* overload */;
	__property System::Sysutils::TBytes Bytes = {read=FBytes};
public:
...
public:
	...
	__fastcall TStringStream(const System::Sysutils::TBytes ABytes)/* overload */;
...
private:
	Winapi::Windows::THandle HResInfo;
	Winapi::Windows::THandle HGlobal;
	void __fastcall Initialize(Winapi::Windows::THandle Instance, System::WideChar * Name, System::WideChar * ResType, bool FromID);
...
public:
	__fastcall TPointerStream(void * Ptr, const System::NativeInt Size, bool ReadOnly);
	HIDESBASE void __fastcall SetPointer(void * Ptr, const System::NativeInt Size);
#ifdef _WIN64
	virtual System::LongInt __fastcall Write(const void *Buffer, System::LongInt Count)/* overload */;
#endif /* _WIN64 */
	virtual TNativeCount __fastcall Write(const void *Buffer, TNativeCount Count)/* overload */;
...
public:
	__fastcall TProxySubrangeStream(TStream* Stream, __int64 Offset, __int64 Size, bool OwnsStream);
	__fastcall virtual ~TProxySubrangeStream();
#ifdef _WIN64
	virtual System::LongInt __fastcall Read(void *Buffer, System::LongInt Count)/* overload */;
	virtual System::LongInt __fastcall Write(const void *Buffer, System::LongInt Count)/* overload */;
#endif /* _WIN64 */
...
private:
	typedef System::DynamicArray<bool> _TProxyAggregateStream__1;
	
	
private:
	System::Generics::Collections::TList__1<TStream*>* FStreams;
	_TProxyAggregateStream__1 FOwnsStreams;
	int FCurrentStream;
	__int64 FCurrentStreamPos;
	__int64 FSize;
	__int64 FPosition;
	int __fastcall GetCount();
	TStream* __fastcall GetStreams(int AIndex);
	
protected:
	void __fastcall SyncPosition();
	virtual __int64 __fastcall GetSize();
	
public:
	__fastcall TProxyAggregateStream();
	__fastcall virtual ~TProxyAggregateStream();
#ifdef _WIN64
	virtual System::LongInt __fastcall Read(void *Buffer, System::LongInt Count)/* overload */;
	virtual System::LongInt __fastcall Write(const void *Buffer, System::LongInt Count)/* overload */;
#endif /* _WIN64 */
	...
	virtual TNativeCount __fastcall Write(const void *Buffer, TNativeCount Count)/* overload */;
	virtual __int64 __fastcall Seek(const __int64 Offset, TSeekOrigin Origin)/* overload */;
	int __fastcall AddStream(TStream* AStream, bool OwnsStream = false);
...
private:
	...
	System::NativeInt FBufSize;
	System::NativeInt FBufPos;
	System::NativeInt FBufEnd;
	TComponent* FRoot;
...
private:
	...
	System::NativeInt __fastcall GetPosition();
...
protected:
	...
	void __fastcall SetPosition(System::NativeInt Value);
...
public:
	...
	void __fastcall Read(void *Buffer, System::NativeInt Count)/* overload */;
	void __fastcall Read(System::Sysutils::TBytes Buffer, System::NativeInt Offset, System::NativeInt Count)/* overload */;
	void __fastcall Read(System::Sysutils::TBytes Buffer, System::NativeInt Count)/* overload */;
...
#ifndef _WIN64
	__property System::NativeInt Position = {read=GetPosition, write=SetPosition, nodefault};
#else /* _WIN64 */
	__property System::NativeInt Position = {read=GetPosition, write=SetPosition};
#endif /* _WIN64 */
...
public:
	...
	void __fastcall WriteVar(const char Buffer, System::NativeInt Count)/* overload */;
	void __fastcall WriteVar(const System::WideChar Buffer, System::NativeInt Count)/* overload */;
	void __fastcall WriteVar(const System::Int8 Buffer, System::NativeInt Count)/* overload */;
	void __fastcall WriteVar(const System::UInt8 Buffer, System::NativeInt Count)/* overload */;
	void __fastcall WriteVar(const System::Int16 Buffer, System::NativeInt Count)/* overload */;
	void __fastcall WriteVar(const System::UInt16 Buffer, System::NativeInt Count)/* overload */;
	void __fastcall WriteVar(const System::Int32 Buffer, System::NativeInt Count)/* overload */;
	void __fastcall WriteVar(const System::UInt32 Buffer, System::NativeInt Count)/* overload */;
	void __fastcall WriteVar(const __int64 Buffer, System::NativeInt Count)/* overload */;
	void __fastcall WriteVar(const unsigned __int64 Buffer, System::NativeInt Count)/* overload */;
	void __fastcall WriteVar(const float Buffer, System::NativeInt Count)/* overload */;
	void __fastcall WriteVar(const double Buffer, System::NativeInt Count)/* overload */;
	void __fastcall WriteVar(const System::Extended Buffer, System::NativeInt Count)/* overload */;
	void __fastcall WriteVar(const System::TExtended80Rec &Buffer, System::NativeInt Count)/* overload */;
...
private:
	TStream* FStream;
	System::NativeInt FOrigin;
	System::Sysutils::TBytes FBuffer;
	System::NativeInt FBufPtr;
	System::NativeInt FBufEnd;
	System::NativeInt FSourcePtr;
	System::NativeInt FSourceEnd;
	System::NativeInt FTokenPtr;
	System::NativeInt FStringPtr;
	int FSourceLine;
	System::Byte FSaveChar;
	System::WideChar FToken;
	System::WideChar FFloatType;
	System::Sysutils::TCharArray FWideStr;
	...
	TCharType __fastcall CharType(System::NativeInt &ABufPos);
	
protected:
	System::NativeInt __fastcall GetLinePos();
...
public:
	...
	System::NativeInt __fastcall SourcePos();
...
#ifndef _WIN64
	__property System::NativeInt LinePos = {read=GetLinePos, nodefault};
#else /* _WIN64 */
	__property System::NativeInt LinePos = {read=GetLinePos};
#endif /* _WIN64 */
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EThread(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : System::Sysutils::Exception(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EThread(System::NativeUInt Ident)/* overload */ : System::Sysutils::Exception(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EThread(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EThread(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EThread(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : System::Sysutils::Exception(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EThread(System::NativeUInt Ident, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EThread(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EThread(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High, AHelpContext) { }
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EThreadExternalException(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : EThread(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EThreadExternalException(System::NativeUInt Ident)/* overload */ : EThread(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EThreadExternalException(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : EThread(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EThreadExternalException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : EThread(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EThreadExternalException(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : EThread(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EThreadExternalException(System::NativeUInt Ident, int AHelpContext)/* overload */ : EThread(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EThreadExternalException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : EThread(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EThreadExternalException(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : EThread(Ident, Args, Args_High, AHelpContext) { }
...
private:
	...
	{
		virtual void __fastcall Invoke(System::TThreadID AThreadID, bool &AQueueEvent, bool &AForceQueue, TThreadMethod &AMethod, _di_TThreadProcedure &AProcedure) = 0 ;
	};
...
public:
	...
	__fastcall TThread(bool CreateSuspended, System::NativeUInt ReservedStackSize)/* overload */;
	...
	System::LongWord __fastcall WaitFor();
...
enum DECLSPEC_DENUM TComponentStateItem : unsigned char { csLoading, csReading, csWriting, csDestroying, csDesigning, csAncestor, csUpdating, csFixups, csFreeNotification, csInline, csDesignInstance };
...
private:
	TPlatformIds FPlatforms;
	
public:
	__fastcall ComponentPlatformsAttribute(const TPlatformIds Platforms);
	__property TPlatformIds Platforms = {read=FPlatforms, write=FPlatforms, nodefault};
public:
...
public:
	...
	virtual void __fastcall RemoveObserver(const int *IDs, const System::NativeInt IDs_High, const System::_di_IInterface AIntf)/* overload */;
...
public:
	static _DELPHI_CONST System::Int8 EditLinkID = System::Int8(0x1);
	
	static _DELPHI_CONST System::Int8 EditGridLinkID = System::Int8(0x2);
	
	static _DELPHI_CONST System::Int8 PositionLinkID = System::Int8(0x3);
	
	static _DELPHI_CONST System::Int8 ControlValueID = System::Int8(0x4);
	
	static _DELPHI_CONST System::Int8 IteratorLinkID = System::Int8(0x5);
	
	static _DELPHI_CONST System::Int8 MappedID = System::Int8(0x64);
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EObserverException(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : System::Sysutils::Exception(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EObserverException(System::NativeUInt Ident)/* overload */ : System::Sysutils::Exception(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EObserverException(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EObserverException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EObserverException(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : System::Sysutils::Exception(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EObserverException(System::NativeUInt Ident, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EObserverException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EObserverException(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High, AHelpContext) { }
...
typedef System::Int32 TDesignInfo;
...
private:
	...
	System::TThreadID FInvokingThread;
...
typedef void __fastcall (__closure *TAsyncConstArrayProcedureEvent)(const System::Types::_di_IAsyncResult ASyncResult, const System::TVarRec *Params, const System::NativeInt Params_High);

typedef void __fastcall (__closure *TAsyncConstArrayFunctionEvent)(const System::Types::_di_IAsyncResult ASyncResult, /* out */ System::TObject* &Result, const System::TVarRec *Params, const System::NativeInt Params_High);

__interface TAsyncConstArrayProc  : public System::IInterface 
{
	virtual void __fastcall Invoke(const System::TVarRec *Params, const System::NativeInt Params_High) = 0 ;
};
...
{
	virtual TResult __fastcall Invoke(const System::TVarRec *Params, const System::NativeInt Params_High) = 0 ;
};
...
protected:
	...
	protected:
		...
		__fastcall TAsyncConstArrayResult(System::TObject* const AContext, TComponent* const AComponent, const System::TVarRec *Params, const System::NativeInt Params_High);
	public:
	...
	protected:
		...
		__fastcall TAsyncConstArrayProcResult(const _di_TAsyncConstArrayProc AAsyncProcedure, System::TObject* const AContext, TComponent* const AComponent, const System::TVarRec *Params, const System::NativeInt Params_High);
	public:
	...
	protected:
		__fastcall TAsyncConstArrayFuncResult__1(const System::DelphiInterface<TAsyncConstArrayFunc__1<TResult> > AAsyncFunction, System::TObject* const AContext, TComponent* const AComponent, const System::TVarRec *Params, const System::NativeInt Params_High);
		virtual void __fastcall AsyncDispatch();
	...
	protected:
		virtual void __fastcall AsyncDispatch();
		__fastcall TAsyncConstArrayProcedureResult(const TAsyncConstArrayProcedureEvent AAsyncProcedure, System::TObject* const AContext, TComponent* const AComponent, const System::TVarRec *Params, const System::NativeInt Params_High);
	public:
	...
	protected:
		__fastcall TAsyncConstArrayFunctionResult(const TAsyncConstArrayFunctionEvent AAsyncFunction, System::TObject* const AContext, TComponent* const AComponent, const System::TVarRec *Params, const System::NativeInt Params_High);
		virtual void __fastcall AsyncDispatch();
...
public:
	...
	System::Types::_di_IAsyncResult __fastcall BeginInvoke(const _di_TAsyncConstArrayProc AProc, const System::TVarRec *Params, const System::NativeInt Params_High, System::TObject* const AContext = (System::TObject*)(0x0))/* overload */;
	template<typename TResult> System::Types::_di_IAsyncResult __fastcall BeginInvoke(const System::DelphiInterface<TAsyncConstArrayFunc__1<TResult> > AFunc, const System::TVarRec *Params, const System::NativeInt Params_High, System::TObject* const AContext = (System::TObject*)(0x0))/* overload */;
	System::Types::_di_IAsyncResult __fastcall BeginInvoke(const TAsyncConstArrayProcedureEvent AProc, const System::TVarRec *Params, const System::NativeInt Params_High, System::TObject* const AContext = (System::TObject*)(0x0))/* overload */;
	System::Types::_di_IAsyncResult __fastcall BeginInvoke(const TAsyncConstArrayFunctionEvent AFunc, const System::TVarRec *Params, const System::NativeInt Params_High, System::TObject* const AContext = (System::TObject*)(0x0))/* overload */;
...
protected:
	typedef System::DynamicArray<TBasicAction*> TSafeRef;
...
private:
	...
	TSafeRef __fastcall GetSafeRef();
...
protected:
	...
	__property TSafeRef SafeRef = {read=GetSafeRef};
...
#pragma pack(push,4)
#endif /* not _WIN64 */
class PASCALIMPLEMENTATION TTextReaderEnumerator : public System::TObject
{
	typedef System::TObject inherited;
...
public:
	__fastcall TTextReaderEnumerator(TTextReader* AReader);
	bool __fastcall MoveNext();
	__property System::UnicodeString Current = {read=FLine};
public:
	/* TObject.Destroy */ inline __fastcall virtual ~TTextReaderEnumerator() { }
...
protected:
	virtual bool __fastcall GetEndOfStream() = 0 ;
	
public:
	virtual void __fastcall Close() = 0 ;
	virtual int __fastcall Peek() = 0 ;
	virtual int __fastcall Read() = 0 /* overload */;
	virtual int __fastcall Read(System::Sysutils::TCharArray &Buffer, int Index, int Count) = 0 /* overload */;
	virtual int __fastcall ReadBlock(System::Sysutils::TCharArray &Buffer, int Index, int Count) = 0 ;
	...
	TTextReaderEnumerator* __fastcall GetEnumerator();
...
public:
	...
	virtual void __fastcall Write(const System::Sysutils::TCharArray Value) = 0 /* overload */;
	...
	virtual void __fastcall Write(const System::UnicodeString Format, System::TVarRec *Args, const System::NativeInt Args_High) = 0 /* overload */;
	virtual void __fastcall Write(const System::Sysutils::TCharArray Value, int Index, int Count) = 0 /* overload */;
	...
	virtual void __fastcall WriteLine(const System::Sysutils::TCharArray Value) = 0 /* overload */;
	...
	virtual void __fastcall WriteLine(const System::UnicodeString Format, System::TVarRec *Args, const System::NativeInt Args_High) = 0 /* overload */;
	virtual void __fastcall WriteLine(const System::Sysutils::TCharArray Value, int Index, int Count) = 0 /* overload */;
public:
...
private:
	...
	System::Sysutils::TBytes FCharBytes;
	System::Sysutils::TCharArray FOneChar;
	int FMaxCharsSize;
	int __fastcall InternalReadChar();
	int __fastcall InternalReadChars(const System::Sysutils::TCharArray Chars, int Index, int Count);
...
public:
	...
	virtual int __fastcall Read(System::Sysutils::TCharArray &Buffer, int Index, int Count)/* overload */;
	virtual int __fastcall Read(const System::Sysutils::TBytes Buffer, int Index, int Count)/* overload */;
	virtual bool __fastcall ReadBoolean();
	virtual System::Byte __fastcall ReadByte();
	virtual System::Sysutils::TBytes __fastcall ReadBytes(int Count);
	virtual System::WideChar __fastcall ReadChar();
	virtual System::Sysutils::TCharArray __fastcall ReadChars(int Count);
...
public:
	...
	virtual void __fastcall Write(const System::Sysutils::TBytes Value)/* overload */;
	...
	virtual void __fastcall Write(const System::Sysutils::TBytes Value, int Index, int Count)/* overload */;
	__property TStream* BaseStream = {read=GetBaseStream};
...
protected:
	virtual bool __fastcall GetEndOfStream();
...
public:
	...
	virtual int __fastcall Read()/* overload */;
	virtual int __fastcall Read(System::Sysutils::TCharArray &Buffer, int Index, int Count)/* overload */;
	virtual int __fastcall ReadBlock(System::Sysutils::TCharArray &Buffer, int Index, int Count);
...
public:
	...
	virtual void __fastcall WriteLine(const System::Sysutils::TCharArray Value)/* overload */;
	...
	virtual void __fastcall WriteLine(const System::UnicodeString Format, System::TVarRec *Args, const System::NativeInt Args_High)/* overload */;
	virtual void __fastcall WriteLine(const System::Sysutils::TCharArray Value, int Index, int Count)/* overload */;
...
protected:
	int FBufferIndex;
	System::Sysutils::TBytes FBuffer;
	void __fastcall WriteBytes(System::Sysutils::TBytes Bytes);
...
private:
	...
	public:
		...
		void __fastcall MoveArray(int DestinationIndex, int Count, System::Sysutils::TCharArray &Destination);
...
private:
	...
	bool FSkipPreamble;
	TStream* FStream;
	int __fastcall DetectBOM(System::Sysutils::TEncoding* &Encoding, System::Sysutils::TBytes Buffer);
	int __fastcall SkipPreamble(System::Sysutils::TEncoding* Encoding, System::Sysutils::TBytes Buffer);
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall ELoginCredentialError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : System::Sysutils::Exception(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall ELoginCredentialError(System::NativeUInt Ident)/* overload */ : System::Sysutils::Exception(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall ELoginCredentialError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall ELoginCredentialError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall ELoginCredentialError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : System::Sysutils::Exception(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall ELoginCredentialError(System::NativeUInt Ident, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall ELoginCredentialError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall ELoginCredentialError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High, AHelpContext) { }
...
{
#ifndef _WIN64
	virtual void __fastcall Invoke(const System::UnicodeString ClassName, System::IntPtr Reference, System::Generics::Collections::TStack__1<int>* const Stack) = 0 ;
#else /* _WIN64 */
	virtual void __fastcall Invoke(const System::UnicodeString ClassName, System::IntPtr Reference, System::Generics::Collections::TStack__1<__int64>* const Stack) = 0 ;
#endif /* _WIN64 */
};

//-- var, const, procedure ---------------------------------------------------
static _DELPHI_CONST int MaxListSize _DEPRECATED_ATTRIBUTE0  = int(0x7ffffff);
static _DELPHI_CONST System::Int8 soFromBeginning = System::Int8(0x0);
static _DELPHI_CONST System::Int8 soFromCurrent = System::Int8(0x1);
static _DELPHI_CONST System::Int8 soFromEnd = System::Int8(0x2);
static _DELPHI_CONST System::Word fmCreate = System::Word(0xff00);
static _DELPHI_CONST System::WideChar toEOF = (System::WideChar)(0x0);
static _DELPHI_CONST System::WideChar toSymbol = (System::WideChar)(0x1);
static _DELPHI_CONST System::WideChar toString = (System::WideChar)(0x2);
static _DELPHI_CONST System::WideChar toInteger = (System::WideChar)(0x3);
static _DELPHI_CONST System::WideChar toFloat = (System::WideChar)(0x4);
static _DELPHI_CONST System::WideChar toWString = (System::WideChar)(0x5);
static _DELPHI_CONST System::Word scCommand = System::Word(0x1000);
static _DELPHI_CONST System::Word scShift = System::Word(0x2000);
static _DELPHI_CONST System::Word scCtrl = System::Word(0x4000);
static _DELPHI_CONST System::Word scAlt = System::Word(0x8000);
static _DELPHI_CONST System::Int8 scNone = System::Int8(0x0);
static _DELPHI_CONST System::Int8 pidWin32 = System::Int8(0x1);
static _DELPHI_CONST System::Int8 pidWin64 = System::Int8(0x2);
static _DELPHI_CONST System::Int8 pidOSX32 = System::Int8(0x4);
static _DELPHI_CONST System::Int8 pidiOSSimulator32 = System::Int8(0x8);
static _DELPHI_CONST System::Int8 pidiOSSimulator _DEPRECATED_ATTRIBUTE1("Use pidiOSSimulator32")  = System::Int8(0x8);
static _DELPHI_CONST System::Int8 pidAndroidArm32 = System::Int8(0x10);
static _DELPHI_CONST System::Int8 pidAndroid32Arm _DEPRECATED_ATTRIBUTE1("Use pidAndroidArm32")  = System::Int8(0x10);
static _DELPHI_CONST System::Int8 pidAndroid _DEPRECATED_ATTRIBUTE1("Use pidAndroidArm32")  = System::Int8(0x10);
static _DELPHI_CONST System::Int8 pidLinux32 = System::Int8(0x20);
static _DELPHI_CONST System::Int8 pidiOSDevice32 = System::Int8(0x40);
static _DELPHI_CONST System::Int8 pidiOSDevice _DEPRECATED_ATTRIBUTE1("Use pidiOSDevice32")  = System::Int8(0x40);
static _DELPHI_CONST System::Byte pidLinux64 = System::Byte(0x80);
static _DELPHI_CONST System::Word pidWinNX32 = System::Word(0x100);
static _DELPHI_CONST System::Word pidWinIoT32 = System::Word(0x200);
static _DELPHI_CONST System::Word pidiOSDevice64 = System::Word(0x400);
static _DELPHI_CONST System::Word pidWinARM32 = System::Word(0x800);
static _DELPHI_CONST System::Word pidWin32ARM _DEPRECATED_ATTRIBUTE1("Use pidWinARM32")  = System::Word(0x800);
static _DELPHI_CONST System::Word pidOSX64 = System::Word(0x1000);
static _DELPHI_CONST System::Word pidLinuxArm32 = System::Word(0x2000);
static _DELPHI_CONST System::Word pidLinuxArm64 = System::Word(0x4000);
static _DELPHI_CONST System::Word pidAndroidArm64 = System::Word(0x8000);
static _DELPHI_CONST System::Word pidAndroid64Arm _DEPRECATED_ATTRIBUTE1("Use pidAndroidArm64")  = System::Word(0x8000);
static _DELPHI_CONST int pidiOSSimulator64 = int(0x10000);
static _DELPHI_CONST int pidOSXArm64 = int(0x20000);
static _DELPHI_CONST int pidWinArm64 = int(0x40000);
static _DELPHI_CONST int pidiOSSimulatorArm64 = int(0x80000);
static _DELPHI_CONST int pidWin64x = int(0x100000);
static _DELPHI_CONST int pidAllPlatforms = int(0x1fd4df);
static _DELPHI_CONST int pfidWindows = int(0x140003);
static _DELPHI_CONST int pfidOSX = int(0x21004);
static _DELPHI_CONST int pfidiOS = int(0x90448);
static _DELPHI_CONST System::Word pfidAndroid = System::Word(0x8010);
static _DELPHI_CONST System::Word pfidLinux = System::Word(0x4080);
static _DELPHI_CONST System::Types::TDuplicates dupIgnore = (System::Types::TDuplicates)(0);
static _DELPHI_CONST System::Types::TDuplicates dupAccept = (System::Types::TDuplicates)(1);
static _DELPHI_CONST System::Types::TDuplicates dupError = (System::Types::TDuplicates)(2);
...
extern DELPHI_PACKAGE void __fastcall (*RegisterComponentsProc)(const System::UnicodeString Page, TComponentClass const *ComponentClasses, const System::NativeInt ComponentClasses_High);
extern DELPHI_PACKAGE void __fastcall (*RegisterNoIconProc)(TComponentClass const *ComponentClasses, const System::NativeInt ComponentClasses_High);
extern DELPHI_PACKAGE int CurrentGroup;
extern DELPHI_PACKAGE void __fastcall (*RegisterNonActiveXProc)(TComponentClass const *ComponentClasses, const System::NativeInt ComponentClasses_High, TActiveXRegType AxRegType);
...
extern DELPHI_PACKAGE Winapi::Windows::THandle SyncEvent;
static _DELPHI_CONST System::Generics::Collections::TCollectionNotification cnAdding = (System::Generics::Collections::TCollectionNotification)(0);
static _DELPHI_CONST System::Generics::Collections::TCollectionNotification cnAdded = (System::Generics::Collections::TCollectionNotification)(1);
static _DELPHI_CONST System::Generics::Collections::TCollectionNotification cnExtracting = (System::Generics::Collections::TCollectionNotification)(2);
static _DELPHI_CONST System::Generics::Collections::TCollectionNotification cnExtracted = (System::Generics::Collections::TCollectionNotification)(3);
static _DELPHI_CONST System::Generics::Collections::TCollectionNotification cnDeleting = (System::Generics::Collections::TCollectionNotification)(4);
static _DELPHI_CONST System::Generics::Collections::TCollectionNotification cnRemoved = (System::Generics::Collections::TCollectionNotification)(5);
...
#ifndef _WIN64
extern DELPHI_PACKAGE void __fastcall UnRegisterModuleClasses(unsigned Module);
#else /* _WIN64 */
extern DELPHI_PACKAGE void __fastcall UnRegisterModuleClasses(unsigned __int64 Module);
#endif /* _WIN64 */
...
extern DELPHI_PACKAGE void __fastcall RegisterNonActiveX(TComponentClass const *ComponentClasses, const System::NativeInt ComponentClasses_High, TActiveXRegType AxRegType);
...
extern DELPHI_PACKAGE TComponent* __fastcall ReadComponentDeltaRes(TComponent* Instance, const System::UnicodeString *DeltaCandidates, const System::NativeInt DeltaCandidates_High, const TGetStreamProc Proc);
...
extern DELPHI_PACKAGE TComponent* __fastcall ReadComponentResEx(Winapi::Windows::THandle HInstance, const System::UnicodeString ResName);
...
#ifndef _WIN64
extern DELPHI_PACKAGE int __fastcall LineStart(const System::Sysutils::TBytes Buffer, System::NativeInt BufPos)/* overload */;
#else /* _WIN64 */
extern DELPHI_PACKAGE __int64 __fastcall LineStart(const System::Sysutils::TBytes Buffer, System::NativeInt BufPos)/* overload */;
#endif /* _WIN64 */
...
extern DELPHI_PACKAGE void __fastcall TCollection_ResetID(TCollection* Self);
...
extern DELPHI_PACKAGE int __fastcall HexToBin(const System::Sysutils::TBytes Text, int TextOffset, System::Sysutils::TBytes &Buffer, int BufOffset, int Count)/* overload */;
...
extern DELPHI_PACKAGE void __fastcall Write16bitResourceHeader(const System::Sysutils::TBytes AName, int DataSize, TStream* const Output);
extern DELPHI_PACKAGE void __fastcall Write32bitResourceHeader(const System::Sysutils::TBytes AName, int DataSize, TStream* const Output);
