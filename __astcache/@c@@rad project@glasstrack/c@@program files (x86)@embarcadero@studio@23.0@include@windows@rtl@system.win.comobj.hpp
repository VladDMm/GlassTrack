...
// (DO NOT EDIT: machine generated header) 'System.Win.ComObj.pas' rev: 36.00 (Windows)
...
protected:
	...
	HRESULT __stdcall GetLicInfo(Winapi::Activex::TLicInfo &licInfo);
	HRESULT __stdcall RequestLicKey(System::LongInt dwResrved, /* out */ System::WideString &bstrKey);
	HRESULT __stdcall CreateInstanceLic(const System::_di_IInterface unkOuter, const System::_di_IInterface unkReserved, const Winapi::Activex::TIID &iid, const System::WideString bstrKey, /* out */ void *vObject);
...
private:
	...
	System::PInterfaceEntry FDispIntfEntry;
	GUID FEventIID;
...
private:
	...
	void __fastcall RemoveSink(System::LongInt Cookie);
	
protected:
	HRESULT __stdcall GetConnectionInterface(/* out */ Winapi::Activex::TIID &iid);
	HRESULT __stdcall GetConnectionPointContainer(/* out */ _di_IConnectionPointContainer &cpc);
	HRESULT __stdcall Advise(const System::_di_IInterface unkSink, /* out */ System::LongInt &dwCookie);
	HRESULT __stdcall Unadvise(System::LongInt dwCookie);
...
protected:
	...
	HRESULT __stdcall FindConnectionPoint(const Winapi::Activex::TIID &iid, /* out */ _di_IConnectionPoint &cp);
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EOleError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : System::Sysutils::Exception(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EOleError(System::NativeUInt Ident)/* overload */ : System::Sysutils::Exception(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EOleError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EOleError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EOleError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : System::Sysutils::Exception(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EOleError(System::NativeUInt Ident, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EOleError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EOleError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High, AHelpContext) { }
...
public:
	/* Exception.CreateFmt */ inline __fastcall EOleRegistrationError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : EOleSysError(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EOleRegistrationError(System::NativeUInt Ident)/* overload */ : EOleSysError(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EOleRegistrationError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : EOleSysError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EOleRegistrationError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : EOleSysError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EOleRegistrationError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : EOleSysError(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EOleRegistrationError(System::NativeUInt Ident, int AHelpContext)/* overload */ : EOleSysError(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EOleRegistrationError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : EOleSysError(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EOleRegistrationError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : EOleSysError(Ident, Args, Args_High, AHelpContext) { }
...
extern DELPHI_PACKAGE Winapi::Activex::POleStr __fastcall StringToLPOLESTR(const System::UnicodeString Source);
...
extern DELPHI_PACKAGE void __fastcall InterfaceConnect(const System::_di_IInterface Source, const Winapi::Activex::TIID &IID, const System::_di_IInterface Sink, System::LongInt &Connection);
extern DELPHI_PACKAGE void __fastcall InterfaceDisconnect(const System::_di_IInterface Source, const Winapi::Activex::TIID &IID, System::LongInt &Connection);
...
extern DELPHI_PACKAGE void __fastcall DispatchInvokeError(int Status, const Winapi::Activex::TExcepInfo &ExcepInfo);
...
extern DELPHI_PACKAGE HRESULT __fastcall EventDispatchInvoke(int DispId, Winapi::Activex::TDispParams &ADispParams, _di_TEventDispatchInvoker Invoker);
