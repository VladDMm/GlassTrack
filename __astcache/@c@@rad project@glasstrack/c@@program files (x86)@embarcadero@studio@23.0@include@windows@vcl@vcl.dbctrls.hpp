...
// (DO NOT EDIT: machine generated header) 'Vcl.DBCtrls.pas' rev: 36.00 (Windows)
...
private:
	...
	Winapi::Windows::TPoint __fastcall GetTextMargins();
...
protected:
	...
	Winapi::Windows::TRect __fastcall DestRect(Vcl::Graphics::TPicture* APicture);
	DYNAMIC HPALETTE __fastcall GetPalette();
	DYNAMIC void __fastcall KeyDown(System::Word &Key, System::Classes::TShiftState Shift);
	DYNAMIC void __fastcall KeyPress(System::WideChar &Key);
	virtual void __fastcall Notification(System::Classes::TComponent* AComponent, System::Classes::TOperation Operation);
	virtual void __fastcall Paint();
	DYNAMIC void __fastcall Progress(System::TObject* Sender, Vcl::Graphics::TProgressStage Stage, System::Byte PercentDone, bool RedrawNow, const Winapi::Windows::TRect &R, const System::UnicodeString Msg);
...
enum DECLSPEC_DENUM TNavButtonStyleItem : unsigned char { nsAllowTimer, nsFocusRect };

typedef System::Set<TNavButtonStyleItem, TNavButtonStyleItem::nsAllowTimer, TNavButtonStyleItem::nsFocusRect> TNavButtonStyle;
...
private:
	...
	TDBNavigatorKind __fastcall GetKind();
	HIDESBASE void __fastcall SetKind(TDBNavigatorKind Value);
	...
	HIDESBASE Vcl::Buttons::TNavButton* __fastcall GetButton(TNavigateBtn Index);
	
protected:
	__property Vcl::Buttons::TNavButton* Buttons[TNavigateBtn Index] = {read=GetButton};
	void __fastcall ActiveChanged();
	void __fastcall DataChanged();
	void __fastcall EditingChanged();
	virtual void __fastcall Notification(System::Classes::TComponent* AComponent, System::Classes::TOperation Operation);
	virtual Vcl::Imglist::TCustomImageList* __fastcall GetButtonImageList();
	virtual void __fastcall BtnIDClick(Vcl::Buttons::TNavBtnID Index);
	virtual void __fastcall Loaded();
...
__published:
	...
	__property TDBNavigatorKind Kind = {read=GetKind, write=SetKind, default=0};
	__property ParentCtl3D = {default=1};
	__property ParentShowHint = {default=1};
	__property PopupMenu;
...
private:
	// __classmethod void __fastcall Create@();
public:
	/* TWinControl.CreateParented */ inline __fastcall TDBNavigator(HWND ParentWindow) : Vcl::Buttons::TBaseNavigator(ParentWindow) { }
...
//-- var, const, procedure ---------------------------------------------------
static _DELPHI_CONST System::Word InitRepeatPause = System::Word(0x190);
static _DELPHI_CONST System::Int8 RepeatPause = System::Int8(0x64);
static _DELPHI_CONST System::Int8 SpaceSize = System::Int8(0x5);
