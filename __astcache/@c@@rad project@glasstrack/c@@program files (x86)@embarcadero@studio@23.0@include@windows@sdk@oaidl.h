...
#if (__STDC__ && !defined(_FORCENAMELESSUNION) && !defined(__CODEGEARC__)) || defined(NONAMELESSUNION) || (!defined(_MSC_EXTENSIONS) && !defined(_FORCENAMELESSUNION) && !defined(__CODEGEARC__))
