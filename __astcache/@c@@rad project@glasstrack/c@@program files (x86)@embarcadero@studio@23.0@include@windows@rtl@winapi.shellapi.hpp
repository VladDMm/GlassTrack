...
// (DO NOT EDIT: machine generated header) 'Winapi.ShellAPI.pas' rev: 36.00 (Windows)
...
public:
	...
	Winapi::Windows::THandle hUserToken;
	Winapi::Windows::PSecurityAttributes lpProcessAttributes;
	Winapi::Windows::PSecurityAttributes lpThreadAttributes;
	System::LongBool bInheritHandles;
	unsigned dwCreationFlags;
	Winapi::Windows::PStartupInfoW lpStartupInfo;
	Winapi::Windows::PProcessInformation lpProcessInformation;
};
#ifndef _WIN64
#pragma pack(pop)
#endif /* not _WIN64 */
