...
// (DO NOT EDIT: machine generated header) 'FireDAC.DatS.pas' rev: 36.00 (Windows)
...
typedef System::Set<TFDDatSColumnThing, TFDDatSColumnThing::ctCalcs, TFDDatSColumnThing::ctParentRef> TFDDatSColumnThings;
...
private:
	...
	void __fastcall SetSize(const System::LongWord AValue);
...
public:
	...
	__property System::LongWord Size = {read=FSize, write=SetSize, default=50};
	...
	__property System::LongWord SourceSize = {read=FSourceSize, write=FSourceSize, nodefault};
...
private:
	...
	System::LongWord __fastcall GetStorageSize();
...
public:
	...
	__property System::LongWord StorageSize = {read=GetStorageSize, nodefault};
...
public:
	...
	TFDDatSUniqueConstraint* __fastcall AddUK(const System::UnicodeString AName, TFDDatSColumn* const *AColumns, const System::NativeInt AColumns_High, bool APrimaryKey = true)/* overload */;
...
private:
	...
	Firedac::Stan::Intf::TFDObjList* FCascadingRows;
...
private:
	TFDDatSTable* FTable;
	Winapi::Windows::PByte FpInfo;
	Winapi::Windows::PByte FpOriginal;
	Winapi::Windows::PByte FpCurrent;
	Winapi::Windows::PByte FpProposed;
	TFDDatSRow* FNextChange;
	TFDDatSRow* FPriorChange;
	System::LongWord FRowID;
	System::LongWord FChangeNumber;
	PFDDataRowExtraInfo FExtraInfo;
	bool __fastcall GetHasErrors();
	TFDDatSTableRowList* __fastcall GetRowList();
	void __fastcall CalculateColumns(bool ADefaults);
	Winapi::Windows::PByte __fastcall CheckWrite(int AColumn, TFDDatSRowVersion AVersion);
	void __fastcall InternalSetData(int AColumn, TFDDatSRowVersion AVersion, void * ABuff, System::LongWord ADataLen);
	void __fastcall InternalInitComplexData(Winapi::Windows::PByte ABuffer);
	void __fastcall AllocInvariants();
	void __fastcall FreeInvariants();
	System::NativeInt __fastcall InternalGetInvariantObject(int AColumn);
	TFDDatSObject* __fastcall GetInvariantObject(int AColumn);
	void __fastcall InternalSetInvariantObject(int AColumn, System::NativeInt AValue);
	...
	bool __fastcall GetCheckInfo(int ACheckColumn, /* out */ Winapi::Windows::PByte &ACheckValue, /* out */ System::LongWord &ACheckLen);
	void __fastcall SetCheckInfo(int ACheckColumn, Winapi::Windows::PByte ACheckValue, int ACheckLen);
	bool __fastcall SkipConstraintCheck();
	void __fastcall CascadeAcceptReject(bool AAccept);
	System::LongWord __fastcall GetDBLockID();
	...
	void __fastcall SaveRowVersion(const Firedac::Stan::Intf::_di_IFDStanStorage AStorage, const System::UnicodeString AName, Winapi::Windows::PByte ABuff, TFDDatSRowState ABuffKind);
	void __fastcall LoadRowVersion(const Firedac::Stan::Intf::_di_IFDStanStorage AStorage, const System::UnicodeString AName, Winapi::Windows::PByte &ABuff, TFDDatSRowState ABuffKind);
...
protected:
	...
	virtual void __fastcall DoListRemoved(TFDDatSObject* ANewOwner);
	virtual void __fastcall DoListRemoving();
	Winapi::Windows::PByte __fastcall AllocBuffer();
	void __fastcall CleanupBuffer(Winapi::Windows::PByte ABuffer);
	void __fastcall CopyBuffer(Winapi::Windows::PByte ADestination, Winapi::Windows::PByte ASource);
	void __fastcall FreeBuffer(Winapi::Windows::PByte &ApBuffer);
	bool __fastcall GetBlobData(Winapi::Windows::PByte ABuffer, int AColumn, Winapi::Windows::PByte &ApData, int &ALen);
	Winapi::Windows::PByte __fastcall GetBuffer(TFDDatSRowVersion AVersion);
...
public:
	...
	bool __fastcall GetData(const int AColumn, TFDDatSRowVersion AVersion, void * &ABuff, System::LongWord ABuffLen, System::LongWord &ADataLen, bool AByVal)/* overload */;
	...
	Winapi::Windows::PByte __fastcall BeginDirectWriteBlob(int AColumn, int ABlobLen);
	...
	void __fastcall DBLock(System::LongWord ALockID = (unsigned)(0xffffffff));
	...
	__property System::LongWord DBLockID = {read=GetDBLockID, nodefault};
	...
	__property System::LongWord RowID = {read=FRowID, nodefault};
	__property System::LongWord ChangeNumber = {read=FChangeNumber, nodefault};
...
private:
	Firedac::Stan::Intf::TFDPtrList* FAggregateValues;
...
private:
	...
	Firedac::Stan::Intf::TFDLocalID FLocale;
	bool FCaseSensitive;
	bool FNested;
	...
	void __fastcall SetLocale(const Firedac::Stan::Intf::TFDLocalID AValue);
...
private:
	...
	void __fastcall SetSavePoint(const System::LongWord AValue);
...
public:
	...
	void __fastcall Clear();
	__property System::LongWord SavePoint = {read=FChangeNumber, write=SetSavePoint, nodefault};
