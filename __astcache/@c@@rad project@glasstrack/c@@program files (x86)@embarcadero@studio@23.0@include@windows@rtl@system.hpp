...
// (DO NOT EDIT: machine generated header) 'System.pas' rev: 36.00 (Windows)
...
#define _DELPHI_WEAK_NATIVEINT  // NativeInt and NativeUInt are alias type
#ifndef _WIN64
#define _DELPHI_OBJ_FMT_OMF     // Object format OMF
#else /* _WIN64 */
#define _DELPHI_OBJ_FMT_ELF     // Object format ELF
#endif /* _WIN64 */
#include <sysmac.h>

//-- user supplied -----------------------------------------------------------
#define RTLVersionC 3600
#define RTLVersion121C
#define RTLVersion122C
namespace System
{
...
typedef System::NativeInt IntPtr;
...
enum DECLSPEC_DENUM TVisibilityClass : unsigned char { vcPrivate, vcProtected, vcPublic, vcPublished };

typedef Set<TVisibilityClass, TVisibilityClass::vcPrivate, TVisibilityClass::vcPublished> TVisibilityClasses;
...
typedef System::LongWord TThreadID;
...
#else /* _WIN64 */
typedef System::DynamicArray<__int64> TBoundArray;
#endif /* _WIN64 */
...
#else /* _WIN64 */
typedef __int64 *PNativeInt;
#endif /* _WIN64 */

#ifndef _WIN64
typedef unsigned *PNativeUInt;
#else /* _WIN64 */
typedef unsigned __int64 *PNativeUInt;
#endif /* _WIN64 */
...
public:
	...
	void __fastcall (*VarToWStr)(System::WideString &S, const Variant &V);
	...
	void __fastcall (*VarFromWStr)(Variant &V, const System::WideString Value);
	...
	void __fastcall (*VarOp)(Variant &Left, const Variant &Right, TVarOp OpCode);
	void __fastcall (*VarCmp)(const TVarData &Left, const TVarData &Right, const TVarOp OpCode);
...
public:
	__fastcall TPtrWrapper(System::NativeInt AValue)/* overload */;
	__fastcall TPtrWrapper(void * AValue)/* overload */;
	void * __fastcall ToPointer();
	System::NativeInt __fastcall ToInteger();
...
#else /* _WIN64 */
typedef unsigned __int64 TResourceHandle;
#endif /* _WIN64 */
...
typedef UInt32 __fastcall (*TRandom32Proc)(void);
...
typedef bool __fastcall (*TEnumModuleFunc)(System::NativeInt HInstance, void * Data);

typedef bool __fastcall (*TEnumModuleFuncLW)(System::NativeUInt HInstance, void * Data);

typedef void __fastcall (*TModuleUnloadProc)(System::NativeInt HInstance);
...
//-- var, const, procedure ---------------------------------------------------
static _DELPHI_CONST bool False = false;
static _DELPHI_CONST bool True = true;
static _DELPHI_CONST int MaxInt = int(2147483647);
static _DELPHI_CONST int MaxLongInt = int(2147483647);
#define RTLVersion  (3.600000E+01)
static _DELPHI_CONST bool RTLVersion121 = true;
static _DELPHI_CONST bool RTLVersion122 = true;
static _DELPHI_CONST System::Int8 varEmpty = System::Int8(0x0);
static _DELPHI_CONST System::Int8 varNull = System::Int8(0x1);
static _DELPHI_CONST System::Int8 varSmallint = System::Int8(0x2);
static _DELPHI_CONST System::Int8 varInteger = System::Int8(0x3);
static _DELPHI_CONST System::Int8 varSingle = System::Int8(0x4);
static _DELPHI_CONST System::Int8 varDouble = System::Int8(0x5);
static _DELPHI_CONST System::Int8 varCurrency = System::Int8(0x6);
static _DELPHI_CONST System::Int8 varDate = System::Int8(0x7);
static _DELPHI_CONST System::Int8 varOleStr = System::Int8(0x8);
static _DELPHI_CONST System::Int8 varDispatch = System::Int8(0x9);
static _DELPHI_CONST System::Int8 varError = System::Int8(0xa);
static _DELPHI_CONST System::Int8 varBoolean = System::Int8(0xb);
static _DELPHI_CONST System::Int8 varVariant = System::Int8(0xc);
static _DELPHI_CONST System::Int8 varUnknown = System::Int8(0xd);
static _DELPHI_CONST System::Int8 varShortInt = System::Int8(0x10);
static _DELPHI_CONST System::Int8 varByte = System::Int8(0x11);
static _DELPHI_CONST System::Int8 varWord = System::Int8(0x12);
static _DELPHI_CONST System::Int8 varLongWord = System::Int8(0x13);
static _DELPHI_CONST System::Int8 varUInt32 = System::Int8(0x13);
static _DELPHI_CONST System::Int8 varInt64 = System::Int8(0x14);
static _DELPHI_CONST System::Int8 varUInt64 = System::Int8(0x15);
static _DELPHI_CONST System::Int8 varRecord = System::Int8(0x24);
static _DELPHI_CONST System::Int8 varStrArg = System::Int8(0x48);
static _DELPHI_CONST System::Int8 varObject = System::Int8(0x49);
static _DELPHI_CONST System::Int8 varUStrArg = System::Int8(0x4a);
static _DELPHI_CONST System::Word varString = System::Word(0x100);
static _DELPHI_CONST System::Word varAny = System::Word(0x101);
static _DELPHI_CONST System::Word varUString = System::Word(0x102);
static _DELPHI_CONST System::Word varTypeMask = System::Word(0xfff);
static _DELPHI_CONST System::Word varArray = System::Word(0x2000);
static _DELPHI_CONST System::Word varByRef = System::Word(0x4000);
static _DELPHI_CONST System::Int8 vtInteger = System::Int8(0x0);
static _DELPHI_CONST System::Int8 vtBoolean = System::Int8(0x1);
static _DELPHI_CONST System::Int8 vtChar = System::Int8(0x2);
static _DELPHI_CONST System::Int8 vtExtended = System::Int8(0x3);
static _DELPHI_CONST System::Int8 vtString = System::Int8(0x4);
static _DELPHI_CONST System::Int8 vtPointer = System::Int8(0x5);
static _DELPHI_CONST System::Int8 vtPChar = System::Int8(0x6);
static _DELPHI_CONST System::Int8 vtObject = System::Int8(0x7);
static _DELPHI_CONST System::Int8 vtClass = System::Int8(0x8);
static _DELPHI_CONST System::Int8 vtWideChar = System::Int8(0x9);
static _DELPHI_CONST System::Int8 vtPWideChar = System::Int8(0xa);
static _DELPHI_CONST System::Int8 vtAnsiString = System::Int8(0xb);
static _DELPHI_CONST System::Int8 vtCurrency = System::Int8(0xc);
static _DELPHI_CONST System::Int8 vtVariant = System::Int8(0xd);
static _DELPHI_CONST System::Int8 vtInterface = System::Int8(0xe);
static _DELPHI_CONST System::Int8 vtWideString = System::Int8(0xf);
static _DELPHI_CONST System::Int8 vtInt64 = System::Int8(0x10);
static _DELPHI_CONST System::Int8 vtUnicodeString = System::Int8(0x11);
static _DELPHI_CONST System::Int8 vmtArcOffset = System::Int8(0x0);
#ifndef _WIN64
static _DELPHI_CONST System::Int8 CPP_ABI_ADJUST = System::Int8(0x0);
static _DELPHI_CONST Int8 vmtSelfPtr = Int8(-88);
static _DELPHI_CONST Int8 vmtIntfTable = Int8(-84);
static _DELPHI_CONST Int8 vmtAutoTable = Int8(-80);
static _DELPHI_CONST Int8 vmtInitTable = Int8(-76);
static _DELPHI_CONST Int8 vmtTypeInfo = Int8(-72);
static _DELPHI_CONST Int8 vmtFieldTable = Int8(-68);
static _DELPHI_CONST Int8 vmtMethodTable = Int8(-64);
static _DELPHI_CONST Int8 vmtDynamicTable = Int8(-60);
static _DELPHI_CONST Int8 vmtClassName = Int8(-56);
static _DELPHI_CONST Int8 vmtInstanceSize = Int8(-52);
static _DELPHI_CONST Int8 vmtParent = Int8(-48);
static _DELPHI_CONST Int8 vmtEquals _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = Int8(-44);
static _DELPHI_CONST Int8 vmtGetHashCode _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = Int8(-40);
static _DELPHI_CONST Int8 vmtToString _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = Int8(-36);
static _DELPHI_CONST Int8 vmtSafeCallException _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = Int8(-32);
static _DELPHI_CONST Int8 vmtAfterConstruction _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = Int8(-28);
static _DELPHI_CONST Int8 vmtBeforeDestruction _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = Int8(-24);
static _DELPHI_CONST Int8 vmtDispatch _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = Int8(-20);
static _DELPHI_CONST Int8 vmtDefaultHandler _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = Int8(-16);
static _DELPHI_CONST Int8 vmtNewInstance _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = Int8(-12);
static _DELPHI_CONST Int8 vmtFreeInstance _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = Int8(-8);
static _DELPHI_CONST Int8 vmtDestroy _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = Int8(-4);
#else /* _WIN64 */
static _DELPHI_CONST System::Int8 CPP_ABI_ADJUST = System::Int8(0x18);
static _DELPHI_CONST short vmtSelfPtr = short(-200);
static _DELPHI_CONST short vmtIntfTable = short(-192);
static _DELPHI_CONST short vmtAutoTable = short(-184);
static _DELPHI_CONST short vmtInitTable = short(-176);
static _DELPHI_CONST short vmtTypeInfo = short(-168);
static _DELPHI_CONST short vmtFieldTable = short(-160);
static _DELPHI_CONST short vmtMethodTable = short(-152);
static _DELPHI_CONST short vmtDynamicTable = short(-144);
static _DELPHI_CONST short vmtClassName = short(-136);
static _DELPHI_CONST Int8 vmtInstanceSize = Int8(-128);
static _DELPHI_CONST Int8 vmtParent = Int8(-120);
static _DELPHI_CONST Int8 vmtEquals _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = Int8(-112);
static _DELPHI_CONST Int8 vmtGetHashCode _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = Int8(-104);
static _DELPHI_CONST Int8 vmtToString _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = Int8(-96);
static _DELPHI_CONST Int8 vmtSafeCallException _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = Int8(-88);
static _DELPHI_CONST Int8 vmtAfterConstruction _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = Int8(-80);
static _DELPHI_CONST Int8 vmtBeforeDestruction _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = Int8(-72);
static _DELPHI_CONST Int8 vmtDispatch _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = Int8(-64);
static _DELPHI_CONST Int8 vmtDefaultHandler _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = Int8(-56);
static _DELPHI_CONST Int8 vmtNewInstance _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = Int8(-48);
static _DELPHI_CONST Int8 vmtFreeInstance _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = Int8(-40);
static _DELPHI_CONST Int8 vmtDestroy _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = Int8(-32);
#endif /* _WIN64 */
static _DELPHI_CONST System::Int8 vmtQueryInterface _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = System::Int8(0x0);
#ifndef _WIN64
static _DELPHI_CONST System::Int8 vmtAddRef _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = System::Int8(0x4);
static _DELPHI_CONST System::Int8 vmtRelease _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = System::Int8(0x8);
static _DELPHI_CONST System::Int8 vmtCreateObject _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = System::Int8(0xc);
static _DELPHI_CONST int hfFieldSize = int(0x4);
#else /* _WIN64 */
static _DELPHI_CONST System::Int8 vmtAddRef _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = System::Int8(0x8);
static _DELPHI_CONST System::Int8 vmtRelease _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = System::Int8(0x10);
static _DELPHI_CONST System::Int8 vmtCreateObject _DEPRECATED_ATTRIBUTE1("Use VMTOFFSET in asm code")  = System::Int8(0x18);
static _DELPHI_CONST int hfFieldSize = int(0x8);
#endif /* _WIN64 */
static _DELPHI_CONST System::Int8 hfMonitorOffset = System::Int8(0x0);
#define DefaultMethodRttiVisibility (Set<TVisibilityClass, TVisibilityClass::vcPrivate, TVisibilityClass::vcPublished>() << TVisibilityClass::vcPublic << TVisibilityClass::vcPublished )
#define DefaultFieldRttiVisibility (Set<TVisibilityClass, TVisibilityClass::vcPrivate, TVisibilityClass::vcPublished>() << TVisibilityClass::vcPrivate << TVisibilityClass::vcProtected << TVisibilityClass::vcPublic << TVisibilityClass::vcPublished )
#define DefaultPropertyRttiVisibility (Set<TVisibilityClass, TVisibilityClass::vcPrivate, TVisibilityClass::vcPublished>() << TVisibilityClass::vcPublic << TVisibilityClass::vcPublished )
static _DELPHI_CONST System::Int8 opAdd = System::Int8(0x0);
static _DELPHI_CONST System::Int8 opSubtract = System::Int8(0x1);
static _DELPHI_CONST System::Int8 opMultiply = System::Int8(0x2);
static _DELPHI_CONST System::Int8 opDivide = System::Int8(0x3);
static _DELPHI_CONST System::Int8 opIntDivide = System::Int8(0x4);
static _DELPHI_CONST System::Int8 opModulus = System::Int8(0x5);
static _DELPHI_CONST System::Int8 opShiftLeft = System::Int8(0x6);
static _DELPHI_CONST System::Int8 opShiftRight = System::Int8(0x7);
static _DELPHI_CONST System::Int8 opAnd = System::Int8(0x8);
static _DELPHI_CONST System::Int8 opOr = System::Int8(0x9);
static _DELPHI_CONST System::Int8 opXor = System::Int8(0xa);
static _DELPHI_CONST System::Int8 opCompare = System::Int8(0xb);
static _DELPHI_CONST System::Int8 opNegate = System::Int8(0xc);
static _DELPHI_CONST System::Int8 opNot = System::Int8(0xd);
static _DELPHI_CONST System::Int8 opCmpEQ = System::Int8(0xe);
static _DELPHI_CONST System::Int8 opCmpNE = System::Int8(0xf);
static _DELPHI_CONST System::Int8 opCmpLT = System::Int8(0x10);
static _DELPHI_CONST System::Int8 opCmpLE = System::Int8(0x11);
static _DELPHI_CONST System::Int8 opCmpGT = System::Int8(0x12);
static _DELPHI_CONST System::Int8 opCmpGE = System::Int8(0x13);
static _DELPHI_CONST TTypeKind tkAnsiChar = (TTypeKind)(2);
static _DELPHI_CONST TTypeKind tkWideChar = (TTypeKind)(9);
static _DELPHI_CONST TTypeKind tkUnicodeString = (TTypeKind)(18);
static _DELPHI_CONST TTypeKind tkAnsiString = (TTypeKind)(10);
static _DELPHI_CONST TTypeKind tkWideString = (TTypeKind)(11);
static _DELPHI_CONST TTypeKind tkShortString = (TTypeKind)(5);
#ifndef _WIN64
static _DELPHI_CONST System::Int8 NumSmallBlockTypes = System::Int8(0x37);
#else /* _WIN64 */
static _DELPHI_CONST System::Int8 NumSmallBlockTypes = System::Int8(0x2e);
#endif /* _WIN64 */
...
extern DELPHI_PACKAGE System::LongWord HPrevInst _DEPRECATED_ATTRIBUTE0 ;
...
extern DELPHI_PACKAGE void __fastcall (*VarToLStrProc)(System::AnsiString &Dest, const TVarData &Source, Word CodePage/* = (Word)(0x0)*/);
extern DELPHI_PACKAGE void __fastcall (*VarToWStrProc)(System::WideString &Dest, const TVarData &Source);
...
static _DELPHI_CONST System::Int8 CPUi386 = System::Int8(0x2);
static _DELPHI_CONST System::Int8 CPUi486 = System::Int8(0x3);
static _DELPHI_CONST System::Int8 CPUPentium = System::Int8(0x4);
extern DELPHI_PACKAGE System::StaticArray<TCPUIDRec, 8> CPUIDTable;
extern DELPHI_PACKAGE System::NativeInt ERMSBThreshold;
extern DELPHI_PACKAGE Word Default8087CW;
extern DELPHI_PACKAGE UInt32 DefaultMXCSR;
...
static _DELPHI_CONST Word fmClosed = Word(0xd7b0);
static _DELPHI_CONST Word fmInput = Word(0xd7b1);
static _DELPHI_CONST Word fmOutput = Word(0xd7b2);
static _DELPHI_CONST Word fmInOut = Word(0xd7b3);
static _DELPHI_CONST System::Int8 tfCRLF = System::Int8(0x1);
extern DELPHI_PACKAGE TRandom32Proc Random32Proc;
extern DELPHI_PACKAGE TRandomizeProc RandomizeProc;
static _DELPHI_CONST System::Int8 feeINEXACT = System::Int8(0x20);
static _DELPHI_CONST System::Int8 feeUNDERFLOW = System::Int8(0x10);
static _DELPHI_CONST System::Int8 feeOVERFLOW = System::Int8(0x8);
static _DELPHI_CONST System::Int8 feeDIVBYZERO = System::Int8(0x4);
static _DELPHI_CONST System::Int8 feeINVALID = System::Int8(0x1);
static _DELPHI_CONST System::Int8 feeALLEXCEPT = System::Int8(0x3f);
#ifdef _WIN64
static _DELPHI_CONST System::Word femINEXACT = System::Word(0x1000);
static _DELPHI_CONST System::Word femUNDERFLOW = System::Word(0x800);
static _DELPHI_CONST System::Word femOVERFLOW = System::Word(0x400);
static _DELPHI_CONST System::Word femDIVBYZERO = System::Word(0x200);
static _DELPHI_CONST Byte femINVALID = Byte(0x80);
static _DELPHI_CONST System::Word femALLEXCEPT = System::Word(0x1f80);
#endif /* _WIN64 */
static _DELPHI_CONST System::Int8 feeDENORMALOPERAND = System::Int8(0x2);
#ifndef _WIN64
static _DELPHI_CONST System::Int8 femINEXACT = System::Int8(0x20);
static _DELPHI_CONST System::Int8 femUNDERFLOW = System::Int8(0x10);
static _DELPHI_CONST System::Int8 femOVERFLOW = System::Int8(0x8);
static _DELPHI_CONST System::Int8 femDIVBYZERO = System::Int8(0x4);
static _DELPHI_CONST System::Int8 femINVALID = System::Int8(0x1);
static _DELPHI_CONST System::Int8 femALLEXCEPT = System::Int8(0x3f);
static _DELPHI_CONST System::Int8 femDENORMALOPERAND = System::Int8(0x2);
#else /* _WIN64 */
static _DELPHI_CONST System::Word femDENORMALOPERAND = System::Word(0x100);
#endif /* _WIN64 */
static _DELPHI_CONST System::Int8 ferTONEAREST = System::Int8(0x0);
#ifndef _WIN64
static _DELPHI_CONST System::Word ferUPWARD = System::Word(0x800);
static _DELPHI_CONST System::Word ferDOWNWARD = System::Word(0x400);
static _DELPHI_CONST System::Word ferTOWARDZERO = System::Word(0xc00);
static _DELPHI_CONST System::Word ferALLROUND = System::Word(0xc00);
#else /* _WIN64 */
static _DELPHI_CONST System::Word ferUPWARD = System::Word(0x4000);
static _DELPHI_CONST System::Word ferDOWNWARD = System::Word(0x2000);
static _DELPHI_CONST System::Word ferTOWARDZERO = System::Word(0x6000);
static _DELPHI_CONST System::Word ferALLROUND = System::Word(0x6000);
#endif /* _WIN64 */
extern DELPHI_PACKAGE PLibModule LibModuleList;
extern DELPHI_PACKAGE PModuleUnloadRec ModuleUnloadList;
...
extern DELPHI_PACKAGE int __fastcall Pos(const System::WideString SubStr, const System::WideString Str, int Offset = 0x1)/* overload */;
extern DELPHI_PACKAGE int __fastcall Pos(const RawByteString SubStr, const RawByteString Str, int Offset = 0x1)/* overload */;
extern DELPHI_PACKAGE void * __fastcall SysGetMem(System::NativeInt Size);
extern DELPHI_PACKAGE int __fastcall SysFreeMem(void * P);
extern DELPHI_PACKAGE void * __fastcall SysReallocMem(void * P, System::NativeInt Size);
extern DELPHI_PACKAGE void * __fastcall SysAllocMem(System::NativeInt Size);
...
extern DELPHI_PACKAGE UInt32 __fastcall DefaultRandom32(void);
...
extern DELPHI_PACKAGE UInt32 __fastcall FGetRound(void);
...
extern DELPHI_PACKAGE UInt32 __fastcall FGetExceptMask(UInt32 ExceptMasks = (unsigned)(0x3f));
#else /* _WIN64 */
extern DELPHI_PACKAGE UInt32 __fastcall FSetExceptMask(UInt32 NewMasks, UInt32 ExceptMasks = (unsigned)(0x1f80));
extern DELPHI_PACKAGE UInt32 __fastcall FGetExceptMask(UInt32 ExceptMasks = (unsigned)(0x1f80));
#endif /* _WIN64 */
...
extern DELPHI_PACKAGE void __fastcall SetMXCSRExceptionFlag(UInt32 NewExceptionFlag);
extern DELPHI_PACKAGE UInt32 __fastcall GetMXCSR(void);
#ifndef _WIN64
...
extern DELPHI_PACKAGE TCPUIDRec __fastcall GetCPUID(UInt32 FunctionID, UInt32 SubFunctionID = (unsigned)(0x0));
...
extern DELPHI_PACKAGE void __fastcall UniqueString(System::WideString &Str)/* overload */;
extern DELPHI_PACKAGE void __fastcall UniqueString(System::AnsiString &Str)/* overload */;
extern DELPHI_PACKAGE int __fastcall Pos(const System::ShortString &SubStr, const System::ShortString &Str, int Offset = 0x1)/* overload */;
extern DELPHI_PACKAGE UnicodeString __fastcall StringOfChar(WideChar Ch, int Count)/* overload */;
extern DELPHI_PACKAGE AnsiString __fastcall StringOfChar(System::AnsiChar Ch, int Count)/* overload */;
...
extern DELPHI_PACKAGE void __fastcall InitializeArray(void * p, void * typeInfo, System::NativeUInt elemCount);
extern DELPHI_PACKAGE void __fastcall MoveRecord(void * Dest, void * Source, void * TypeInfo);
extern DELPHI_PACKAGE void __fastcall MoveArray(void * Dest, void * Source, void * TypeInfo, System::NativeInt Count);
extern DELPHI_PACKAGE void __fastcall CopyArray(void * Dest, void * Source, void * TypeInfo, System::NativeInt Count);
...
extern DELPHI_PACKAGE void __fastcall InvokeRecordInitializerArray(void * Dest, void * TypeInfo, System::NativeUInt ElemCount);
...
extern DELPHI_PACKAGE void __fastcall WideCharLenToStrVar(WideChar * Source, int SourceLen, System::AnsiString &Dest)/* overload */;
...
extern DELPHI_PACKAGE void __fastcall OleStrToStrVar(WideChar * Source, System::AnsiString &Dest)/* overload */;
...
extern DELPHI_PACKAGE void __fastcall DynArrayCopyRange(void * &Result, void * A, void * TypeInfo, System::NativeInt Index, System::NativeInt Count);
extern DELPHI_PACKAGE void __fastcall DynArrayUnique(void * &A, void * typeInfo);
#ifdef _WIN64
extern DELPHI_PACKAGE void * __fastcall DynArrayIndex(void * P, const __int64 *Indices, const System::NativeInt Indices_High, void * TypInfo)/* overload */;
#endif /* _WIN64 */
...
extern DELPHI_PACKAGE System::NativeUInt __fastcall FindResourceHInstance(System::NativeUInt Instance);
...
extern DELPHI_PACKAGE System::NativeUInt __fastcall LoadResourceModule(WideChar * ModuleName, bool CheckOwner = true);
...
extern DELPHI_PACKAGE void * __cdecl GetMemory(System::NativeInt Size);
...
extern DELPHI_PACKAGE void __fastcall UTF8Encode(const UnicodeString US, Byte *B, const System::NativeInt B_High)/* overload */;
...
extern DELPHI_PACKAGE System::WideString __fastcall UTF8Decode _DEPRECATED_ATTRIBUTE1("Use UTF8ToWideString or UTF8ToString") (const RawByteString S);
extern DELPHI_PACKAGE System::WideString __fastcall UTF8ToWideString(const RawByteString S);
...
extern DELPHI_PACKAGE UnicodeString __fastcall UTF8ToUnicodeString(const System::ShortString &S)/* overload */;
extern DELPHI_PACKAGE UnicodeString __fastcall UTF8ToString(const RawByteString S)/* overload */;
extern DELPHI_PACKAGE UnicodeString __fastcall UTF8ToString(const System::ShortString &S)/* overload */;
extern DELPHI_PACKAGE UnicodeString __fastcall UTF8ToString(const char * S)/* overload */;
extern DELPHI_PACKAGE UnicodeString __fastcall UTF8ToString _DEPRECATED_ATTRIBUTE1("Use UTF8ArrayToString(const S: array of Byte)") (const Byte *S, const System::NativeInt S_High)/* overload */;
extern DELPHI_PACKAGE UnicodeString __fastcall UTF8ArrayToString(const char *S, const System::NativeInt S_High)/* overload */;
extern DELPHI_PACKAGE UnicodeString __fastcall UTF8ArrayToString(const Byte *S, const System::NativeInt S_High)/* overload */;
