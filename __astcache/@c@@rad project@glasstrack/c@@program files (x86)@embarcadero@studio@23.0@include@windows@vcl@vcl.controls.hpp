...
// (DO NOT EDIT: machine generated header) 'Vcl.Controls.pas' rev: 36.00 (Windows)
...
struct TCMRemoteSessionStatusChanged;
...
class DELPHICLASS TWinControlMessageHandler;
class DELPHICLASS TControlEnumerator;
...
class DELPHICLASS TDPIContextService;
//-- type declarations -------------------------------------------------------
...
typedef System::NativeInt TCustomLongData _DEPRECATED_ATTRIBUTE1("Use THelpEventData, TListBoxItemData or NativeInt") ;
...
#else /* _WIN64 */
_DECLARE_METACLASS(System::TMetaClass, TWinControlClass);
#endif /* _WIN64 */

#ifndef _WIN64
typedef System::TMetaClass* THintWindowClass;
#else /* _WIN64 */
_DECLARE_METACLASS(System::TMetaClass, THintWindowClass);
#endif /* _WIN64 */
...
struct DECLSPEC_DRECORD TCMRemoteSessionStatusChanged
{
public:
	unsigned Msg;
#ifndef _WIN64
	...
	Winapi::Messages::TDWordFiller MsgFiller;
#endif /* _WIN64 */
	System::LongBool InRemoteSession;
#ifndef _WIN64
...
public:
	...
	virtual Winapi::Windows::THandle __fastcall Instance();
...
#else /* _WIN64 */
	__property HWND DragHandle = {read=FDragHandle, write=FDragHandle};
#endif /* _WIN64 */
	__property System::Types::TPoint DragPos = {read=FDragPos, write=FDragPos};
	__property TDragTarget DragTarget = {read=FDragTarget, write=FDragTarget};
...
#else /* _WIN64 */
_DECLARE_METACLASS(System::TMetaClass, TDragObjectClass);
#endif /* _WIN64 */
...
#else /* _WIN64 */
_DECLARE_METACLASS(System::TMetaClass, TControlActionLinkClass);
#endif /* _WIN64 */

enum DECLSPEC_DENUM TControlStateItem : unsigned char { csLButtonDown, csClicked, csPalette, csReadingState, csAlignmentNeeded, csFocusing, csCreating, csPaintCopy, csCustomPaint, csDestroyingHandle, csDocking, csDesignerHide, csPanning, csRecreating, csAligning, csGlassPaint, csPrintClient, csReadingProps, csDPIIsolated };

typedef System::Set<TControlStateItem, TControlStateItem::csLButtonDown, TControlStateItem::csDPIIsolated> TControlState;

enum DECLSPEC_DENUM TControlStyleItem : unsigned char { csAcceptsControls, csCaptureMouse, csDesignInteractive, csClickEvents, csFramed, csSetCaption, csOpaque, csDoubleClicks, csFixedWidth, csFixedHeight, csNoDesignVisible, csReplicatable, csNoStdEvents, csDisplayDragImage, csReflector, csActionClient, csMenuEvents, csNeedsBorderPaint, csParentBackground, csPannable, csAlignWithMargins, csGestures, csPaintBlackOpaqueOnGlass, csOverrideStylePaint, csNeedsDesignDisabledState };

typedef System::Set<TControlStyleItem, TControlStyleItem::csAcceptsControls, TControlStyleItem::csNeedsDesignDisabledState> TControlStyle;
...
public:
	...
	unsigned __int64 Reserved;
#endif /* _WIN64 */
	PMouseActivateRec MouseActivateRec;
#ifndef _WIN64
	int Result;
#else /* _WIN64 */
	__int64 Result;
...
protected:
	...
	void __fastcall ScaleBy(int M, int D, bool AUpdate = false);
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EGestureException(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : System::Sysutils::Exception(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EGestureException(System::NativeUInt Ident)/* overload */ : System::Sysutils::Exception(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EGestureException(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EGestureException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EGestureException(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : System::Sysutils::Exception(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EGestureException(System::NativeUInt Ident, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EGestureException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EGestureException(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High, AHelpContext) { }
...
enum DECLSPEC_DENUM TStyleElement : unsigned char { seFont, seClient, seBorder };
...
private:
	static bool FRaiseOnNonMainThreadUsage;
	TWinControl* FParent;
	...
	TWinControl* FRootControl;
	float FScaleFactorRoot;
	...
	void __fastcall UpdateRootControl();
	...
	MESSAGE void __fastcall WMRButtonDown(Winapi::Messages::TWMRButtonDown &Message);
	MESSAGE void __fastcall WMMButtonDown(Winapi::Messages::TWMMButtonDown &Message);
	MESSAGE void __fastcall WMLButtonDblClk(Winapi::Messages::TWMLButtonDblClk &Message);
	MESSAGE void __fastcall WMRButtonDblClk(Winapi::Messages::TWMRButtonDblClk &Message);
	MESSAGE void __fastcall WMMButtonDblClk(Winapi::Messages::TWMMButtonDblClk &Message);
	...
	MESSAGE void __fastcall WMRButtonUp(Winapi::Messages::TWMRButtonUp &Message);
	MESSAGE void __fastcall WMMButtonUp(Winapi::Messages::TWMMButtonUp &Message);
	MESSAGE void __fastcall WMMouseWheel(Winapi::Messages::TWMMouseWheel &Message);
	MESSAGE void __fastcall WMCancelMode(Winapi::Messages::TWMCancelMode &Message);
	MESSAGE void __fastcall WMWindowPosChanged(Winapi::Messages::TWMWindowPosChanged &Message);
	...
	MESSAGE void __fastcall CMHitTest(TCMHitTest &Message);
	...
	MESSAGE void __fastcall CMDesignHitTest(TCMDesignHitTest &Message);
	...
	MESSAGE void __fastcall CMStyleElementsChanged(Winapi::Messages::TMessage &Message);
...
protected:
	...
	virtual int __fastcall GetDPIForDesigner();
	...
	virtual void __fastcall DoStyleElementsChanged();
	...
	virtual TStyleElements __fastcall GetStyleElements();
...
public:
	...
	void __fastcall CheckNonMainThreadUsage();
...
#else /* _WIN64 */
	__int64 __fastcall Perform(unsigned Msg, unsigned __int64 WParam, __int64 LParam)/* overload */;
#endif /* _WIN64 */
...
#else /* _WIN64 */
	__int64 __fastcall Perform(unsigned Msg, unsigned __int64 WParam, System::WideChar * LParam)/* overload */;
	__int64 __fastcall Perform(unsigned Msg, unsigned __int64 WParam, System::Types::TRect &LParam)/* overload */;
#endif /* _WIN64 */
	...
	TStyleElements __fastcall GetInternalStyleElements();
	...
	__property TStyleElements StyleElements = {read=GetStyleElements, write=SetStyleElements, default=7};
	...
	/* static */ __property bool RaiseOnNonMainThreadUsage = {read=FRaiseOnNonMainThreadUsage, write=FRaiseOnNonMainThreadUsage, default=0};
...
#else /* _WIN64 */
_DECLARE_METACLASS(System::TMetaClass, TWinControlActionLinkClass);
#endif /* _WIN64 */
...
#pragma pack(push,4)
#endif /* not _WIN64 */
class PASCALIMPLEMENTATION TWinControlMessageHandler : public System::TObject
{
	typedef System::TObject inherited;
	
private:
	TWinControl* FControl;
	bool FDefaultWinProcCalling;
	HWND __fastcall GetHandle();
	
protected:
	void __fastcall DefaultWinProc(Winapi::Messages::TMessage &Message);
	virtual bool __fastcall HandleMessage(Winapi::Messages::TMessage &Message);
	__property bool IsDefaultWinProcCalling = {read=FDefaultWinProcCalling, nodefault};
	
public:
	__fastcall virtual TWinControlMessageHandler(TWinControl* AControl);
...
#endif /* _WIN64 */
public:
	/* TObject.Destroy */ inline __fastcall virtual ~TWinControlMessageHandler() { }
...
#ifndef _WIN64
typedef System::TMetaClass* TWinControlMessageHandlerClass;
#else /* _WIN64 */
_DECLARE_METACLASS(System::TMetaClass, TWinControlMessageHandlerClass);
#endif /* _WIN64 */

enum DECLSPEC_DENUM TControlEnumeratorFilterType : unsigned char { ceftAll, ceftEnabled, ceftDisabled, ceftVisible, ceftInvisible, ceftCustom };

typedef System::Set<TControlEnumeratorFilterType, TControlEnumeratorFilterType::ceftAll, TControlEnumeratorFilterType::ceftCustom> TControlEnumeratorFilter;
...
#pragma pack(push,4)
#endif /* not _WIN64 */
class PASCALIMPLEMENTATION TControlEnumerator : public System::TObject
{
	typedef System::TObject inherited;
...
protected:
	void __fastcall EnumControls(TWinControl* AControl, TControlEnumeratorFilter AFilter);
	
public:
	__fastcall TControlEnumerator(TWinControl* AControl, TControlEnumeratorFilter AFilter);
	__fastcall virtual ~TControlEnumerator();
	TControlEnumerator* __fastcall GetEnumerator();
	bool __fastcall MoveNext();
	TControl* __fastcall GetCurrent();
...
enum DECLSPEC_DENUM TDoubleBufferedMode : unsigned char { dbmDefault, dbmRequested };
...
private:
	...
	unsigned FDrawLockCount;
	TWinControlMessageHandler* FMessageHandler;
	TEnumerateControlEvent FOnEnumerateControl;
	...
	void __fastcall SetDoubleBufferedMode(TDoubleBufferedMode Value);
	void __fastcall SetDPIScaling(bool Value);
	...
	bool __fastcall GetIsDrawingLocked();
	bool __fastcall GetRedrawDisabled();
	...
	MESSAGE void __fastcall WMSysColorChange(Winapi::Messages::TWMSysColorChange &Message);
	MESSAGE void __fastcall WMHScroll(Winapi::Messages::TWMHScroll &Message);
	MESSAGE void __fastcall WMVScroll(Winapi::Messages::TWMVScroll &Message);
	...
	MESSAGE void __fastcall WMWindowPosChanging(Winapi::Messages::TWMWindowPosChanging &Message);
	...
	MESSAGE void __fastcall WMKeyDown(Winapi::Messages::TWMKeyDown &Message);
	MESSAGE void __fastcall WMSysKeyDown(Winapi::Messages::TWMSysKeyDown &Message);
	MESSAGE void __fastcall WMKeyUp(Winapi::Messages::TWMKeyUp &Message);
	MESSAGE void __fastcall WMSysKeyUp(Winapi::Messages::TWMSysKeyUp &Message);
	MESSAGE void __fastcall WMChar(Winapi::Messages::TWMChar &Message);
	...
	MESSAGE void __fastcall WMVKeyToItem(Winapi::Messages::TWMVKeyToItem &Message);
	...
	MESSAGE void __fastcall WMNCDestroy(Winapi::Messages::TWMNCDestroy &Message);
	...
	MESSAGE void __fastcall CMDialogKey(TCMDialogKey &Message);
	...
	HIDESBASE MESSAGE void __fastcall CMDesignHitTest(TCMDesignHitTest &Message);
	...
	MESSAGE void __fastcall CNKeyDown(Winapi::Messages::TWMKeyDown &Message);
	MESSAGE void __fastcall CNKeyUp(Winapi::Messages::TWMKeyUp &Message);
	MESSAGE void __fastcall CNChar(Winapi::Messages::TWMChar &Message);
	MESSAGE void __fastcall CNSysKeyDown(Winapi::Messages::TWMKeyDown &Message);
	MESSAGE void __fastcall CNSysChar(Winapi::Messages::TWMChar &Message);
	MESSAGE void __fastcall CMRecreateWnd(Winapi::Messages::TMessage &Message);
	MESSAGE void __fastcall CMSysCommand(Winapi::Messages::TWMKeyDown &Message);
	...
	MESSAGE void __fastcall WMPrintClient(Winapi::Messages::TWMPrintClient &Message);
...
protected:
	...
	TDoubleBufferedMode FDoubleBufferedMode;
	...
	void __fastcall CreateMessageHandler(TWinControlMessageHandlerClass AMessageHandlerClass);
	...
	virtual bool __fastcall DoWritePixelsPerInch(System::Classes::TFiler* Filer);
	...
	virtual int __fastcall GetPixelsPerInch();
	...
	void __fastcall RequestDPIScaling()/* overload */;
	void __fastcall RequestDPIScaling(bool Value)/* overload */;
	...
	__property TWinControlMessageHandler* MessageHandler = {read=FMessageHandler};
...
public:
	...
	virtual void __fastcall DefaultHandler(void *Message);
	virtual void __fastcall InitMessageHandler(TWinControlMessageHandlerClass AMessageHandlerClass);
	void __fastcall ReleaseMessageHandler();
	...
	__property TDoubleBufferedMode DoubleBufferedMode = {read=FDoubleBufferedMode, write=SetDoubleBufferedMode, default=0};
	...
	virtual bool __fastcall CanEnumerateControl(TControl* AControl);
	...
	__property TEnumerateControlEvent OnEnumerateControl = {read=FOnEnumerateControl, write=FOnEnumerateControl};
	/* Hoisted overloads: */
...
public:
	...
	virtual void __fastcall ActivateHintData(const System::Types::TRect &Rect, const System::UnicodeString AHint, TCustomData AData);
	virtual System::Types::TRect __fastcall CalcHintRect(int MaxWidth, const System::UnicodeString AHint, TCustomData AData);
	__property BiDiMode;
	__property Caption = {default=0};
...
#else /* _WIN64 */
_DECLARE_METACLASS(System::TMetaClass, TDockTreeClass);
#endif /* _WIN64 */
...
#else /* _WIN64 */
_DECLARE_METACLASS(System::TMetaClass, TPanningWindowClass);
#endif /* _WIN64 */
...
__published:
	...
	virtual bool __fastcall StartPanning(Winapi::Windows::THandle AHandle, TControl* AControl) = 0 ;
...
enum DECLSPEC_DENUM TWheelRouting : unsigned char { wrFocusedWindow, wrHybrid, wrMousePos };
...
#else /* _WIN64 */
	__property HWND Capture = {read=GetCapture, write=SetCapture};
#endif /* _WIN64 */
...
protected:
	...
	virtual void __fastcall InternalPositionAt(const System::Types::TRect &Rect, bool AAdjustCursor);
...
protected:
	...
	virtual void __fastcall Notification(System::Classes::TComponent* AComponent, System::Classes::TOperation Operation);
	virtual THintPosition __fastcall GetHintPosition(const System::Types::TRect &ARect);
...
__published:
	...
	__property THintPosition Position = {read=FPosition, write=FPosition, default=2};
};
...
#pragma pack(push,4)
#endif /* not _WIN64 */
class PASCALIMPLEMENTATION TDPIContextService : public System::TObject
{
	typedef System::TObject inherited;
	
public:
	__classmethod bool __fastcall IsControlDPIIsolated(TWinControl* AControl);
	...
	__classmethod bool __fastcall GetClientRect(HWND hWnd, System::Types::TRect &lpRect)/* overload */;
	__classmethod bool __fastcall GetClientRect(TWinControl* AControl, System::Types::TRect &lpRect)/* overload */;
	...
	__classmethod bool __fastcall GetWindowPlacement(HWND hWnd, Winapi::Windows::TWindowPlacement &WindowPlacement)/* overload */;
	__classmethod bool __fastcall GetWindowPlacement(TWinControl* AControl, Winapi::Windows::TWindowPlacement &WindowPlacement)/* overload */;
	__classmethod bool __fastcall SetWindowPlacement(HWND hWnd, const Winapi::Windows::TWindowPlacement &WindowPlacement);
	__classmethod bool __fastcall SetWindowPos(HWND hWnd, HWND hWndInsertAfter, int X, int Y, int cx, int cy, unsigned uFlags);
	__classmethod bool __fastcall ClientToScreen(HWND hWnd, System::Types::TPoint &lpPoint);
	__classmethod bool __fastcall ScreenToClient(HWND hWnd, System::Types::TPoint &lpPoint);
public:
	/* TObject.Create */ inline __fastcall TDPIContextService() : System::TObject() { }
	/* TObject.Destroy */ inline __fastcall virtual ~TDPIContextService() { }
...
//-- var, const, procedure ---------------------------------------------------
static _DELPHI_CONST System::Word CM_BASE = System::Word(0xb000);
static _DELPHI_CONST System::Int8 CM_CLROFFSET = System::Int8(0x0);
static _DELPHI_CONST System::Word CM_ACTIVATE = System::Word(0xb000);
static _DELPHI_CONST System::Word CM_DEACTIVATE = System::Word(0xb001);
static _DELPHI_CONST System::Word CM_GOTFOCUS = System::Word(0xb002);
static _DELPHI_CONST System::Word CM_LOSTFOCUS = System::Word(0xb003);
static _DELPHI_CONST System::Word CM_CANCELMODE = System::Word(0xb004);
static _DELPHI_CONST System::Word CM_DIALOGKEY = System::Word(0xb005);
static _DELPHI_CONST System::Word CM_DIALOGCHAR = System::Word(0xb006);
static _DELPHI_CONST System::Word CM_FOCUSCHANGED = System::Word(0xb007);
static _DELPHI_CONST System::Word CM_PARENTFONTCHANGED = System::Word(0xb008);
static _DELPHI_CONST System::Word CM_PARENTCOLORCHANGED = System::Word(0xb009);
static _DELPHI_CONST System::Word CM_HITTEST = System::Word(0xb00a);
static _DELPHI_CONST System::Word CM_VISIBLECHANGED = System::Word(0xb00b);
static _DELPHI_CONST System::Word CM_ENABLEDCHANGED = System::Word(0xb00c);
static _DELPHI_CONST System::Word CM_COLORCHANGED = System::Word(0xb00d);
static _DELPHI_CONST System::Word CM_FONTCHANGED = System::Word(0xb00e);
static _DELPHI_CONST System::Word CM_CURSORCHANGED = System::Word(0xb00f);
static _DELPHI_CONST System::Word CM_CTL3DCHANGED = System::Word(0xb010);
static _DELPHI_CONST System::Word CM_PARENTCTL3DCHANGED = System::Word(0xb011);
static _DELPHI_CONST System::Word CM_TEXTCHANGED = System::Word(0xb012);
static _DELPHI_CONST System::Word CM_MOUSEENTER = System::Word(0xb013);
static _DELPHI_CONST System::Word CM_MOUSELEAVE = System::Word(0xb014);
static _DELPHI_CONST System::Word CM_MENUCHANGED = System::Word(0xb015);
static _DELPHI_CONST System::Word CM_APPKEYDOWN = System::Word(0xb016);
static _DELPHI_CONST System::Word CM_APPSYSCOMMAND = System::Word(0xb017);
static _DELPHI_CONST System::Word CM_BUTTONPRESSED = System::Word(0xb018);
static _DELPHI_CONST System::Word CM_SHOWINGCHANGED = System::Word(0xb019);
static _DELPHI_CONST System::Word CM_ENTER = System::Word(0xb01a);
static _DELPHI_CONST System::Word CM_EXIT = System::Word(0xb01b);
static _DELPHI_CONST System::Word CM_DESIGNHITTEST = System::Word(0xb01c);
static _DELPHI_CONST System::Word CM_ICONCHANGED = System::Word(0xb01d);
static _DELPHI_CONST System::Word CM_WANTSPECIALKEY = System::Word(0xb01e);
static _DELPHI_CONST System::Word CM_INVOKEHELP = System::Word(0xb01f);
static _DELPHI_CONST System::Word CM_WINDOWHOOK = System::Word(0xb020);
static _DELPHI_CONST System::Word CM_RELEASE = System::Word(0xb021);
static _DELPHI_CONST System::Word CM_SHOWHINTCHANGED = System::Word(0xb022);
static _DELPHI_CONST System::Word CM_PARENTSHOWHINTCHANGED = System::Word(0xb023);
static _DELPHI_CONST System::Word CM_SYSCOLORCHANGE = System::Word(0xb024);
static _DELPHI_CONST System::Word CM_WININICHANGE = System::Word(0xb025);
static _DELPHI_CONST System::Word CM_FONTCHANGE = System::Word(0xb026);
static _DELPHI_CONST System::Word CM_TIMECHANGE = System::Word(0xb027);
static _DELPHI_CONST System::Word CM_TABSTOPCHANGED = System::Word(0xb028);
static _DELPHI_CONST System::Word CM_UIACTIVATE = System::Word(0xb029);
static _DELPHI_CONST System::Word CM_UIDEACTIVATE = System::Word(0xb02a);
static _DELPHI_CONST System::Word CM_DOCWINDOWACTIVATE = System::Word(0xb02b);
static _DELPHI_CONST System::Word CM_CONTROLLISTCHANGE = System::Word(0xb02c);
static _DELPHI_CONST System::Word CM_GETDATALINK = System::Word(0xb02d);
static _DELPHI_CONST System::Word CM_CHILDKEY = System::Word(0xb02e);
static _DELPHI_CONST System::Word CM_DRAG = System::Word(0xb02f);
static _DELPHI_CONST System::Word CM_HINTSHOW = System::Word(0xb030);
static _DELPHI_CONST System::Word CM_DIALOGHANDLE = System::Word(0xb031);
static _DELPHI_CONST System::Word CM_ISTOOLCONTROL = System::Word(0xb032);
static _DELPHI_CONST System::Word CM_RECREATEWND = System::Word(0xb033);
static _DELPHI_CONST System::Word CM_INVALIDATE = System::Word(0xb034);
static _DELPHI_CONST System::Word CM_SYSFONTCHANGED = System::Word(0xb035);
static _DELPHI_CONST System::Word CM_CONTROLCHANGE = System::Word(0xb036);
static _DELPHI_CONST System::Word CM_CHANGED = System::Word(0xb037);
static _DELPHI_CONST System::Word CM_DOCKCLIENT = System::Word(0xb038);
static _DELPHI_CONST System::Word CM_UNDOCKCLIENT = System::Word(0xb039);
static _DELPHI_CONST System::Word CM_FLOAT = System::Word(0xb03a);
static _DELPHI_CONST System::Word CM_BORDERCHANGED = System::Word(0xb03b);
static _DELPHI_CONST System::Word CM_BIDIMODECHANGED = System::Word(0xb03c);
static _DELPHI_CONST System::Word CM_PARENTBIDIMODECHANGED = System::Word(0xb03d);
static _DELPHI_CONST System::Word CM_ALLCHILDRENFLIPPED = System::Word(0xb03e);
static _DELPHI_CONST System::Word CM_ACTIONUPDATE = System::Word(0xb03f);
static _DELPHI_CONST System::Word CM_ACTIONEXECUTE = System::Word(0xb040);
static _DELPHI_CONST System::Word CM_HINTSHOWPAUSE = System::Word(0xb041);
static _DELPHI_CONST System::Word CM_DOCKNOTIFICATION = System::Word(0xb042);
static _DELPHI_CONST System::Word CM_MOUSEWHEEL = System::Word(0xb043);
static _DELPHI_CONST System::Word CM_ISSHORTCUT = System::Word(0xb044);
static _DELPHI_CONST System::Word CM_UPDATEACTIONS = System::Word(0xb045);
static _DELPHI_CONST System::Word CM_INVALIDATEDOCKHOST = System::Word(0xb046);
static _DELPHI_CONST System::Word CM_SETACTIVECONTROL = System::Word(0xb047);
static _DELPHI_CONST System::Word CM_POPUPHWNDDESTROY = System::Word(0xb048);
static _DELPHI_CONST System::Word CM_CREATEPOPUP = System::Word(0xb049);
static _DELPHI_CONST System::Word CM_DESTROYHANDLE = System::Word(0xb04a);
static _DELPHI_CONST System::Word CM_MOUSEACTIVATE = System::Word(0xb04b);
static _DELPHI_CONST System::Word CM_CONTROLLISTCHANGING = System::Word(0xb04c);
static _DELPHI_CONST System::Word CM_BUFFEREDPRINTCLIENT = System::Word(0xb04d);
static _DELPHI_CONST System::Word CM_UNTHEMECONTROL = System::Word(0xb04e);
static _DELPHI_CONST System::Word CM_DOUBLEBUFFEREDCHANGED = System::Word(0xb04f);
static _DELPHI_CONST System::Word CM_PARENTDOUBLEBUFFEREDCHANGED = System::Word(0xb050);
static _DELPHI_CONST System::Word CM_STYLECHANGED = System::Word(0xb051);
static _DELPHI_CONST System::Word CM_THEMECHANGED _DEPRECATED_ATTRIBUTE1("Use CM_STYLECHANGED")  = System::Word(0xb051);
static _DELPHI_CONST System::Word CM_GESTURE = System::Word(0xb052);
static _DELPHI_CONST System::Word CM_CUSTOMGESTURESCHANGED = System::Word(0xb053);
static _DELPHI_CONST System::Word CM_GESTUREMANAGERCHANGED = System::Word(0xb054);
static _DELPHI_CONST System::Word CM_STANDARDGESTURESCHANGED = System::Word(0xb055);
static _DELPHI_CONST System::Word CM_INPUTLANGCHANGE = System::Word(0xb056);
static _DELPHI_CONST System::Word CM_TABLETOPTIONSCHANGED = System::Word(0xb057);
static _DELPHI_CONST System::Word CM_PARENTTABLETOPTIONSCHANGED = System::Word(0xb058);
static _DELPHI_CONST System::Word CM_CUSTOMSTYLECHANGED = System::Word(0xb059);
static _DELPHI_CONST System::Word CM_SYSFONTSALLCHANGED = System::Word(0xb05a);
static _DELPHI_CONST System::Word CM_PARENTVISIBLECHANGED = System::Word(0xb05b);
static _DELPHI_CONST System::Word CM_SYSCOMMAND = System::Word(0xb05c);
static _DELPHI_CONST System::Word CM_REMOTESESSIONSTATUSCHANGED = System::Word(0xb05d);
static _DELPHI_CONST System::Word CM_STYLEELEMENTSCHANGED = System::Word(0xb05e);
static _DELPHI_CONST System::Word CN_BASE = System::Word(0xbc00);
static _DELPHI_CONST System::Word CN_CHARTOITEM = System::Word(0xbc2f);
static _DELPHI_CONST System::Word CN_COMMAND = System::Word(0xbd11);
static _DELPHI_CONST System::Word CN_COMPAREITEM = System::Word(0xbc39);
static _DELPHI_CONST System::Word CN_CTLCOLORBTN = System::Word(0xbd35);
static _DELPHI_CONST System::Word CN_CTLCOLORDLG = System::Word(0xbd36);
static _DELPHI_CONST System::Word CN_CTLCOLOREDIT = System::Word(0xbd33);
static _DELPHI_CONST System::Word CN_CTLCOLORLISTBOX = System::Word(0xbd34);
static _DELPHI_CONST System::Word CN_CTLCOLORMSGBOX = System::Word(0xbd32);
static _DELPHI_CONST System::Word CN_CTLCOLORSCROLLBAR = System::Word(0xbd37);
static _DELPHI_CONST System::Word CN_CTLCOLORSTATIC = System::Word(0xbd38);
static _DELPHI_CONST System::Word CN_DELETEITEM = System::Word(0xbc2d);
static _DELPHI_CONST System::Word CN_DRAWITEM = System::Word(0xbc2b);
static _DELPHI_CONST System::Word CN_HSCROLL = System::Word(0xbd14);
static _DELPHI_CONST System::Word CN_MEASUREITEM = System::Word(0xbc2c);
static _DELPHI_CONST System::Word CN_PARENTNOTIFY = System::Word(0xbe10);
static _DELPHI_CONST System::Word CN_VKEYTOITEM = System::Word(0xbc2e);
static _DELPHI_CONST System::Word CN_VSCROLL = System::Word(0xbd15);
static _DELPHI_CONST System::Word CN_KEYDOWN = System::Word(0xbd00);
static _DELPHI_CONST System::Word CN_KEYUP = System::Word(0xbd01);
static _DELPHI_CONST System::Word CN_CHAR = System::Word(0xbd02);
static _DELPHI_CONST System::Word CN_SYSKEYDOWN = System::Word(0xbd04);
static _DELPHI_CONST System::Word CN_SYSCHAR = System::Word(0xbd06);
static _DELPHI_CONST System::Word CN_NOTIFY = System::Word(0xbc4e);
static _DELPHI_CONST System::Uitypes::TAnchorKind akLeft = (System::Uitypes::TAnchorKind)(0);
static _DELPHI_CONST System::Uitypes::TAnchorKind akTop = (System::Uitypes::TAnchorKind)(1);
static _DELPHI_CONST System::Uitypes::TAnchorKind akRight = (System::Uitypes::TAnchorKind)(2);
static _DELPHI_CONST System::Uitypes::TAnchorKind akBottom = (System::Uitypes::TAnchorKind)(3);
...
static _DELPHI_CONST System::Int8 gcnRefreshAll = System::Int8(0x0);
static _DELPHI_CONST System::Int8 gcnAdded = System::Int8(0x1);
static _DELPHI_CONST System::Int8 gcnRemoved = System::Int8(0x2);
static _DELPHI_CONST System::Int8 gcnModified = System::Int8(0x3);
static _DELPHI_CONST System::Uitypes::TDragMode dmAutomatic = (System::Uitypes::TDragMode)(1);
static _DELPHI_CONST System::Uitypes::TDragMode dmManual = (System::Uitypes::TDragMode)(0);
static _DELPHI_CONST System::Uitypes::TDragState dsDragEnter = (System::Uitypes::TDragState)(0);
static _DELPHI_CONST System::Uitypes::TDragState dsDragLeave = (System::Uitypes::TDragState)(1);
static _DELPHI_CONST System::Uitypes::TDragState dsDragMove = (System::Uitypes::TDragState)(2);
static _DELPHI_CONST System::Uitypes::TDragKind dkDrag = (System::Uitypes::TDragKind)(0);
static _DELPHI_CONST System::Uitypes::TDragKind dkDock = (System::Uitypes::TDragKind)(1);
static _DELPHI_CONST System::Uitypes::TMouseActivate maDefault = (System::Uitypes::TMouseActivate)(0);
static _DELPHI_CONST System::Uitypes::TMouseActivate maActivate = (System::Uitypes::TMouseActivate)(1);
static _DELPHI_CONST System::Uitypes::TMouseActivate maActivateAndEat = (System::Uitypes::TMouseActivate)(2);
static _DELPHI_CONST System::Uitypes::TMouseActivate maNoActivate = (System::Uitypes::TMouseActivate)(3);
static _DELPHI_CONST System::Uitypes::TMouseActivate maNoActivateAndEat = (System::Uitypes::TMouseActivate)(4);
static _DELPHI_CONST System::Uitypes::TMouseButton mbLeft = (System::Uitypes::TMouseButton)(0);
static _DELPHI_CONST System::Uitypes::TMouseButton mbRight = (System::Uitypes::TMouseButton)(1);
static _DELPHI_CONST System::Uitypes::TMouseButton mbMiddle = (System::Uitypes::TMouseButton)(2);
static _DELPHI_CONST System::Int8 cImageMargin = System::Int8(0x4);
static _DELPHI_CONST System::Int8 cTextVerticalMargin = System::Int8(0x4);
static _DELPHI_CONST System::Int8 cTextHorizontalMargin = System::Int8(0x4);
static _DELPHI_CONST System::Int8 cBalloonStemHeight = System::Int8(0xa);
static _DELPHI_CONST System::Int8 cEdgeRadius = System::Int8(0x4);
...
static _DELPHI_CONST System::Word CTL3D_ALL = System::Word(0xffff);
#ifndef _WIN64
#define NullDockSite (TWinControl*)(0xffffffff)
#else /* _WIN64 */
#define NullDockSite (TWinControl*)(0x00000000ffffffffULL)
#endif /* _WIN64 */
...
extern DELPHI_PACKAGE void __fastcall InvalidControlOperation(System::PResStringRec AMessage, TControl* AControl);
...
#else /* _WIN64 */
extern DELPHI_PACKAGE __int64 __stdcall InitWndProc(HWND HWindow, unsigned Msg, unsigned __int64 WParam, __int64 LParam);
#endif /* _WIN64 */
...
#ifndef _WIN64
extern DELPHI_PACKAGE int __fastcall SendAppMessage(unsigned Msg, unsigned WParam, int LParam);
#else /* _WIN64 */
extern DELPHI_PACKAGE __int64 __fastcall SendAppMessage(unsigned Msg, unsigned __int64 WParam, __int64 LParam);
#endif /* _WIN64 */
...
extern DELPHI_PACKAGE bool __fastcall CursorToIdent(System::LongInt Cursor, System::UnicodeString &Ident);
...
extern DELPHI_PACKAGE bool __fastcall Imm32SetCompositionFont _DEPRECATED_ATTRIBUTE0 (int hImc, Winapi::Windows::PLogFont lpLogfont)/* overload */;
