...
// (DO NOT EDIT: machine generated header) 'System.Win.TaskbarCore.pas' rev: 36.00 (Windows)
...
public:
	...
	__property Winapi::Windows::TRect Bounds = {read=FBounds};
...
//-- var, const, procedure ---------------------------------------------------
static _DELPHI_CONST System::Int8 MAX_BUTTON_COUNT = System::Int8(0x7);
}	/* namespace Taskbarcore */
}	/* namespace Win */
}	/* namespace System */
