...
// (DO NOT EDIT: machine generated header) 'Vcl.ToolWin.pas' rev: 36.00 (Windows)
...
public:
	...
	/* TCustomForm.CreateScaledNew */ inline __fastcall virtual TToolDockForm(System::Classes::TComponent* AOwner, int ADPI, int Dummy) : Vcl::Forms::TCustomDockForm(AOwner, ADPI, Dummy) { }
