...
// (DO NOT EDIT: machine generated header) 'System.StrUtils.pas' rev: 36.00 (Windows)
...
extern DELPHI_PACKAGE bool __fastcall MatchText(const System::UnicodeString AText, const System::UnicodeString *AValues, const System::NativeInt AValues_High)/* overload */;
extern DELPHI_PACKAGE bool __fastcall AnsiMatchText(const System::UnicodeString AText, const System::UnicodeString *AValues, const System::NativeInt AValues_High)/* overload */;
extern DELPHI_PACKAGE int __fastcall IndexText(const System::UnicodeString AText, const System::UnicodeString *AValues, const System::NativeInt AValues_High)/* overload */;
...
extern DELPHI_PACKAGE bool __fastcall AnsiMatchStr(const System::UnicodeString AText, const System::UnicodeString *AValues, const System::NativeInt AValues_High)/* overload */;
extern DELPHI_PACKAGE int __fastcall IndexStr(const System::UnicodeString AText, const System::UnicodeString *AValues, const System::NativeInt AValues_High)/* overload */;
extern DELPHI_PACKAGE int __fastcall AnsiIndexStr(const System::UnicodeString AText, const System::UnicodeString *AValues, const System::NativeInt AValues_High)/* overload */;
...
extern DELPHI_PACKAGE System::UnicodeString __fastcall RandomFrom(const System::UnicodeString *AValues, const System::NativeInt AValues_High)/* overload */;
