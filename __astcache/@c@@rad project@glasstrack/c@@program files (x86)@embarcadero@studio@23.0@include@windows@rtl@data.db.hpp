...
// (DO NOT EDIT: machine generated header) 'Data.DB.pas' rev: 36.00 (Windows)
...
__interface DELPHIINTERFACE IBatchDataSet;
typedef System::DelphiInterface<IBatchDataSet> _di_IBatchDataSet;
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EDatabaseError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : System::Sysutils::Exception(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EDatabaseError(System::NativeUInt Ident)/* overload */ : System::Sysutils::Exception(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EDatabaseError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EDatabaseError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EDatabaseError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : System::Sysutils::Exception(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EDatabaseError(System::NativeUInt Ident, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EDatabaseError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EDatabaseError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High, AHelpContext) { }
...
public:
	/* Exception.CreateFmt */ inline __fastcall EUpdateError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : EDatabaseError(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EUpdateError(System::NativeUInt Ident)/* overload */ : EDatabaseError(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EUpdateError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : EDatabaseError(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EUpdateError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : EDatabaseError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EUpdateError(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : EDatabaseError(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EUpdateError(System::NativeUInt Ident, int AHelpContext)/* overload */ : EDatabaseError(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EUpdateError(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : EDatabaseError(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EUpdateError(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : EDatabaseError(Ident, Args, Args_High, AHelpContext) { }
...
enum DECLSPEC_DENUM TUpdateRecordType : unsigned char { rtModified, rtInserted, rtDeleted, rtUnmodified };
...
__interface  INTERFACE_UUID("{294572F6-8B5E-483F-87FC-676299A04DC1}") IBatchDataSet  : public System::IInterface 
{
	virtual void __fastcall BeginBatch(bool ARegular) = 0 ;
	virtual void __fastcall EndBatch() = 0 ;
};
...
public:
	...
	bool __fastcall GetData(TValueBuffer &Buffer, bool NativeFormat = true)/* overload */;
	...
	void __fastcall SetData(TValueBuffer Buffer, bool NativeFormat = true)/* overload */;
...
private:
	Largeint FMinValue;
	Largeint FMaxValue;
	void __fastcall CheckRange(Largeint Value, Largeint Min, Largeint Max);
...
public:
	...
	__property TAggHandle* Handle = {read=FHandle, write=FHandle};
...
private:
	...
	void __fastcall DataEvent(TDataEvent Event, System::NativeInt Info);
	void __fastcall NotifyDataLinks(TDataEvent Event, System::NativeInt Info);
	void __fastcall NotifyLinkTypes(TDataEvent Event, System::NativeInt Info, bool LinkType);
...
private:
	...
	void __fastcall GetStreamData(TValueBuffer Buffer)/* overload */;
...
protected:
	...
	Largeint __fastcall GetAsLargeInt();
	...
	void __fastcall SetAsBlob(const TBlobData Value);
	...
	void __fastcall SetAsLargeInt(const Largeint Value);
...
public:
	...
	void __fastcall Clear();
	void __fastcall GetData(TValueBuffer Buffer)/* overload */;
...
__interface  INTERFACE_UUID("{6C501EAF-4C52-4B7C-8040-5EE085009667}") IProviderSupportNG  : public System::IInterface 
{
	...
	virtual void __fastcall PSGetAttributes(TPacketAttributeList* List) = 0 ;
...
enum DECLSPEC_DENUM TDataSetCommandState : unsigned char { dcSupported, dcEnabled };
...
__interface  INTERFACE_UUID("{285C0B2D-C123-444A-9FD3-9C6D1DE3762B}") IDataSetCommandSupport  : public System::IInterface 
{
	...
	virtual void __fastcall ExecuteCommand(const System::UnicodeString ACommand, const System::TVarRec *Args, const System::NativeInt Args_High) = 0 ;
};
...
private:
	...
	TBlobDisplayValue FBlobDisplayValue;
	void __fastcall SetAutoCreateMode(const TFieldsAutoCreationMode Value);
	void __fastcall SetBlobDisplayValue(const TBlobDisplayValue Value);
...
__published:
	...
	__property TBlobDisplayValue BlobDisplayValue = {read=FBlobDisplayValue, write=SetBlobDisplayValue, default=0};
public:
...
typedef System::NativeInt TRecBuf;

#ifndef _WIN64
typedef System::DynamicArray<int> TBufList;
#else /* _WIN64 */
typedef System::DynamicArray<__int64> TBufList;
#endif /* _WIN64 */
...
enum DECLSPEC_DENUM TResyncModeItem : unsigned char { rmExact, rmCenter };
...
private:
	...
	int FIOBufferSize;
	TValueBuffer FIOSharedBuffer;
	TValueBuffer FIOTempBuffer;
	...
	void __fastcall AddRecord(const System::TVarRec *Values, const System::NativeInt Values_High, bool Append);
	...
	TRecBuf __fastcall GetBuffer(int Index);
	int __fastcall GetFieldCount();
...
protected:
	...
	virtual void __fastcall CalculateFields(TRecBuf Buffer)/* overload */;
	virtual void __fastcall CalculateFields _DEPRECATED_ATTRIBUTE1("Use overloaded method instead") (TRecordBuffer Buffer)/* overload */;
	...
	virtual void __fastcall ClearCalcFields(TRecBuf Buffer)/* overload */;
	virtual void __fastcall ClearCalcFields _DEPRECATED_ATTRIBUTE1("Use overloaded method instead") (TRecordBuffer Buffer)/* overload */;
	...
	virtual void __fastcall GetCalcFields(TRecBuf Buffer)/* overload */;
	virtual TBookmarkStr __fastcall GetBookmarkStr _DEPRECATED_ATTRIBUTE0 ();
	virtual void __fastcall GetCalcFields _DEPRECATED_ATTRIBUTE1("Use overloaded method instead") (TRecordBuffer Buffer)/* overload */;
	virtual TFieldTypes __fastcall GetCalcFieldTypes();
	virtual TFieldKinds __fastcall GetStoredFieldKinds();
	virtual bool __fastcall GetCanModify();
	...
	virtual void __fastcall InitRecord(TRecBuf Buffer)/* overload */;
	virtual void __fastcall InitRecord _DEPRECATED_ATTRIBUTE1("Use overloaded method instead") (TRecordBuffer Buffer)/* overload */;
...
#else /* _WIN64 */
	__property TRecBuf CalcBuffer = {read=FCalcBuffer};
#endif /* _WIN64 */
	...
	virtual TRecordBuffer __fastcall AllocRecordBuffer();
	...
	virtual void __fastcall InternalInitRecord(TRecBuf Buffer)/* overload */;
	virtual void __fastcall InternalGotoBookmark _DEPRECATED_ATTRIBUTE1("Use overloaded method instead") (void * Bookmark)/* overload */;
	virtual void __fastcall InternalInitRecord _DEPRECATED_ATTRIBUTE1("Use overloaded method instead") (TRecordBuffer Buffer)/* overload */;
	...
	virtual void __fastcall SetFieldData(TField* Field, TValueBuffer Buffer)/* overload */;
	virtual void __fastcall SetFieldData(TField* Field, TValueBuffer Buffer, bool NativeFormat)/* overload */;
	...
	virtual TGetResult __fastcall GetRecord(TRecBuf Buffer, TGetMode GetMode, bool DoCheck)/* overload */;
	virtual TGetResult __fastcall GetRecord(TRecordBuffer Buffer, TGetMode GetMode, bool DoCheck) = 0 /* overload */;
...
public:
	...
	virtual bool __fastcall BookmarkValid(TBookmark Bookmark);
	virtual void __fastcall Cancel();
	void __fastcall CheckBrowseMode();
	void __fastcall ClearFields();
	void __fastcall Close();
	bool __fastcall ControlsDisabled();
	virtual int __fastcall CompareBookmarks(TBookmark Bookmark1, TBookmark Bookmark2);
	...
	virtual void __fastcall FreeBookmark(TBookmark Bookmark);
	virtual TBookmark __fastcall GetBookmark();
	...
	virtual bool __fastcall GetFieldData(TField* Field, TValueBuffer &Buffer)/* overload */;
	virtual bool __fastcall GetFieldData(int FieldNo, TValueBuffer &Buffer)/* overload */;
	virtual bool __fastcall GetFieldData(TField* Field, TValueBuffer &Buffer, bool NativeFormat)/* overload */;
	...
	void __fastcall InsertRecord(const System::TVarRec *Values, const System::NativeInt Values_High);
	...
	void __fastcall SetFields(const System::TVarRec *Values, const System::NativeInt Values_High);
	...
	__property TFieldKinds StoredFieldKinds = {read=GetStoredFieldKinds, nodefault};
	__property int RecordCount = {read=GetRecordCount, nodefault};
...
typedef System::StaticArray<System::UnicodeString, 52> Data_Db__47;
...
#define ftCalcFieldTypes (System::Set<TFieldType, TFieldType::ftUnknown, TFieldType::ftSingle>() << TFieldType::ftString << TFieldType::ftSmallint << TFieldType::ftInteger << TFieldType::ftWord << TFieldType::ftBoolean << TFieldType::ftFloat << TFieldType::ftCurrency << TFieldType::ftBCD << TFieldType::ftDate << TFieldType::ftTime << TFieldType::ftDateTime << TFieldType::ftBytes << TFieldType::ftVarBytes << TFieldType::ftFixedChar << TFieldType::ftWideString << TFieldType::ftLargeint << TFieldType::ftGuid << TFieldType::ftTimeStamp << TFieldType::ftFMTBcd << TFieldType::ftFixedWideChar << TFieldType::ftOraTimeStamp << TFieldType::ftOraInterval << TFieldType::ftLongWord << TFieldType::ftShortint << TFieldType::ftByte << TFieldType::ftExtended << TFieldType::ftTimeStampOffset \
	<< TFieldType::ftSingle )
#define fkCalcFieldKinds (System::Set<TFieldKind, TFieldKind::fkData, TFieldKind::fkAggregate>() << TFieldKind::fkCalculated << TFieldKind::fkLookup << TFieldKind::fkInternalCalc )
...
extern DELPHI_PACKAGE Data_Db__47 FieldTypeNames;
...
static _DELPHI_CONST System::Word dsMaxStringSize = System::Word(0x2000);
static _DELPHI_CONST System::Int8 dsGuidStringLength = System::Int8(0x26);
...
extern DELPHI_PACKAGE TBlobDisplayValue DefaultBlobDisplayValue;
