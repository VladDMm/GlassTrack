...
typedef struct _DEVICE_MANAGE_DATA_SET_ATTRIBUTES {
    ...
    //
    // Must be aligned to TYPE_ALIGNMENT(action-specific struct)
    //
    ...
    //
    // Must be aligned to TYPE_ALIGNMENT(DEVICE_DSM_RANGE)
    //
...
typedef struct _DEVICE_MANAGE_DATA_SET_ATTRIBUTES_OUTPUT {
    ...
    //
    // Must be aligned to TYPE_ALIGNMENT(corresponding struct)
    //
...
#define DeviceDsmDefinition_ConversionQuery {DeviceDsmAction_ConversionQuery,         \
                                             ...
                                             0,                                       \
                                             TRUE,                                    \
                                             TYPE_ALIGNMENT(DEVICE_DSM_CONVERSION_OUTPUT), \
