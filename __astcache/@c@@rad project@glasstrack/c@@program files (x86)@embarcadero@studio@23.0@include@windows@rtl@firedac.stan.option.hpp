...
// (DO NOT EDIT: machine generated header) 'FireDAC.Stan.Option.pas' rev: 36.00 (Windows)
...
class DELPHICLASS TFDSecurityOptions;
...
typedef System::Set<TFDSecurityOptionValue, TFDSecurityOptionValue::svAllowedCommandKinds, TFDSecurityOptionValue::svExactUpdatedRecsNum> TFDSecurityOptionValues;
...
__interface  INTERFACE_UUID("{3E9B315B-F456-4175-A864-B2573C4A2018}") IFDStanOptions  : public System::IInterface 
{
	...
	virtual TFDSecurityOptions* __fastcall GetSecurityOptions() = 0 ;
	...
	__property TFDSecurityOptions* SecurityOptions = {read=GetSecurityOptions};
...
private:
	...
	TFDSecurityOptions* FSecurityOptions;
...
protected:
	...
	TFDSecurityOptions* __fastcall GetSecurityOptions();
...
public:
	...
	__property System::LongWord Version = {read=FVersion, nodefault};
...
private:
	...
	System::LongWord FMaxStringSize;
	...
	Firedac::Stan::Intf::TFDLocalID FSortLocale;
	Firedac::Stan::Intf::TFDSortOptions FSortOptions;
	Data::Db::TFieldKinds FStoredCalcFields;
	...
	System::LongWord __fastcall GetMaxStringSize();
	bool __fastcall IsMSSS();
	void __fastcall SetMaxStringSize(const System::LongWord AValue);
	...
	Firedac::Stan::Intf::TFDLocalID __fastcall GetSortLocale();
	bool __fastcall IsSLS();
	void __fastcall SetSortLocale(const Firedac::Stan::Intf::TFDLocalID AValue);
	...
	Data::Db::TFieldKinds __fastcall GetStoredCalcFields();
	void __fastcall SetStoredCalcFields(const Data::Db::TFieldKinds AValue);
	bool __fastcall IsPCFS();
...
public:
	...
	__classmethod void __fastcall FieldDef2ColumnDef(Data::Db::TFieldType ASrcFieldType, System::LongWord ASrcSize, int ASrcPrec, int ASrcScale, Firedac::Stan::Intf::TFDDataType &ADestDataType, System::LongWord &ADestSize, int &ADestPrec, int &ADestScale, Firedac::Stan::Intf::TFDDataAttributes &ADestAttrs)/* overload */;
	__classmethod void __fastcall FieldDef2ColumnDef(Data::Db::TField* AField, Firedac::Stan::Intf::TFDDataType &ADestDataType, System::LongWord &ADestSize, int &ADestPrec, int &ADestScale, Firedac::Stan::Intf::TFDDataAttributes &ADestAttrs)/* overload */;
	__classmethod void __fastcall FieldDef2ColumnDef(Data::Db::TFieldDef* AFieldDef, Firedac::Stan::Intf::TFDDataType &ADestDataType, System::LongWord &ADestSize, int &ADestPrec, int &ADestScale, Firedac::Stan::Intf::TFDDataAttributes &ADestAttrs)/* overload */;
	void __fastcall CheckConversion(Firedac::Stan::Intf::TFDDataType ASrc, Firedac::Stan::Intf::TFDDataType ADest);
	void __fastcall ConvertRawData(Firedac::Stan::Intf::TFDDataType ASrcType, Firedac::Stan::Intf::TFDDataType ADestType, void * ApSrc, System::LongWord ASrcSize, void * &ApDest, System::LongWord ADestMaxSize, System::LongWord &ADestSize, Firedac::Stan::Util::TFDEncoder* AEncoder);
...
private:
	TFDSecurityOptionValues FAssignedValues;
	Firedac::Stan::Intf::TFDCommandKinds FAllowedCommandKinds;
	bool FAllowMultiCommands;
	bool FAllowSQLChange;
	int FExactUpdatedRecsNum;
	Firedac::Stan::Intf::TFDCommandKinds __fastcall GetAllowedCommandKinds();
	void __fastcall SetAllowedCommandKinds(const Firedac::Stan::Intf::TFDCommandKinds AValue);
	bool __fastcall IsACKS();
	bool __fastcall GetAllowMultiCommands();
	void __fastcall SetAllowMultiCommands(const bool AValue);
	bool __fastcall IsAMCS();
	bool __fastcall GetAllowSQLChange();
	void __fastcall SetAllowSQLChange(const bool AValue);
	bool __fastcall IsASCS();
	int __fastcall GetExactUpdatedRecsNum();
	void __fastcall SetExactUpdatedRecsNum(const int AValue);
	bool __fastcall IsEURNS();
	
public:
	virtual void __fastcall Assign(System::Classes::TPersistent* ASource);
	virtual void __fastcall RestoreDefaults();
	bool __fastcall IsValueOwned(TFDSecurityOptionValue AValue, _di_IFDStanOptions &AParentOpts);
	void __fastcall AllowAllCommands();
...
public:
	/* TFDCustomOptions.Create */ inline __fastcall virtual TFDSecurityOptions(TFDOptionsContainer* AContainer) : TFDCustomOptions(AContainer) { }
	
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TFDSecurityOptions() { }
