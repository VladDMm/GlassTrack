...
// (DO NOT EDIT: machine generated header) 'FireDAC.UI.Intf.pas' rev: 36.00 (Windows)
...
__interface DELPHIINTERFACE IFDGUIxQBEDialog;
typedef System::DelphiInterface<IFDGUIxQBEDialog> _di_IFDGUIxQBEDialog;
//-- type declarations -------------------------------------------------------
...
__interface  INTERFACE_UUID("{3E9B315B-F456-4175-A864-B2573C4A2207}") IFDGUIxTimer  : public System::IInterface 
{
	...
	virtual void __fastcall SetEvent(System::Classes::TNotifyEvent AProc, System::LongWord ATimeout) = 0 ;
...
__interface  INTERFACE_UUID("{3E9B315B-F456-4175-A864-B2573C4A2202}") IFDGUIxAsyncExecuteDialog  : public System::IInterface 
{
	...
	virtual System::UnicodeString __fastcall GetCancelCaption() = 0 ;
	virtual void __fastcall SetCancelCaption(const System::UnicodeString AValue) = 0 ;
	...
	__property System::UnicodeString CancelCaption = {read=GetCancelCaption, write=SetCancelCaption};
...
enum DECLSPEC_DENUM TFDGUIxScriptOption : unsigned int { ssCallstack, ssConsole, ssAutoHide };

typedef System::Set<TFDGUIxScriptOption, TFDGUIxScriptOption::ssCallstack, TFDGUIxScriptOption::ssAutoHide> TFDGUIxScriptOptions;
...
__interface  INTERFACE_UUID("{3E9B315B-F456-4175-A864-B2573C4A2208}") IFDGUIxQBEDialog  : public System::IInterface 
{
	virtual bool __fastcall Execute(Data::Db::TDataSet* AOrigDataSet, Data::Db::TDataSet* AQueryDataSet) = 0 ;
};
