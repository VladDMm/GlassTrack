...
/*
 *      C/C++ Run Time Library - Version 29.1
 *
 *      Copyright (c) 1987, 2024 by Embarcadero Technologies, Inc.
 *      All Rights Reserved.
 *
 */
...
void _RTLENTRY _cexit(void);
void _RTLENTRY _c_exit(void);
...
uintptr_t _RTLENTRY _EXPFUNC _beginthread  (void (_USERENTRY *__start)(void *),
                                                unsigned __stksize, void *__arg);
uintptr_t _RTLENTRY _EXPFUNC _beginthreadNT(void (_USERENTRY *__start)(void *),
                                                unsigned __stksize, void *__arg,
                                                void *__security_attr,
                                                unsigned long __create_flags,
                                                unsigned long *__thread_id);

uintptr_t _RTLENTRY _EXPFUNC _beginthreadex(void *__security_attr,
                                                unsigned __stksize,
...
#if defined(__cplusplus) && !defined(__XUSING_CNAME__) && !defined(__PROCESS_H_USING_LIST)
