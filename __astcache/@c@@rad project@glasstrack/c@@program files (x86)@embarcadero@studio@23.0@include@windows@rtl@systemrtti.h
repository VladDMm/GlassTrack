...
namespace System {
 namespace Internal {
  namespace Varhlpr {
   extern PACKAGE void* /*System::Typinfo::PTypeInfo*/ __fastcall GetTypeInfoHelper(unsigned I);
  }
 }
}
...
namespace Rtti
{
  ...
  {
    static System::Typinfo::PTypeInfo get()
    { return System::Typinfo::PTypeInfo(System::Internal::Varhlpr::GetTypeInfoHelper(static_cast<unsigned>(E))); }
  };
