...
// (DO NOT EDIT: machine generated header) 'FireDAC.Comp.Client.pas' rev: 36.00 (Windows)
...
enum DECLSPEC_DENUM TFDCommandFlag : unsigned int { ckMacros, ckLockParse, ckPrepare, ckCreateIntfDontPrepare, ckExecuted };
...
enum DECLSPEC_DENUM TFDInfoReportItem : unsigned int { riConnDef, riFireDAC, riClientLog, riClient, riSessionHints, riSession, riTryConnect, riKeepConnected };
...
private:
	...
	Firedac::Stan::Intf::TFDObjList* FConnections;
...
public:
	...
	Firedac::Phys::Intf::_di_IFDPhysConnectionDefStat __fastcall GetConnectionDefStat(const System::UnicodeString AName);
...
private:
	...
	Firedac::Stan::Intf::TFDObjList* FCommands;
	...
	bool FDisconnecting;
	Firedac::Stan::Intf::TFDObjList* FDeferredUnregs;
	...
	bool __fastcall BasePrepareSQL(const Firedac::Phys::Intf::_di_IFDPhysCommand ACommand, const System::UnicodeString ASQL, const System::Variant *AParams, const System::NativeInt AParams_High, const Data::Db::TFieldType *ATypes, const System::NativeInt ATypes_High, Firedac::Stan::Param::TFDParamBindMode ABindMode);
	...
	unsigned __int64 __fastcall GetCommandsExecuted();
...
public:
	...
	void __fastcall Trace(Firedac::Stan::Intf::TFDMoniEventStep AStep, System::TObject* ASender, const System::UnicodeString AMsg, const System::TVarRec *AArgs, const System::NativeInt AArgs_High);
	TFDInfoReportStatus __fastcall GetInfoReport(System::Classes::TStrings* AList, TFDInfoReportItems AItems = (TFDInfoReportItems() << TFDInfoReportItem::riConnDef << TFDInfoReportItem::riFireDAC << TFDInfoReportItem::riClientLog << TFDInfoReportItem::riClient << TFDInfoReportItem::riSessionHints << TFDInfoReportItem::riSession << TFDInfoReportItem::riTryConnect << TFDInfoReportItem::riKeepConnected ));
	...
	void __fastcall ApplyUpdates _DEPRECATED_ATTRIBUTE1("Use Centralized Cached Updates and TFDSchemaAdapter instead") (Firedac::Comp::Dataset::TFDDataSet* const *ADataSets, const System::NativeInt ADataSets_High);
	...
	System::Variant __fastcall ExecSQLScalar(const System::UnicodeString ASQL, const System::Variant *AParams, const System::NativeInt AParams_High)/* overload */;
	System::Variant __fastcall ExecSQLScalar(const System::UnicodeString ASQL, const System::Variant *AParams, const System::NativeInt AParams_High, const Data::Db::TFieldType *ATypes, const System::NativeInt ATypes_High)/* overload */;
...
private:
	...
	Firedac::Stan::Intf::TFDObjList* FDataSets;
	System::LongWord FNestingLevel;
	System::LongWord FSerialID;
	System::Classes::TNotifyEvent FBeforeStartTransaction;
	System::Classes::TNotifyEvent FAfterStartTransaction;
	System::Classes::TNotifyEvent FBeforeCommit;
	System::Classes::TNotifyEvent FAfterCommit;
...
private:
	...
	Firedac::Stan::Intf::TFDCounter FRowsAffected;
	...
	void __fastcall CheckCanChangeSQL();
	...
	void __fastcall MacrosChanging(System::TObject* ASender);
	...
	void __fastcall ReadCommandText(System::Classes::TReader* Reader);
...
public:
	...
	void __fastcall Trace(Firedac::Stan::Intf::TFDMoniEventStep AStep, const System::UnicodeString AMsg, const System::TVarRec *AArgs, const System::NativeInt AArgs_High);
	void __fastcall AbortJob(bool AWait = false);
	...
	System::LongInt __fastcall Execute(const System::UnicodeString ASQL)/* overload */;
	System::LongInt __fastcall Execute(const System::UnicodeString ASQL, const System::Variant *AParams, const System::NativeInt AParams_High)/* overload */;
	System::LongInt __fastcall Execute(const System::UnicodeString ASQL, const System::Variant *AParams, const System::NativeInt AParams_High, const Data::Db::TFieldType *ATypes, const System::NativeInt ATypes_High)/* overload */;
...
#ifndef _WIN64
	__property Firedac::Stan::Intf::TFDCounter RowsAffected = {read=FRowsAffected, nodefault};
#else /* _WIN64 */
	__property Firedac::Stan::Intf::TFDCounter RowsAffected = {read=FRowsAffected};
#endif /* _WIN64 */
...
private:
	...
	void __fastcall UpdateAdapterCmds(const Firedac::Stan::Option::TFDActionRequest *ACmds, const System::NativeInt ACmds_High);
...
private:
	Firedac::Stan::Intf::TFDObjList* FTableAdapters;
...
protected:
	...
	virtual void __fastcall DoMasterParamSetValues(Firedac::Comp::Dataset::TFDFieldList* AMasterFieldList);
...
private:
	...
	void __fastcall SetMacros(Firedac::Stan::Param::TFDMacros* const AValue);
	bool __fastcall IsPS();
	Firedac::Stan::Intf::TFDCounter __fastcall GetRowsAffected();
...
public:
	...
	HIDESBASE void __fastcall Open(const System::UnicodeString ASQL, const System::Variant *AParams, const System::NativeInt AParams_High)/* overload */;
	HIDESBASE void __fastcall Open(const System::UnicodeString ASQL, const System::Variant *AParams, const System::NativeInt AParams_High, const Data::Db::TFieldType *ATypes, const System::NativeInt ATypes_High)/* overload */;
	Firedac::Stan::Param::TFDMacro* __fastcall MacroByName(const System::UnicodeString AValue);
	Firedac::Stan::Param::TFDMacro* __fastcall FindMacro(const System::UnicodeString AValue);
...
public:
	...
	System::LongInt __fastcall ExecSQL(bool AExecDirect)/* overload */;
	System::LongInt __fastcall ExecSQL(const System::UnicodeString ASQL)/* overload */;
	System::LongInt __fastcall ExecSQL(const System::UnicodeString ASQL, const System::Variant *AParams, const System::NativeInt AParams_High)/* overload */;
	System::LongInt __fastcall ExecSQL(const System::UnicodeString ASQL, const System::Variant *AParams, const System::NativeInt AParams_High, const Data::Db::TFieldType *ATypes, const System::NativeInt ATypes_High)/* overload */;
...
private:
	...
	void __fastcall SetCatalogName(const System::UnicodeString AValue);
	void __fastcall SetSchemaName(const System::UnicodeString AValue);
	System::LongWord __fastcall GetColSize(Firedac::Dats::TFDDatSColumn* ACol);
	System::LongWord __fastcall GetBookmarkColSize(Firedac::Dats::TFDDatSColumn* ACol);
...
private:
	...
	void __fastcall SetCatalogName(const System::UnicodeString AValue);
	void __fastcall ExecProcBase(const System::UnicodeString AProcName, bool AFunction, const System::Variant *AParams, const System::NativeInt AParams_High, const Data::Db::TFieldType *ATypes, const System::NativeInt ATypes_High);
...
public:
	...
	System::LongInt __fastcall ExecProc(const System::UnicodeString AProcName)/* overload */;
	System::LongInt __fastcall ExecProc(const System::UnicodeString AProcName, const System::Variant *AParams, const System::NativeInt AParams_High)/* overload */;
	System::LongInt __fastcall ExecProc(const System::UnicodeString AProcName, const System::Variant *AParams, const System::NativeInt AParams_High, const Data::Db::TFieldType *ATypes, const System::NativeInt ATypes_High)/* overload */;
	...
	System::Variant __fastcall ExecFunc(const System::UnicodeString AProcName, const System::Variant *AParams, const System::NativeInt AParams_High)/* overload */;
	System::Variant __fastcall ExecFunc(const System::UnicodeString AProcName, const System::Variant *AParams, const System::NativeInt AParams_High, const Data::Db::TFieldType *ATypes, const System::NativeInt ATypes_High)/* overload */;
